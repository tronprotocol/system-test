...
import org.tron.protos.Contract.FreezeBalanceV2Contract;
import org.tron.protos.Contract.UnfreezeBalanceV2Contract;
import org.tron.protos.Contract.WithdrawExpireUnfreezeContract;
...
public abstract class AbstractTransactionCreator extends Level2Strategy {
  ...
  protected String aggContractAddress = Configuration.getByPath("stress.conf")
      .getString("address.aggContractAddress");
  protected String jstAddress = Configuration.getByPath("stress.conf")
      .getString("address.jstAddress");
  protected String tstExchangeAddress = Configuration.getByPath("stress.conf")
      .getString("address.tstExchangeAddress");
...
*/
  ...
  public FreezeBalanceV2Contract createFreezeBalanceV2Contract(byte[] ownerAddress, long frozen_balance,
     int resourceCode) {
    org.tron.protos.Contract.FreezeBalanceV2Contract.Builder builder = org.tron.protos.Contract.FreezeBalanceV2Contract
        .newBuilder();
    ByteString byteAddress = ByteString.copyFrom(ownerAddress);
    builder.setOwnerAddress(byteAddress).setFrozenBalance(frozen_balance)
  ...
  public UnfreezeBalanceV2Contract createUnfreezeBalanceV2Contract(byte[] ownerAddress,
      int resourceCode, long unfreezeAmount) {
    org.tron.protos.Contract.UnfreezeBalanceV2Contract.Builder builder = org.tron.protos.Contract.UnfreezeBalanceV2Contract
        .newBuilder();
    ByteString byteAddreess = ByteString.copyFrom(ownerAddress);
    builder.setOwnerAddress(byteAddreess).setResourceValue(resourceCode)
  ...
  public UnDelegateResourceContract unDelegateResourceContract(byte[] ownerAddress, long delegateBalance,
      int resourceCode, byte[] receiverAddress) {
    org.tron.protos.Contract.UnDelegateResourceContract.Builder builder = org.tron.protos.Contract.UnDelegateResourceContract
        .newBuilder();
    ByteString byteAddress = ByteString.copyFrom(ownerAddress);
  ...
  public WithdrawExpireUnfreezeContract withdrawExpireUnfreezeContract(byte[] ownerAddress) {
    org.tron.protos.Contract.WithdrawExpireUnfreezeContract.Builder builder = org.tron.protos.Contract.WithdrawExpireUnfreezeContract
        .newBuilder();
    ByteString byteAddress = ByteString.copyFrom(ownerAddress);
  ...
  public DelegateResourceContract delegateResourceContract(byte[] ownerAddress, long delegateBalance,
      int resourceCode, byte[] receiverAddress) {
    org.tron.protos.Contract.DelegateResourceContract.Builder builder = org.tron.protos.Contract.DelegateResourceContract
        .newBuilder();
    ByteString byteAddress = ByteString.copyFrom(ownerAddress);
    builder.setOwnerAddress(byteAddress).setBalance(delegateBalance)
        .setResourceValue(resourceCode).setReceiverAddress(ByteString.copyFrom(receiverAddress));
