...
@Slf4j
@Flaky(reason = "Timing-sensitive: delegate resource expiry timing", since = "2026-04-03")
public class FreezeBalanceV2Test006 extends TronBaseTest {
  ...
  public void test01DelegateResourceLockValueIsTrueTest() throws Exception {
    ...
    DelegatedResourceList delegatedResourceList =
        PublicMethod.getDelegatedResource(frozenBandwidthAddress, receiverAddress, blockingStubFull)
            .get();
    ...
    DelegatedResourceList delegatedResourceListSolidity =
        PublicMethod.getDelegatedResourceV2Solidity(
  ...
  public void test02DelegateResourceBandWidthLockPeriodValueIsNonZeroTest() {
    ...
    String txId =
        PublicMethod.delegateResourceV2LockAndGetTxId(
            fromAddress,
            delegateBalance,
            0,
            true,
  ...
  @Test(
      enabled = true,
      description = "unDelegateResource energy after lockPeriod",
      groups = {"daily", "staking"})
  ...
  @Test(
      enabled = true,
      description = "only lock = true equals lock = true and lockPeriod = 0",
      groups = {"daily", "staking"})
  ...
  public void test06LockPeriodBoundaryTest() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    GrpcAPI.TransactionExtention ext =
        PublicMethod.delegateResourceV2AndGetTransactionExtention(
            fromAddress,
            delegateBalance,
            1,
            true,
    ...
    Long lockStartTime =
        PublicMethod.getBlock2(lastBlockNumber, blockingStubFull)
            .getBlockHeader()
            .getRawData()
            .getTimestamp();
    Optional<DelegatedResourceList> delegatedResourceList =
  ...
  @Test(
      enabled = true,
      description = "Delegate twice in same block and lock = true,lockPeriod=0L",
      groups = {"daily", "staking"})
  public void test08DelegateLockTwiceInSameBlock() {
    ...
    String txId2 =
        PublicMethod.delegateResourceV2LockAndGetTxId(
            ...
            blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Transaction transaction1 = PublicMethod.getTransactionById(txId1, blockingStubFull).get();
    Transaction transaction2 = PublicMethod.getTransactionById(txId2, blockingStubFull).get();
