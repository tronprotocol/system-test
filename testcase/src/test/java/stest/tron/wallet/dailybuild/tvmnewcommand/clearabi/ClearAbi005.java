...
@Slf4j
@MultiNode
public class ClearAbi005 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Clear a contract created by create2 (without ABI)",
  ...
  public void testClearAbi() {
    ...
    smartContract = PublicMethod.getContract(returnAddressBytes, blockingStubFull);
    Assert.assertTrue(smartContract.getAbi().toString().isEmpty());
    Assert.assertFalse(smartContract.getBytecode().toString().isEmpty());
  }
