...
@Slf4j
public class WalletTestAccount013 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Delegate resource for bandwidth and energy",
      groups = {"daily"})
  public void test1DelegateResourceForBandwidthAndEnergy() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            account013Address, 10000000000L, foundationAddress, foundationKey, blockingStubFull));
    ...
    AccountResourceMessage receiverResource =
        PublicMethod.getAccountResource(receiverDelegateAddress, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Get delegate resource",
      groups = {"daily"})
  public void test2getDelegatedResource() {
    ...
    Protocol.Account account4infoBefore =
        PublicMethod.queryAccount(account4DelegatedResourceAddress, blockingStubFull);
    ...
    Optional<GrpcAPI.DelegatedResourceList> delegatedResourceResult1 =
        PublicMethod.getDelegatedResource(
    ...
    Optional<Protocol.DelegatedResourceAccountIndex> delegatedResourceIndexResult1 =
        PublicMethod.getDelegatedResourceAccountIndex(
    ...
    Assert.assertTrue(
        PublicMethod.queryAccount(account013Address, blockingStubFull).getBalance()
  ...
  @Test(
      enabled = true,
      description = "Prepare delegate resource token",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Delegate resource about transfer asset",
      groups = {"daily"})
  public void test4DelegateResourceAboutTransferAsset() {
    ...
    getAssetIdFromThisAccount =
        PublicMethod.queryAccount(accountForAssetIssueAddress, blockingStubFull);
    ...
    final long account013CurrentBandwidth =
        PublicMethod.getAccountResource(account013Address, blockingStubFull).getNetUsed();
    long accountForAssetIssueCurrentBandwidth =
        PublicMethod.getAccountResource(accountForAssetIssueAddress, blockingStubFull).getNetUsed();
    ...
    final long accountForAssetIssueCurrentBandwidthAfterTrans =
        PublicMethod.getAccountResource(accountForAssetIssueAddress, blockingStubFull)
            .getFreeNetUsed();
  ...
  @Test(
      enabled = true,
      description = "Can't delegate resource for contract",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Get delegate resource from PBFT",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Get delegate resource index from solidity",
      groups = {"daily"})
  public void test8GetDelegateResourceIndexFromSolidity() {
    Optional<Protocol.DelegatedResourceAccountIndex> delegateResourceIndex =
        PublicMethod.getDelegatedResourceAccountIndexFromSolidity(
  ...
  @Test(
      enabled = true,
      description = "Get delegate resource index from PBFT",
      groups = {"daily"})
  ...
  public void shutdown() throws InterruptedException {
    PublicMethod.freeResource(
        account013Address, testKeyForAccount013, foundationAddress, blockingStubFull);
    PublicMethod.freeResource(
        receiverDelegateAddress, receiverDelegateKey, foundationAddress, blockingStubFull);
    PublicMethod.freeResource(
        account4DelegatedResourceAddress,
        account4DelegatedResourceKey,
        foundationAddress,
