...
public class HttpShieldTrc20Token003 extends ZenTrc20Base {
  ...
  @Test(
      enabled = true,
      description = "Transfer type with 1V1 by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Transfer type with 1V2 by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Transfer type with 2V2 by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Transfer type with 2V1 by http",
      groups = {"daily", "serial"})
