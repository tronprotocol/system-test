...
public class ContractTrcToken079 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Trigger transferToken with 0 tokenValue and tokenId",
  ...
  public void triggerTransferTokenContract() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            user001Address, 1000_000_000L, fromAddress, foundationKey, blockingStubFull));
    ...
    PublicMethod.sendcoin(
        transferTokenContractAddress, 5000000, fromAddress, foundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
