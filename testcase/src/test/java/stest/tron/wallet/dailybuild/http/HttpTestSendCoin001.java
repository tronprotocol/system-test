...
public class HttpTestSendCoin001 {
  ...
  @Test(
      enabled = true,
      description = "Get transaction by id from solidity by http",
      groups = {"daily", "serial"})
  public void test2GetTransactionByIdFromSolidity() {
    txid = HttpMethod.sendCoinGetTxid(httpnode, fromAddress, receiverAddress, amount, testKey002);
  ...
  @Test(
      enabled = true,
      description = "Get transaction by id from PBFT by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Get transaction info by id from solidity by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Get transaction info by id from PBFT by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = false,
      description = "Get transactions from this from solidity by http",
      groups = {"daily", "serial"})
  public void test4GetTransactionsFromThisFromSolidity() {
    response =
        HttpMethod.getTransactionsFromThisFromSolidity(httpSoliditynode, fromAddress, 0, 100);
    Assert.assertEquals(response.getStatusLine().getStatusCode(), 200);
    responseContent = HttpMethod.parseResponseContent(response);
    HttpMethod.printJsonContent(responseContent);
    JSONObject transactionObject =
        HttpMethod.parseStringContent(
  ...
  @Test(
      enabled = false,
      description = "Get transactions to this from solidity by http",
      groups = {"daily", "serial"})
