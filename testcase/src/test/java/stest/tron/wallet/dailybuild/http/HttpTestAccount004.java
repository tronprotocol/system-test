...
public class HttpTestAccount004 {
  ...
  @Test(
      enabled = true,
      description = "Set account by http",
      groups = {"daily", "serial"})
  public void test1setAccountId() {
    ...
    response =
        HttpMethod.setAccountId(httpnode, setAccountIdAddress, accountId, true, setAccountIdKey);
    Assert.assertTrue(HttpMethod.verificationResult(response));
  }
  ...
  @Test(
      enabled = true,
      description = "Get account by id via http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Get account by id via PBFT http",
      groups = {"daily", "serial"})
