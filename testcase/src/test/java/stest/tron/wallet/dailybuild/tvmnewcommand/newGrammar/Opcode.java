...
public class Opcode extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "test opcode smod, used for int",
  ...
  @Test(
      enabled = true,
      description = "test opcode extcodecopy return contract bytecode",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test opcode gaslimit,block.gaslimit is always 0",
      groups = {"contract", "daily"})
  ...
  public void test06Pc() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    SmartContractOuterClass.SmartContract smartContract =
        PublicMethod.getContract(temContract, blockingStubFull);
    Assert.assertNotNull(smartContract.getAbi());
  ...
  @Test(
      enabled = true,
      description = "test opcode swap14-16,solidity cannot use optimize",
      groups = {"contract", "daily"})
  ...
  public void test09Callcode() {
    String code =
        "60806040526103b4806100136000396000f3006080604052600436106100565763"
            ...
            + "0"
            + "00000000000000001781529151815173ffffffffffffffffffffffffffffffffffffffff861693829180"
            + "8"
            + "38360005b8381101561034457818101518382015260200161032c565b50505050905090810190601f168"
            + "0"
            + "156103715780820380516001836020036101000a031916815260200191505b5091505060006040518083"
            + "0"
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    SmartContractOuterClass.SmartContract smartContract =
        PublicMethod.getContract(contractA, blockingStubFull);
    Assert.assertNotNull(smartContract.getAbi());
    ...
    code =
        "608060405260d2806100126000396000f300608060405260043610603e5763ffffffff7c0"
            ...
            + "0a165627a7a72305820c460a35f70e363777be22b3a4ace5f95533de626073ab4e06d9bf3bbb2cffceb0"
            + "029";
    abi =
        "[\n"
            + "\t{\n"
