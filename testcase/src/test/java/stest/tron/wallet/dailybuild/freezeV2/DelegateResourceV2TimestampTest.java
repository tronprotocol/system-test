...
public class DelegateResourceV2TimestampTest extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "GetDelegateResource to account sort by timestamp",
      groups = {"daily", "staking"})
  public void test01GetDelegateResourceToAccountTimestamp() {

    List<ByteString> toAccountList =
        PublicMethod.getDelegatedResourceAccountIndex(frozen1Address, blockingStubFull)
            .get()
            .getToAccountsList();
    // query solidity
    ...
    List<ByteString> toAccountListPbft =
        PublicMethod.getDelegatedResourceAccountIndexV2Solidity(frozen1Address, blockingStubPbft)
            .get()
            .getToAccountsList();
  ...
  @Test(
      enabled = true,
      description = "GetDelegateResource from account sort by timestamp",
      groups = {"daily", "staking"})
