...
public class ConstantCallStorage0425 extends TronBaseTest {
  ...
  @Test(
      enabled = false,
      description = "Deploy contract without abi",
  ...
  @Test(
      enabled = false,
      description = "Trigger contract constant function without ABI",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "TriggerConstantContract bool constant function",
      groups = {"contract", "daily"})
