...
public class WalletTestAssetIssue020 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Asset issue support precision",
      groups = {"daily"})
  public void test01AssetIssueSupportPrecision() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            asset020Address, 204800000000L, foundationAddress2, foundationKey2, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.sendcoin(
    ...
    AssetIssueContractOuterClass.AssetIssueContract assetIssueInfo =
        PublicMethod.getAssetIssueByName(name, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Get asset issue by id from Solidity",
      groups = {"daily"})
  public void test02GetAssetIssueByidFromSolidity() {
    Assert.assertEquals(
        PublicMethod.getAssetIssueById(
            ByteArray.toStr(assetAccountId.toByteArray()), blockingStubFull),
        PublicMethod.getAssetIssueByIdFromSolidity(
  ...
  @Test(
      enabled = true,
      description = "Get asset issue by id from PBFT",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Get asset issue list by name from Solidity",
      groups = {"daily"})
  public void test04GetAssetIssueListByNameFromSolidity() {
    Assert.assertEquals(
        PublicMethod.getAssetIssueListByNameFromSolidity(name, blockingStubSolidity)
            .get()
            .getAssetIssueList()
            .get(0)
            .getTotalSupply(),
  ...
  @Test(
      enabled = true,
      description = "Get asset issue list by name from PBFT",
      groups = {"daily"})
  public void test05GetAssetIssueListByNameFromPbft() {
    Assert.assertEquals(
        PublicMethod.getAssetIssueListByNameFromSolidity(name, blockingStubPbft)
            .get()
            .getAssetIssue(0)
            .getTotalSupply(),
        totalSupply);
  ...
  public void test06NetUsedDecrease() {
    ...
    Account getAssetIdFromThisAccount =
        PublicMethod.queryAccount(assetOwnerAddress, blockingStubFull);
    assetAccountId = getAssetIdFromThisAccount.getAssetIssuedID();
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            assetFromAddress, 100000000000L, foundationAddress2, foundationKey2, blockingStubFull));
    ...
    Long fromBeginNetUsed =
        PublicMethod.queryAccount(assetFromAddress, blockingStubFull)
            .getFreeAssetNetUsageV2Map()
            .get(strAssetId)
            .longValue();
    Long assetBeginNetUsed =
        PublicMethod.getAssetIssueById(strAssetId, blockingStubFull).getPublicFreeAssetNetUsage();
