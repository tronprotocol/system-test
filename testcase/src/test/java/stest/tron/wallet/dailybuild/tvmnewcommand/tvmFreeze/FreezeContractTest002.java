...
public class FreezeContractTest002 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "contract freeze over balance",
  ...
  @Test(
      enabled = true,
      description = "contract freeze amount < 1 TRX",
      groups = {"contract", "daily"})
  void FreezeContract002() {

    Account account002_before = PublicMethod.queryAccount(testAddress002, blockingStubFull);
    Account contractAccount_before = PublicMethod.queryAccount(contractAddress, blockingStubFull);
    // freeze(address payable receiver, uint amount, uint res)
    ...
    Account account002_after = PublicMethod.queryAccount(testAddress002, blockingStubFull);
    Account contractAccount_after = PublicMethod.queryAccount(contractAddress, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "contract transfer all balance, then freeze",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "contract freeze to ger Net",
      groups = {"contract", "daily"})
