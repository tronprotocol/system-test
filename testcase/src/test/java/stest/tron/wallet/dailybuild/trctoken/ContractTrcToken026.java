...
public class ContractTrcToken026 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Deploy transferToken contract",
  ...
  public void deploy01TransferTokenContract001() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 4048000000L, foundationAddress, foundationKey, blockingStubFull));
  ...
  @Test(
      enabled = true,
      description = "Multistage call transferToken use right tokenID",
      groups = {"contract", "daily"})
  public void deploy02TransferTokenContract002() {
    ...
    Long beforeAssetIssueBAddress =
        PublicMethod.getAssetIssueValue(btestAddress, assetAccountId, blockingStubFull);
    Long beforeAssetIssueCAddress =
        PublicMethod.getAssetIssueValue(ctestAddress, assetAccountId, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Multistage call transferToken use fake tokenID",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Multistage call transferToken token value not enough",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Multistage call transferToken calltoken ID not exist",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Multistage call transferToken calltoken value not enough",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Multistage call transferToken use right tokenID,tokenvalue",
      groups = {"contract", "daily"})
  public void deploy07TransferTokenContract007() {
    ...
    Optional<TransactionInfo> infoById5 =
        PublicMethod.getTransactionInfoById(triggerTxid5, blockingStubFull);
  ...
  public void shutdown() throws InterruptedException {
    ...
    PublicMethod.unFreezeBalance(
        foundationAddress, foundationKey, 0, dev001Address, blockingStubFull);
    PublicMethod.unFreezeBalance(
        foundationAddress, foundationKey, 1, dev001Address, blockingStubFull);
  }
}
