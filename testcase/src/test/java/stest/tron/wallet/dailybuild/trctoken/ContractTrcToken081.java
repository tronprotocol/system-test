...
public class ContractTrcToken081 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    SmartContract smartContract = PublicMethod.getContract(tokenReceiver, blockingStubFull);
    ...
    tokenSender =
        PublicMethod.deployContract(
            ...
            blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    smartContract = PublicMethod.getContract(tokenSender, blockingStubFull);
    Assert.assertNotNull(smartContract.getAbi());
    Long contractAssetCount =
        PublicMethod.getAssetIssueValue(tokenSender, assetAccountId, blockingStubFull);
    logger.info(
  ...
  @Test(
      enabled = true,
      description = "transfer 1 trc10 to contract by assembly",
  ...
  public void transferTokenToContract() {
    ...
    Long receiverAssetCountBefore =
        PublicMethod.getAssetIssueValue(tokenReceiver, assetAccountId, blockingStubFull);
    logger.info(
  ...
  @Test(
      enabled = true,
      description = "transfer 1 trc10 to normal address by assembly",
      groups = {"contract", "daily"})
