...
public class MultiSign08 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Active threshold is exception condition",
  ...
  @Test(
      enabled = true,
      description = "Active threshold is 1",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Active threshold is more than sum of weight",
      groups = {"daily", "multisig"})
  public void testActiveTheshold03() {
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "Contract validate error : sum of all key's weight should not"
  ...
  @Test(
      enabled = true,
      description = "Active threshold is Long.MAX_VALUE",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Active threshold is Integer.MAX_VALUE",
      groups = {"daily", "multisig"})
