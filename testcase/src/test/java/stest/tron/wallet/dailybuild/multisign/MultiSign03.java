...
@Slf4j
@MultiNode
public class MultiSign03 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Owner doesn't have parent_id",
  ...
  @Test(
      enabled = true,
      description = "Owner parent_id in exception condition",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner parent_id is 0",
      groups = {"daily", "multisig"})
