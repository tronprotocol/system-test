...
@Slf4j
@MultiNode
public class TriggerConstant009 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "TriggerContract a payable function without ABI", groups = {"contract", "daily"})
