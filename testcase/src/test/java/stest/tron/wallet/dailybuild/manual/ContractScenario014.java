...
public class ContractScenario014 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Triple trigger in smart contract",
      groups = {"daily"})
  public void testTripleTrigger() {
    ...
    Assert.assertTrue(
        PublicMethod.freezeBalanceGetEnergy(
            contract014Address, 10_000_000_000L, 0, 1, priKey014, blockingStubFull));
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            receiverAddress, 1000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    txid =
        PublicMethod.triggerContract(
            contractAddress2,
            "triggerContract1ButRevert(address)",
            receiveAddress,
            false,
            0,
            10000000L,
  ...
  public void shutdown() throws InterruptedException {
    PublicMethod.unFreezeBalance(
        contract014Address, contract014Key, 1, contract014Address, blockingStubFull);
    PublicMethod.freeResource(
        contract014Address, contract014Key, foundationAddress, blockingStubFull);
  }
}
