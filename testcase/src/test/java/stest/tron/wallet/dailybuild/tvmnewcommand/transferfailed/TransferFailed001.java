...
public class TransferFailed001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Transfer trx insufficient balance",
  ...
  @Test(
      enabled = true,
      description = "Transfer balance enough",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Transfer trx nonexistent target",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Transfer trx to myself",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Transfer trx nonexistent target and insufficient balance",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Transfer trx to myself and insufficient balance",
      groups = {"contract", "daily"})
  ...
  public void test007TransferTrckenPreCompiled() {
    ...
    resourceInfo = PublicMethod.getAccountResource(contractExcAddress, blockingStubFull);
    info = PublicMethod.queryAccount(contractExcKey, blockingStubFull);
  ...
  @Test(
      enabled = false,
      description = "PreCompiled tokenbalance",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "PreCompiled address(0x1) query tokenbalance",
      groups = {"contract", "daily"})
  public void test009TransferTrctoken() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Long returnAddressBytesAccountCountBefore =
        PublicMethod.getAssetIssueValue(addressxx, assetAccountId, blockingStubFull);
    logger.info("returnAddressBytesAccountCountBefore : " + returnAddressBytesAccountCountBefore);
    Account info;
  ...
  @Test(
      enabled = true,
      description = "transferTrx to nonexistent target ,but revert",
      groups = {"contract", "daily"})
