...
public class batchValidateSignContract011 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Correct 17 signatures test multivalidatesign",
  ...
  @Test(
      enabled = true,
      description = "8 signatures with 1st incorrect address" + " test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "6 signatures with 3th incorrect signatures" + " test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "11 signatures with 7th-9th incorrect address" + " test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "40 signatures with 2nd、32nd incorrect signatures" + " test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description =
          "44 signatures with 9th/11th/28th/32nd incorrect address" + " test multivalidatesign",
      groups = {"contract", "daily"})
