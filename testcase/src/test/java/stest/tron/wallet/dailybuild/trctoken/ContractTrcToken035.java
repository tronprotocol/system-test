...
@Slf4j
@MultiNode
public class ContractTrcToken035 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Deploy after transfertoken execute assert contract",
  ...
  @Test(
      enabled = true,
      description = "Trigger after transfertoken execute assert contract",
      groups = {"contract", "daily"})
