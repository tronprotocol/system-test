...
public class TransferFailed005 extends TronBaseTest {
  ...
  public void beforeClass() {
    initSolidityChannel();
    PublicMethod.printAddress(accountExcKey);
  ...
  @Test(
      enabled = false,
      description = "Deploy contract for trigger",
      groups = {"contract", "daily"})
  public void deployContract() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            accountExcAddress, 10000_000_000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    String filePath = "src/test/resources/soliditycode/TransferFailed005.sol";
    String contractName = "EnergyOfTransferFailedTest";
    HashMap retMap = PublicMethod.getBycodeAbi(filePath, contractName);
  ...
  @Test(
      enabled = true,
      description = "TransferFailed for function call_value ",
      groups = {"contract", "daily"})
  public void triggerContract01() {
    Account info = null;

    AccountResourceMessage resourceInfo =
        PublicMethod.getAccountResource(accountExcAddress, blockingStubFull);
    ...
    String triggerTxid =
        PublicMethod.triggerContract(
            contractAddress,
            "testCallTrxInsufficientBalance(uint256,address)",
            param,
            false,
            0L,
            maxFeeLimit,
    ...
    Assert.assertEquals(
        100L, PublicMethod.queryAccount(contractAddress, blockingStubFull).getBalance());
    Assert.assertEquals(
        0L, PublicMethod.queryAccount(contractAddress1, blockingStubFull).getBalance());
    ...
    Assert.assertEquals(
        99L, PublicMethod.queryAccount(contractAddress, blockingStubFull).getBalance());
    Assert.assertEquals(
        0L, PublicMethod.queryAccount(contractAddress1, blockingStubFull).getBalance());
    Assert.assertTrue(infoById.get().getReceipt().getEnergyUsageTotal() < 10000000);
    ...
    Assert.assertEquals(
        98L, PublicMethod.queryAccount(contractAddress, blockingStubFull).getBalance());
    Assert.assertEquals(
        1L, PublicMethod.queryAccount(contractAddress1, blockingStubFull).getBalance());
    Assert.assertTrue(infoById.get().getReceipt().getEnergyUsageTotal() < 10000000);
  ...
  @Test(
      enabled = true,
      description = "TransferFailed for create",
      groups = {"contract", "daily"})
  public void triggerContract02() {
    final Long contractBalance =
        PublicMethod.queryAccount(contractAddress, blockingStubFull).getBalance();
    Account info = null;
    ...
    String triggerTxid =
        PublicMethod.triggerContract(
            contractAddress,
            "testCreateTrxInsufficientBalance(uint256)",
            param,
            false,
            0L,
            maxFeeLimit,
  ...
  @Test(
      enabled = true,
      description = "TransferFailed for create2",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Triggerconstant a transfer function",
      groups = {"contract", "daily"})
  ...
  public void shutdown() throws InterruptedException {
    PublicMethod.freeResource(
        accountExcAddress, accountExcKey, foundationAddress, blockingStubFull);
