...
@Slf4j
@MultiNode
public class ContractLinkage005 extends TronBaseTest {
  ...
  final String txid7 = PublicMethod.triggerContract(contractAddress,
    ...
    infoById = PublicMethod.getTransactionInfoById(txid6, blockingStubFull);
  ...
  final String txid5 = PublicMethod.triggerContract(contractAddress,
    ...
    infoById = PublicMethod.getTransactionInfoById(txid4, blockingStubFull);
