...
public class Create2Test001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Deploy factory contract generated by new solidity",
  ...
  @Test(
      enabled = true,
      description = "Trigger Test contact",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test create2 with constructor has params",
      groups = {"contract", "daily"})
  public void test06TriggerTestContract() {
    ...
    triggerTxid =
        PublicMethod.triggerContract(
            PublicMethod.decode58Check(create2Base58),
            "plusOne()",
            "#",
            false,
            0,
