 ...
 *
 * <p>Tests verify both checked (default 0.8+) and unchecked arithmetic behavior. Unchecked blocks
 * wrap without reverting.
 */
@Slf4j
public class SecurityOverflowTest extends TronBaseTest {
  ...
  public void beforeClass() {
    testAccount =
        TestAccountFactory.funded(
            100_000_000_000L, foundationAddress, foundationKey, blockingStubFull);
  ...
  public void test01AddOverflowChecked() {
    ...
    logger.info("addOverflow: TVM {} overflow", success ? "wraps on" : "reverts on");
  }
  ...
  public void test02SubUnderflowChecked() {
    ...
    logger.info("subUnderflow: TVM {} underflow", success ? "wraps on" : "reverts on");
  }
  ...
  public void test03MulOverflowChecked() {
    ...
    Assert.assertNotNull(ext.getResult());
    logger.info("mulOverflow: TVM {} overflow", success ? "wraps on" : "reverts on");
  }
  ...
  @Test(
      enabled = true,
      description = "Safe add with normal values succeeds",
      groups = {"daily"})
  ...
  public void test08SafeSubChecked() {
    ...
    Assert.assertNotNull(ext.getResult());
    logger.info("safeSub(100,200): TVM {} underflow", success ? "wraps on" : "reverts on");
  }
