...
public class StackSuicideTest001 extends TronBaseTest {
  ...
  @Test(
      enabled = false,
      description = "targetAddress no TRX, and no frozen",
  ...
  @Test(
      enabled = false,
      description = "targetAddress has TRX, but no frozen",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "targetAddress has TRX, and has frozen",
      groups = {"contract", "daily"})
  public void stackSuicideTest003() {
    ...
    BigInteger expected =
        BigInteger.valueOf(ownerFrozen.getExpireTime())
            ...
            .add(
                BigInteger.valueOf(targetFrozen.getExpireTime())
