...
@Slf4j
public class WalletTestZenToken005 extends TronBaseTest {
  ...
  public void test1ReceiverShieldAddressCanNotMoreThenTwo() {
    ...
    Long sendToShiledAddress3Amount =
    ...
    shieldOutList =
        PublicMethod.addShieldOutputList(
            shieldOutList, shieldAddress3, "" + sendToShiledAddress3Amount, memo3);
  ...
  public void test3SendAmountMustEqualReceiverAmountPlusShieldFee() {
    ...
    shieldOutList =
        PublicMethod.addShieldOutputList(
            shieldOutList, shieldAddress1, "" + (sendToShiledAddress1Amount - 1), memo1);
    shieldOutList =
        PublicMethod.addShieldOutputList(
            shieldOutList, shieldAddress2, "" + sendToShiledAddress2Amount, memo2);
    Assert.assertFalse(
