...
@Slf4j
@MultiNode
public class MultiSignSmartContractTest extends TronBaseTest {
  ...
  public void testMultiSignForSmartContract() {
    ...
    Assert.assertTrue(
        PublicMethod.freezeBalanceForReceiver(
            foundationAddress,
            1000000000 + PublicMethod.randomFreezeAmount.getAndAdd(1),
            0,
            0,
    ...
    String txid =
        PublicMethodForMultiSign.deployContractAndGetTransactionInfoById(
            contractName,
            abi,
            code,
            "",
