...
public class MultiSign11 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Active address is witness",
  ...
  public void testActiveAddress01() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, needCoin + 1_000_000, foundationAddress, testKey002, blockingStubFull));
  ...
  @Test(
      enabled = true,
      description = "Active address is contract address",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Active address is inactive address",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Active address is owner address",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Active address is exception condition",
      groups = {"daily", "multisig"})
  public void testActiveAddress05() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, 1_000_000, foundationAddress, testKey002, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Long balanceBefore = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceBefore: " + balanceBefore);
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test(
      enabled = true,
      description = "Active address count is 5",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Active address count is more than 5",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Active address count is 0",
      groups = {"daily", "multisig"})
  public void testActiveAddress08() {
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "Contract validate error : key's count should be greater than 0",
        response.getMessage().toStringUtf8());
    Long balanceAfter = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceAfter: " + balanceAfter);
    Assert.assertEquals(balanceBefore, balanceAfter);
  ...
  @Test(
      enabled = true,
      description = "Active address count is 1",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Active permission count is 8",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Active permission count is 9",
      groups = {"daily", "multisig"})
  public void testActiveAddress11() {
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "Contract validate error : active permission is too many",
        response.getMessage().toStringUtf8());
    Long balanceAfter = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceAfter: " + balanceAfter);
    Assert.assertEquals(balanceBefore, balanceAfter);
  ...
  @Test(
      enabled = true,
      description = "Active permission count is 8, " + "sum of weight is less than threshold",
      groups = {"daily", "multisig"})
  public void testActiveAddress12() {
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "Contract validate error : sum of all key's weight should"
