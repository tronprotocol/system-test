...
@Slf4j
public class MultiSign11 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Active address is witness", groups = {"daily", "multisig"})
  ...
  @Test(enabled = true, description = "Active address is contract address", groups = {"daily", "multisig"})
  ...
  String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"owner\",\"threshold\":1,\"keys\":["
            ...
            + PublicMethod.getAddressString(testKey002) + "\",\"weight\":2147483647}]},"
  ...
  @Test(enabled = true, description = "Active address is inactive address", groups = {"daily", "multisig"})
  ...
  String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"owner\",\"threshold\":1,\"keys\":["
            + "{\"address\":\"" + PublicMethod.getAddressString(ownerKey) + "\",\"weight\":1},"
            + "{\"address\":\"" + PublicMethod.getAddressString(tmpKey01)
            + "\",\"weight\":2147483647}]},"
  ...
  @Test(enabled = true, description = "Active address is owner address", groups = {"daily", "multisig"})
  ...
  @Test(enabled = true, description = "Active address is exception condition", groups = {"daily", "multisig"})
  ...
  // address = same address more than once
    String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"owner\",\"threshold\":1,\"keys\":["
            ...
            + "\"operations\":\"7fff1fc0033e0000000000000000000000000000000000000000000000000000\","
            + "\"keys\":[" + "{\"address\":\"" + PublicMethod.getAddressString(ownerKey)
            + "\",\"weight\":3}," + "{\"address\":\"" + PublicMethod.getAddressString(ownerKey)
            + "\",\"weight\":3}" + "]}]}";
  ...
  // address =
    ...
    accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"owner\",\"threshold\":1,\"keys\":["
            ...
            + "{\"address\":\"" + PublicMethod.getAddressString(tmpKey01) + "\",\"weight\":3}"
            + "]}]}";
    ret = false;
    try {
  ...
  @Test(enabled = true, description = "Active address count is 5", groups = {"daily", "multisig"})
  ...
  String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"owner\",\"threshold\":1,\"keys\":["
            ...
            + "\"operations\":\"7fff1fc0033e0000000000000000000000000000000000000000000000000000\","
            + "\"keys\":[" + "{\"address\":\"" + PublicMethod.getAddressString(ownerKey)
            + "\",\"weight\":2}," + "{\"address\":\"" + PublicMethod.getAddressString(witnessKey)
            + "\",\"weight\":2}," + "{\"address\":\"" + PublicMethod.getAddressString(testKey002)
            + "\",\"weight\":2}," + "{\"address\":\"" + PublicMethod.getAddressString(tmpKey02)
            + "\",\"weight\":2}," + "{\"address\":\"" + PublicMethod.getAddressString(tmpKey01)
            + "\",\"weight\":3}" + "]}]}";
    ...
    Assert.assertEquals(5, PublicMethodForMultiSign.getActivePermissionKeyCount(
        PublicMethod.queryAccount(ownerAddress, blockingStubFull).getActivePermissionList()));
  ...
  @Test(enabled = true, description = "Active address count is more than 5", groups = {"daily", "multisig"})
  ...
  String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"owner\",\"threshold\":1,\"keys\":["
            ...
            + "{\"address\":\"" + PublicMethod.getAddressString(ownerKey) + "\",\"weight\":2},"
            + "{\"address\":\"" + PublicMethod.getAddressString(witnessKey) + "\",\"weight\":2},"
            + "{\"address\":\"" + PublicMethod.getAddressString(testKey002) + "\",\"weight\":2},"
  ...
  @Test(enabled = true, description = "Active address count is 0", groups = {"daily", "multisig"})
  ...
  @Test(enabled = true, description = "Active address count is 1", groups = {"daily", "multisig"})
  ...
  String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"owner\",\"threshold\":1,\"keys\":["
            ...
            + "\"active_permissions\":[{\"type\":2,\"permission_name\":\"active0\",\"threshold\":1,"
            + "\"operations\":\"7fff1fc0033e0000000000000000000000000000000000000000000000000000\","
            + "\"keys\":[" + "{\"address\":\"" + PublicMethod.getAddressString(tmpKey01)
            + "\",\"weight\":3}" + "]}]}";
  ...
  @Test(enabled = true, description = "Active permission count is 8", groups = {"daily", "multisig"})
  ...
  String accountPermissionJson =
    ...
    Assert.assertEquals(40, PublicMethodForMultiSign.getActivePermissionKeyCount(
        PublicMethod.queryAccount(ownerAddress, blockingStubFull).getActivePermissionList()));
    ...
    logger.info("** trigger a normal transaction");
    Assert.assertTrue(PublicMethodForMultiSign
        .sendcoinWithPermissionId(foundationAddress, 1_000000, ownerAddress, 9, ownerKey,
            blockingStubFull,
            activePermissionKeys.toArray(new String[activePermissionKeys.size()])));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  Long balanceAfter = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
  ...
  @Test(enabled = true, description = "Active permission count is 9", groups = {"daily", "multisig"})
  ...
  @Test(enabled = true, description = "Active permission count is 8, "
      + "sum of weight is less than threshold", groups = {"daily", "multisig"})
