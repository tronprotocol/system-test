...
public class FixbugTest086 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "abstract With Map Params",
  ...
  public void test01ContractWithMapParams() {
    ...
    Assert.assertEquals(
        20, ByteArray.toInt(transactionInfo.get().getContractResult(0).toByteArray()));
  }

  @Test(
      enabled = true,
      description = " super skip unimplemented in abstract contract",
      groups = {"contract", "daily"})
  public void test02SkipUnimplemented() {
    ...
    Assert.assertEquals(
        ...
        transactionInfo.get().getReceipt().getResult());
    Assert.assertEquals(
        42, ByteArray.toInt(transactionInfo.get().getContractResult(0).toByteArray()));
  }

  @Test(
      enabled = true,
      description = "Fixed wrong fixed64 proto type transaction print bug",
      groups = {"contract", "daily"})
