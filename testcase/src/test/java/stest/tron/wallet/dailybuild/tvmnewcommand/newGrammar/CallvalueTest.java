...
public class CallvalueTest extends TronBaseTest {
  ...
  public void test01DeployContract() {
    Assert.assertTrue(PublicMethod.sendcoin(dev001Address, 3147483647L, fromAddress,
        testKey002, blockingStubFull));
    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress, 100_000_000L + PublicMethod.randomFreezeAmount.getAndAdd(1),
  ...
  // 15
    String triggerTxid = PublicMethod.triggerContract(contractAddress, methodStr, "", true,
  ...
  // 0
    String triggerTxid1 = PublicMethod.triggerContract(contractAddress, methodStr, "", true,
  ...
  // Integer.MAX_VALUE
    String triggerTxid2 = PublicMethod.triggerContract(contractAddress, methodStr, "", true,
