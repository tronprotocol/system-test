...
public class MultiSign17 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Witness address is witness",
  ...
  @Test(
      enabled = true,
      description = "Witness address is contract",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Witness address is inactive address",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Witness address is owner_address",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Witness address is exception condition",
      groups = {"daily", "multisig"})
  public void testWitnessAddress05() {
    ...
    Assert.assertEquals(
        "Contract validate error : Witness permission's key count should be 1",
  ...
  @Test(
      enabled = true,
      description = "Witness address account is 5",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Witness address account is 0",
      groups = {"daily", "multisig"})
