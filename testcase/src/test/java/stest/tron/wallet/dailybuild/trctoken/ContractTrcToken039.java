...
public class ContractTrcToken039 extends TronBaseTest {
  ...
  public void deploy01TransferTokenContract() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 4048000000L, foundationAddress, testKey002, blockingStubFull));
  ...
  public void deploy02TransferTokenContract() {
    ...
    Long beforeAssetIssueContractAddress =
        PublicMethod.getAssetIssueValue(proxyTestAddress, assetAccountId, blockingStubFull);
    ...
    Long beforeAssetIssueAAddress =
        PublicMethod.getAssetIssueValue(atestAddress, assetAccountId, blockingStubFull);
    Long beforeBalanceContractAddress =
        PublicMethod.queryAccount(proxyTestAddress, blockingStubFull).getBalance();
