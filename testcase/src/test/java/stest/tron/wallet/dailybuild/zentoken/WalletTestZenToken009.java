...
@Slf4j
public class WalletTestZenToken009 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"owner\",\"threshold\":2,\"keys\":["
            ...
            + "\",\"weight\":1},"
            + "{\"address\":\""
            + PublicMethod.getAddressString(zenTokenOwnerKey)
            + "\",\"weight\":1}]},"
  ...
  @Test(
      enabled = false,
      description = "Public to shield transaction with multisign",
      groups = {"daily", "shield"})
  ...
  public void test2ShieldFromShouldNotSign() {
    ...
    shieldOutList =
        PublicMethod.addShieldOutputList(
            shieldOutList, receiverAddress, "" + (note.getValue() - zenTokenFee), memo);
  ...
  public void shutdown() throws InterruptedException {
    PublicMethodForMultiSign.transferAsset(
        foundationZenTokenAddress,
        tokenId,
        PublicMethod.getAssetIssueValue(
            zenTokenOwnerAddress,
