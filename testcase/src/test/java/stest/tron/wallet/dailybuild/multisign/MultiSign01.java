...
@Slf4j
@MultiNode
public class MultiSign01 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is owner1",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is string \"123\"",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is string \"\"",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is null",
      groups = {"daily", "multisig"})
  public void testOwnerName05() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, 1_000000, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Long balanceBefore = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceBefore: " + balanceBefore);
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test(
      enabled = true,
      description = "Owner without permission_name",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is numbers",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is 0.1",
      groups = {"daily", "multisig"})
  public void testOwnerName08() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, needCoin + 1000000, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Long balanceBefore = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceBefore: " + balanceBefore);
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name length is 32",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name length is 33",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name contains special char",
      groups = {"daily", "multisig"})
