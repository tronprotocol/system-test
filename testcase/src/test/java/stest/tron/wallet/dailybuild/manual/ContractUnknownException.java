...
public class ContractUnknownException extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "trigger selfdestruct method",
      groups = {"daily"})
  public void testGrammar001() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            grammarAddress, 1000000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalanceGetEnergy(
            grammarAddress, 204800000, 0, 1, testKeyForGrammarAddress, blockingStubFull));
    Account info;
    ...
    PublicMethod.unFreezeBalance(
        grammarAddress, testKeyForGrammarAddress, 1, grammarAddress, blockingStubFull);
    PublicMethod.freeResource(
        grammarAddress, testKeyForGrammarAddress, foundationAddress, blockingStubFull);
  }

  @Test(
      enabled = true,
      description = "trigger revert method",
      groups = {"daily"})
  public void testGrammar002() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            grammarAddress2, 100000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalanceGetEnergy(
            grammarAddress2, 10000000L, 0, 1, testKeyForGrammarAddress2, blockingStubFull));
    Account info;
    AccountResourceMessage resourceInfo =
        PublicMethod.getAccountResource(grammarAddress2, blockingStubFull);
    ...
    PublicMethod.unFreezeBalance(
        grammarAddress2, testKeyForGrammarAddress2, 1, grammarAddress2, blockingStubFull);
    PublicMethod.freeResource(
        grammarAddress2, testKeyForGrammarAddress2, foundationAddress, blockingStubFull);
  }

  @Test(
      enabled = true,
      description = "trigger assert method",
      groups = {"daily"})
  public void testGrammar003() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            grammarAddress3, 100000000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalanceGetEnergy(
            grammarAddress3, 1000000000L, 0, 1, testKeyForGrammarAddress3, blockingStubFull));
    Account info;
    AccountResourceMessage resourceInfo =
        PublicMethod.getAccountResource(grammarAddress3, blockingStubFull);
    ...
    Assert.assertTrue(beforeBalance - fee == afterBalance);
    PublicMethod.unFreezeBalance(
        grammarAddress3, testKeyForGrammarAddress3, 1, grammarAddress3, blockingStubFull);
    PublicMethod.freeResource(
        grammarAddress3, testKeyForGrammarAddress3, foundationAddress, blockingStubFull);
  }

  @Test(
      enabled = true,
      description = "trigger require method",
      groups = {"daily"})
  public void testGrammar004() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            grammarAddress4, 100000000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalanceGetEnergy(
            grammarAddress4, 100000000L, 0, 1, testKeyForGrammarAddress4, blockingStubFull));
    Account info;
    AccountResourceMessage resourceInfo =
        PublicMethod.getAccountResource(grammarAddress4, blockingStubFull);
    ...
    Assert.assertFalse(energyFee == 1000000000);
    PublicMethod.unFreezeBalance(
        grammarAddress4, testKeyForGrammarAddress4, 1, grammarAddress4, blockingStubFull);
    PublicMethod.freeResource(
        grammarAddress4, testKeyForGrammarAddress4, foundationAddress, blockingStubFull);
  }
