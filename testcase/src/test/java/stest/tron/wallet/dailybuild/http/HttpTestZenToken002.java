...
public class HttpTestZenToken002 {
  ...
  @Test(
      enabled = false,
      description = "Public to shield transaction by http",
      groups = {"daily", "serial"})
  public void test01PublicToShieldTransaction() {
    ...
    ShieldNoteInfo scanAndMarkNoteSendNote =
        HttpMethod.scanAndMarkNoteByIvk(httpnode, sendShieldAddressInfo.get()).get(0);
    Assert.assertFalse(scanAndMarkNoteSendNote.getIsSpend());
  }

  @Test(
      enabled = false,
      description = "Shield to shield transaction by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = false,
      description = "Scan note by ivk and scan not by ivk on FullNode by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = false,
      description = "Scan note by ivk and scan not by ivk on Solidity by http",
      groups = {"daily", "serial"})
  public void test04ScanNoteByIvkAndOvkFromSolidity() {
    ...
    noteByOvk =
        HttpMethod.scanNoteByOvkFromSolidity(httpSolidityNode, sendShieldAddressInfo.get()).get(0);
    noteByIvk =
        HttpMethod.scanNoteByIvkFromSolidity(httpSolidityNode, receiverShieldAddressInfo.get())
            .get(0);
    Assert.assertEquals(noteByIvk.getValue(), noteByOvk.getValue());
    Assert.assertEquals(noteByIvk.getMemo(), noteByOvk.getMemo());
    Assert.assertEquals(noteByIvk.getR(), noteByOvk.getR());
  ...
  @Test(
      enabled = false,
      description = "Scan note by ivk and scan not by ivk on PBFT by http",
      groups = {"daily", "serial"})
  public void test05ScanNoteByIvkAndOvkFromPbft() {
    ...
    noteByIvk =
        HttpMethod.scanNoteByIvkFromPbft(httpPbftNode, receiverShieldAddressInfo.get()).get(0);
    Assert.assertEquals(noteByIvk.getValue(), noteByOvk.getValue());
    Assert.assertEquals(noteByIvk.getMemo(), noteByOvk.getMemo());
    Assert.assertEquals(noteByIvk.getR(), noteByOvk.getR());
    Assert.assertEquals(noteByIvk.getPaymentAddress(), noteByOvk.getPaymentAddress());
  ...
  @Test(
      enabled = false,
      description = "Query whether note is spend on solidity by http",
      groups = {"daily", "serial"})
  public void test06QueryNoteIsSpendOnSolidity() {
    HttpMethod.waitToProduceOneBlockFromSolidity(httpnode, httpSolidityNode);
    Assert.assertTrue(
        HttpMethod.getSpendResultFromSolidity(
  ...
  @Test(
      enabled = false,
      description = "Query whether note is spend on PBFT by http",
      groups = {"daily", "serial"})
  public void test07QueryNoteIsSpendOnSolidity() {
    HttpMethod.waitToProduceOneBlockFromSolidity(httpnode, httpSolidityNode);
    Assert.assertTrue(
        HttpMethod.getSpendResultFromPbft(
  ...
  @Test(
      enabled = false,
      description = "Query note and spend status on fullnode",
      groups = {"daily", "serial"})
  public void test08QueryNoteAndSpendStatusOnFullnode() {
    ...
    ShieldNoteInfo scanAndMarkNoteReceiverNote =
        HttpMethod.scanAndMarkNoteByIvk(httpnode, receiverShieldAddressInfo.get()).get(0);
  ...
  @Test(
      enabled = false,
      description = "Query note and spend status on solidity",
      groups = {"daily", "serial"})
  public void test09QueryNoteAndSpendStatusOnSolidity() {
    ShieldNoteInfo scanAndMarkNoteSendNote =
        HttpMethod.scanAndMarkNoteByIvkFromSolidity(
  ...
  @Test(
      enabled = false,
      description = "Query note and spend status on PBFT",
      groups = {"daily", "serial"})
  public void test10QueryNoteAndSpendStatusOnPbft() {
    ShieldNoteInfo scanAndMarkNoteSendNote =
        HttpMethod.scanAndMarkNoteByIvkFromPbft(httpnode, httpPbftNode, sendShieldAddressInfo.get())
            .get(0);
    Assert.assertTrue(scanAndMarkNoteSendNote.isSpend);
    Assert.assertEquals(scanAndMarkNoteSendNote.getValue(), sendNote.getValue());
    Assert.assertEquals(scanAndMarkNoteSendNote.getMemo(), sendNote.getMemo());
    ...
    ShieldNoteInfo scanAndMarkNoteReceiverNote =
        HttpMethod.scanAndMarkNoteByIvkFromPbft(
  ...
  @Test(
      enabled = false,
      description = "Shield to public transaction by http",
      groups = {"daily", "serial"})
