...
public class TransferFailed004 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Suicide nonexistent target",
  ...
  public void test1SuicideNonexistentTarget() {
    ...
    contractAddress =
        PublicMethod.deployContractFallbackReceive(
            contractName,
            abi,
            code,
            "",
  ...
  @Test(
      enabled = true,
      description = "Suicide existent target",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Suicide nonexistent target, but revert",
      groups = {"contract", "daily"})
  public void test3SuicideNonexistentTargetRevert() {
    ...
    Account nonexistentAddressAccount =
        PublicMethod.queryAccount(nonexistentAddress1, blockingStubFull1);
    Assert.assertEquals(1000000L, nonexistentAddressAccount.getBalance());
  }

  @Test(
      enabled = true,
      description = "transfer to a suicide contract address same token",
      groups = {"contract", "daily"})
  public void test4transferToSuicideContractSameToken() {
    ...
    if (PublicMethod.allowTvmSelfdestructRestrictionIsActive(blockingStubFull)) {
      ...
      Account nonexistentAddressAccount =
          PublicMethod.queryAccount(contractAddress, blockingStubFull1);
  ...
  @Test(
      enabled = true,
      description = "transfer to a suicide contract address different token",
      groups = {"contract", "daily"})
  public void test5transferToSuicideContractDifferentToken() {
    ...
    Account info;
    AccountResourceMessage resourceInfo =
        PublicMethod.getAccountResource(contractExcAddress3, blockingStubFull);
