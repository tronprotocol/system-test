...
@Slf4j
public class DynamicEnergyTest001 extends TronBaseTest {
  ...
  public void beforeClass() throws Exception {
    PublicMethod.printAddress(testAccountKey);
  ...
  @Test(
      enabled = true,
      description = "Test get contract state",
      groups = {"daily"})
  public void test01GetContractStatus() throws Exception {
    ...
    TransactionInfo transactionInfo =
        PublicMethod.getTransactionInfoById(transactionId, blockingStubFull).get();
