...
@Slf4j
public class MultiSignExchangeContractTest002 extends TronBaseTest {
  ...
  public void test1CreateUsedAsset() {
    ...
    Assert.assertTrue(
        PublicMethod.freezeBalanceForReceiver(
            foundationAddress,
            100000000000L + PublicMethod.randomFreezeAmount.addAndGet(1),
            0,
            0,
  ...
  public void test2CreateExchange() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    exchangeId =
        PublicMethod.getExchangeIdByCreatorAddress(exchange001Address, blockingStubFull).intValue();
    Long balanceAfter =
        PublicMethod.queryAccount(exchange001Address, blockingStubFull).getBalance();
