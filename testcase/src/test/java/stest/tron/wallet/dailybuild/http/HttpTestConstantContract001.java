...
public class HttpTestConstantContract001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Get constant contract by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Trigger constant contract without parameterString by http",
      groups = {"daily", "serial"})
  public void test3TriggerConstantContract() {
    ...
    JSONObject transactionObject =
        HttpMethod.parseStringContent(responseContent.getString("transaction"));
  ...
  @Test(
      enabled = true,
      description = "Trigger constant contract with call_value",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = " estimate kill function by triggerconstant",
      groups = {"daily", "serial"})
