...
@Slf4j
public class constructorDefaultsTest extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Constructor default test",
      groups = {"contract", "daily"})
  public void Test01ConstructorDefault() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 200000000L, foundationAddress, foundationKey, blockingStubFull));
