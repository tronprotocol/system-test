...
public class ContractTrcToken077 extends TronBaseTest {
  ...
  public void testAddress001() {
    PublicMethod.sendcoin(
        grammarAddress, 100000000000L, foundationAddress, foundationKey, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "The value of address is not at the beginning of 41",
      groups = {"contract", "daily"})
  public void testAddress002() {
    ...
    String code =
        "608060405234801561001057600080fd5b50d3801561001d57600080fd5b50d2801561002a57600"
            + "080fd5b5060b0806100396000396000f3fe6080604052348015600f57600080fd5b50d38015601b57600"
            + "080"
            + "fd5b50d28015602757600080fd5b5060043610605c577c01000000000000000000000000000000000000"
            + "000"
            + "0000000000000000060003504636241c1d881146061575b600080fd5b60676079565b604080519182525"
            + "190"
            + "81900360200190f35b60405130908190529056fea165627a7a723058207b9b52e71420f2fa4cb55ffd55"
            + "641"
            + "355ec84e09d6d4545c629dde7cc01d74a100029";
    String abi =
        "[{\"constant\":false,\"inputs\":[],\"name\":\"addressTest\",\"outputs\":[{\"name"
            + "\":\"addressValue\",\"type\":\"bytes32\"}],\"payable\":false,\"stateMutability\":\"n"
            + "onp"
