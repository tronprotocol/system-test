...
@Slf4j
@MultiNode
public class TriggerConstant004 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "TriggerConstantContract a pure function without ABI", groups = {"contract", "daily"})
