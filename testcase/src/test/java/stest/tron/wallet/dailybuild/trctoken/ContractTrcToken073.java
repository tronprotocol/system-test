...
@Slf4j
public class ContractTrcToken073 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "TokenBalance with correct tokenValue and tokenId",
      groups = {"contract", "daily"})
  public void testTokenBalanceContract() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 11000_000_000L, fromAddress, foundationKey, blockingStubFull));
