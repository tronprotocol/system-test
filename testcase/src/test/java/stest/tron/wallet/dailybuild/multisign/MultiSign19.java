...
public class MultiSign19 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Active operation is ContractType.TransferContract_VALUE",
  ...
  @Test(
      enabled = true,
      description = "Active operation include invalid contract",
      groups = {"daily", "multisig"})
  public void testActiveOperations03() {
    ...
    Assert.assertEquals(
        "Contract validate error : 99 isn't a validate ContractType",
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "Contract validate error : 21 isn't a validate ContractType",
        response.getMessage().toStringUtf8());
    // operation's length is less then 64,
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "Contract validate error : operations size must 32", response.getMessage().toStringUtf8());
  ...
  @Test(
      enabled = true,
      description = "Owner sets operation",
      groups = {"daily", "multisig"})
  public void testActiveOperations04() {
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "Contract validate error : Owner permission needn't operations",
        response.getMessage().toStringUtf8());
    Long balanceAfter = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceAfter: " + balanceAfter);
    Assert.assertEquals(balanceBefore, balanceAfter);
  ...
  @Test(
      enabled = true,
      description = "Witness sets operation",
      groups = {"daily", "multisig"})
  public void testActiveOperations05() {
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "Contract validate error : Witness permission needn't operations",
        response.getMessage().toStringUtf8());
    Long balanceAfter = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceAfter: " + balanceAfter);
    Assert.assertEquals(balanceBefore, balanceAfter);
