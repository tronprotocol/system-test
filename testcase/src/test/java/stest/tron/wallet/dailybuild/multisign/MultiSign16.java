...
@Slf4j
public class MultiSign16 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Witness weight is exception condition",
  ...
  @Test(
      enabled = true,
      description = "Witness weight is 1",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Witness weight is Integer.MAX_VALUE",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Witness weight is Long.MAX_VALUE",
      groups = {"daily", "multisig"})
