...
public class StateTree001 extends JsonRpcBase {
  ...
  public void test01StateTreeWithEthGetBalance() throws Exception {
    PublicMethod.sendcoin(
        ...
        sendAmount,
        PublicMethod.getFinalAddress(foundationKey001),
        foundationKey001,
        blockingStubFull);
    ...
    final Long afterBalance =
        PublicMethod.queryAccount(getBalanceTestAddress, blockingStubFull).getBalance();
  ...
  @Test(
      enabled = true,
      description = "State tree with tron_getAssets",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "State tree with tron_getAssetById",
      groups = {"daily", "serial"})
  ...
  public void test04StateTreeWithEthCall() throws Exception {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.getTransactionInfoById(trc20Txid01, blockingStubFull).get().getLogCount()
            == 1);
  ...
  public void test05StateTreeWithEthGetCode() throws Exception {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertEquals(
        PublicMethod.getTransactionInfoById(txid02, blockingStubFull)
            .get()
            .getReceipt()
            .getResult(),
  ...
  public void test06StateTreeWithEthGetStorageAt() throws Exception {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertEquals(
        PublicMethod.getTransactionInfoById(txid00, blockingStubFull)
            .get()
            .getReceipt()
            .getResult(),
        contractResult.SUCCESS);
  ...
  public void test07StateTreeWithEthGetStorageAt() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertEquals(
        PublicMethod.getTransactionInfoById(txid01, blockingStubFull)
            .get()
            .getReceipt()
            .getResult(),
        contractResult.SUCCESS);
