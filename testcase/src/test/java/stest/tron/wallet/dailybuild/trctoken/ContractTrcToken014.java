...
@Slf4j
@MultiNode
public class ContractTrcToken014 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "TransferToken with tokenId in exception condition,"
      + " deploy transfer contract", groups = {"contract", "daily"})
  public void test01DeployTransferTokenContract() {
    ...
    Assert.assertTrue(PublicMethod.sendcoin(user001Address, 11000_000_000L, fromAddress,
        testKey002, blockingStubFull));
  ...
  //dev Create a new AssetIssue success.
    Assert.assertTrue(PublicMethod.createAssetIssue(dev001Address, tokenName, TotalSupply,
  ...
  //user Create a new AssetIssue success.
    Assert.assertTrue(PublicMethod.createAssetIssue(user001Address, tokenName, TotalSupply,
        1, 10000, start, end, 1, description, url, 100000L,
        100000L, 1L, 1L, user001Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);

    assetAccountUser = PublicMethod.queryAccount(
    ...
    assetAccountId = PublicMethod.queryAccount(
  ...
  Long devAssetCountBefore = PublicMethod.getAssetIssueValue(
  ...
  @Test(enabled = true, description = "TransferToken with tokenId in exception condition,"
      + " deploy receiver contract", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "TransferToken with tokenId in exception condition,"
      + " transfer to contract", groups = {"contract", "daily"})
  ...
  Long receiveAssetBefore = PublicMethod.getAssetIssueValue(resultContractAddress,
        assetAccountId, blockingStubFull);
  ...
  Long devAssetAfter = PublicMethod.getAssetIssueValue(dev001Address,
        assetAccountId, blockingStubFull);
