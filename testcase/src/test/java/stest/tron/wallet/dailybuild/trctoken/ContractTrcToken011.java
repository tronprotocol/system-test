...
public class ContractTrcToken011 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "TransferToken with correct value, deploy transfer contract", groups = {"contract", "daily"})
  public void test01DeployTransferTokenContract001() {
    Assert.assertTrue(PublicMethod.sendcoin(dev001Address, 15048_000_000L, fromAddress,
        testKey002, blockingStubFull));
    Assert.assertTrue(PublicMethod.sendcoin(user001Address, 14048_000_000L, fromAddress,
        testKey002, blockingStubFull));
...
//        0, 0, ByteString.copyFrom(dev001Address), testKey002, blockingStubFull));
  ...
  @Test(enabled = true, description = "TransferToken with correct value, deploy receive contract", groups = {"contract", "daily"})
...
//    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  String code = retMap.get("byteCode").toString();
  String abi = retMap.get("abI").toString();
  final String recieveTokenTxid = PublicMethod
  ...
  @Test(enabled = true, description = "TransferToken with correct value, transfer to a contract", groups = {"contract", "daily"})
...
//        ByteString.copyFrom(user001Address), testKey002, blockingStubFull));
  ...
  @Test(enabled = true, description = "TransferToken with correct value, get contract tokenBalance", groups = {"contract", "daily"})
...
//    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    long userEnergyLimitBefore = accountResource.getEnergyLimit();
    long userEnergyUsageBefore = accountResource.getEnergyUsed();
    long userBalanceBefore = PublicMethod.queryAccount(user001Address,
  ...
  Long assetIssueCount = PublicMethod
