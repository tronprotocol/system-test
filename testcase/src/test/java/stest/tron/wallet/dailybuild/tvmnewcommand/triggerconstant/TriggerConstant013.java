...
public class TriggerConstant013 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "triggerContract a constant function created by create2", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "TriggerConstantContract a constant function "
          + "created by create2 on pbft", groups = {"contract", "daily"})
