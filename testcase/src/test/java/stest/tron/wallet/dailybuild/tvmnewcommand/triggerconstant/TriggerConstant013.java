...
@Slf4j
@MultiNode
public class TriggerConstant013 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "triggerContract a constant function created by create2",
  ...
  public void test15TriggerConstantContract() {
    ...
    SmartContract smartContract = PublicMethod.getContract(returnAddressBytes, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description =
          "TriggerConstantContract a constant function " + "created by create2 on solidity",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description =
          "TriggerConstantContract a constant function " + "created by create2 on real solidity",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "TriggerConstantContract a constant function " + "created by create2 on pbft",
      groups = {"contract", "daily"})
