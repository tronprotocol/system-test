...
@Slf4j
public class MultiSignAccountTest extends TronBaseTest {  private String operations = Configuration.getByPath("testng.conf")
  ...
  public void testMultiSignForAccount() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(ownerAddress, needCoin + 200000000L, foundationAddress, foundationKey,
            blockingStubFull));

    Assert.assertTrue(PublicMethod
        .freezeBalanceForReceiver(foundationAddress, 2000000000, 0, 0, ByteString.copyFrom(ownerAddress),
