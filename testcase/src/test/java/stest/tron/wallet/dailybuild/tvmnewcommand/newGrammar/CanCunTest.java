...
public class CanCunTest extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "nonreentrant for entrant 1 time",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "call nonreentrant once",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "call nonreentrant for 2 times ",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "TSTORE will also REVERT if called during a STATICCALL",
      groups = {"contract", "daily"})
