...
public class EstimateEnergyTest001 extends TronBaseTest {
  ...
  public void beforeClass() throws Exception {
    ...
    Optional<Protocol.TransactionInfo> infoById =
        PublicMethod.getTransactionInfoById(txid, blockingStubFull2);
  ...
  @Test(
      enabled = true,
      description = "EstimateEnergy to a Revert Function",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Estimate a function which has emit a event",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Estimate nonexistent function",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Estimate payable function",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Estimate TRC20 important function",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Estimate compare to eth_estimateEnergy",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Estimate function with call_value bug-fix call refund",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Estimate function with call_value and command after call",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Estimate function out_of_time",
      groups = {"daily"})
