...
@Slf4j
public class EstimateEnergyTest001 extends TronBaseTest {
  ...
  public void beforeClass() throws Exception {    channelFull2 = ManagedChannelBuilder.forTarget(fullnode2)
        .usePlaintext()
        .build();
  ...
  String deployTrc20Txid =
    ...
    Optional<Protocol.TransactionInfo> info =
        PublicMethod.getTransactionInfoById(deployTrc20Txid, blockingStubFull2);
  ...
  String contractNameTrc721 = "TRC721Token";
    retMap = PublicMethod.getBycodeAbi(filePathTrc721, contractNameTrc721);
  String codeTrc721 = retMap.get("byteCode").toString();
  String abiTrc721 = retMap.get("abI").toString();

    contractAddressTrc721 = PublicMethod.deployContract(
   ...
   * constructor.
   */
  @Test(enabled = true, description = "EstimateEnergy request fullnode solidity pbft", groups = {"daily"})
  ...
  //if do not wait, contact can be null
    PublicMethod.waitSolidityNodeSynFullNodeData(blockingStubFull2, blockingStubFullSolidity);
  ...
  //query solidity , query pbft
    Optional<GrpcAPI.EstimateEnergyMessage> estimateEnergyMessageSolidity =
        PublicMethod.estimateEnergySolidity(
    ...
    Optional<GrpcAPI.EstimateEnergyMessage> estimateEnergyMessagePbft =
        PublicMethod.estimateEnergySolidity(blockingStubPbft,
   ...
   * constructor.
   */
  @Test(enabled = true, description = "EstimateEnergy to a Revert Function", groups = {"daily"})
  ...
  //give a non payable function a callValue to make REVERT opcode executed
    Optional<GrpcAPI.EstimateEnergyMessage> estimateEnergyMessage =
        PublicMethod.estimateEnergy(blockingStubFull2, foundationAddress,
   ...
   * constructor.
   */
  @Test(enabled = true, description = "EstimateEnergy use to calculate feelimit can be triggered success", groups = {"daily"})
  ...
  final String ownerKey = ByteArray.toHexString(ecKey1.getPrivKeyBytes());
    Assert.assertTrue(
        PublicMethod.sendcoin(ownerAddress, 100000000L,
  ...
  String args = "6";
    boolean isHex = false;
    Optional<GrpcAPI.EstimateEnergyMessage> estimateEnergyMessage =
        PublicMethod.estimateEnergy(blockingStubFull2, ownerAddress,
            contractAddress, 0, method, args, isHex, 0, null);
    Assert.assertEquals(estimateEnergyMessage.get().getResult().getCode().toString(), "SUCCESS");
  Long energyEstimateRequired = estimateEnergyMessage.get().getEnergyRequired();
    GrpcAPI.TransactionExtention te =
  ...
  String triggerTxidSuccess =
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull2);
    Optional<Protocol.TransactionInfo> info =
        PublicMethod.getTransactionInfoById(triggerTxidSuccess, blockingStubFull2);
  ...
  //if feelimit is low , OUT_OF_ENERGY
    args = "8";
    te =  PublicMethod.triggerConstantContractForExtention(
        contractAddress, method, args, false, 0,
        maxFeeLimit, "#", 0L, ownerAddress, ownerKey, blockingStubFull2);
  ...
  String triggerTxidFail =
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull2);
    info = PublicMethod.getTransactionInfoById(triggerTxidFail, blockingStubFull2);
    logger.info(info.get().getReceipt().toString());
   ...
   * constructor.
   */
  @Test(enabled = true, description = "TriggerConstantContract use to calculate feelimit boundary value test", groups = {"daily"})
  ...
  final String ownerKey = ByteArray.toHexString(ecKey1.getPrivKeyBytes());
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(ownerAddress, 10000000000L,
            foundationAddress, foundationKey, blockingStubFull2));
    PublicMethod.waitProduceNextBlock(blockingStubFull2);
  ...
  String failTxid =
    ...
    Optional<Protocol.TransactionInfo> infofail =
        PublicMethod.getTransactionInfoById(failTxid, blockingStubFull2);
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Estimate a function which has emit a event", groups = {"daily"})
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Estimate nonexistent function", groups = {"daily"})
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Estimate payable function", groups = {"daily"})
  ...
  String args = "";
    ...
    Assert.assertEquals(estimateEnergyMessage.get().getResult().getCode().toString(), "SUCCESS");
  Long energyEstimateRequired = estimateEnergyMessage.get().getEnergyRequired();
    GrpcAPI.TransactionExtention te =  PublicMethod.triggerConstantContractForExtention(
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Estimate TRC20 important function", groups = {"daily"})
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Estimate compare to eth_estimateEnergy", groups = {"daily"})
  ...
  //fullnode1 vm.estimateEnergy = false  fullnode2 vm.estimateEnergy = true
    ...
    Optional<GrpcAPI.EstimateEnergyMessage> estimateEnergyMessage =
        PublicMethod.estimateEnergy(blockingStubFull, foundationAddress,
            contractAddress, 0, method, args, isHex, 0, null);
    logger.info(estimateEnergyMessage.get().toString());
    Assert.assertEquals(
  ...
  //query fullnode2
    ...
    estimateEnergyMessage = PublicMethod.estimateEnergy(
        blockingStubFull2, foundationAddress, contractAddress, 0, method, args, isHex, 0, null);
    Assert.assertEquals(estimateEnergyMessage.get().getResult().getCode().toString(), "SUCCESS");
  Long energyEstimateRequired = estimateEnergyMessage.get().getEnergyRequired();
    GrpcAPI.TransactionExtention te =
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Estimate TRC721 important function", groups = {"daily"})
   ...
   */
  @Test(enabled = true,
      description = "Estimate TRC721 important function", groups = {"daily"})
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Estimate function with call_value bug-fix call refund", groups = {"daily"})
  ...
  String txid = PublicMethod.triggerContract(contractAddress, method, args,
        false, 10, maxFeeLimit, foundationAddress, foundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Optional<Protocol.TransactionInfo> infoById = PublicMethod.getTransactionInfoById(txid, blockingStubFull);
    ...
    txid = PublicMethod.triggerContract(contractAddress, method, args,
...
//    Assert.assertEquals(Protocol.Transaction.Result.contractResult.OUT_OF_ENERGY, infoById.get().getReceipt().getResult());
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Estimate function with call_value and command after call", groups = {"daily"})
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Estimate function out_of_time", groups = {"daily"})
