...
@Slf4j
@Flaky(
    reason = "Requires specific SR voting state, sensitive to block timing",
    since = "2026-04-03")
public class TvmVote extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "query reward balance",
  ...
  @Test(
      enabled = true,
      description = "freeze balance and vote witness",
      groups = {"contract", "daily"})
  public void test02VoteWitness() {
    ...
    transactionInfo = PublicMethod.getTransactionInfoById(triggerTxid, blockingStubFull);
    Assert.assertEquals(0, transactionInfo.get().getResultValue());
    Assert.assertEquals(
        Protocol.Transaction.Result.contractResult.SUCCESS,
        transactionInfo.get().getReceipt().getResult());
  ...
  @Test(
      enabled = true,
      description = "query contract address is Sr Candidate or not",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "query sr address is Sr Candidate or not",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "query zero address is Sr Candidate or not",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "query sr's total vote count",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "query contract's total vote count",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "query contract used vote count",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "query witnesses received vote count",
      groups = {"contract", "daily"})
