...
@Slf4j
public class WalletTestZenToken003 extends TronBaseTest {
  ...
  public void test1Public2ShieldTransaction() {
    ...
    final Long beforeNetUsed =
        PublicMethod.getAccountResource(zenTokenOwnerAddress, blockingStubFull).getFreeNetUsed();
    ...
    shieldOutList =
        PublicMethod.addShieldOutputList(
            shieldOutList, shieldAddress1, "" + sendToShiledAddress1Amount, memo1);
    String memo2 = "Public to  shield address2 transaction";
    shieldOutList =
        PublicMethod.addShieldOutputList(
            shieldOutList, shieldAddress2, "" + sendToShiledAddress2Amount, memo2);
    txid =
        PublicMethod.sendShieldCoinGetTxid(
            zenTokenOwnerAddress,
            costTokenAmount,
            null,
            null,
  ...
  public void test2Public2OneShieldAndOnePublicTransaction() {
    ...
    final Long beforeBalance =
        PublicMethod.queryAccount(receiverPublicAddress, blockingStubFull).getBalance();
    Long sendToShiledAddress1Amount = 1 * zenTokenFee;
    // When receiver public address don't active,the fee is 1000000
    Long sendToPublicAddressAmount =
        costTokenAmount - sendToShiledAddress1Amount - zenTokenWhenCreateNewAddress;
    ...
    Assert.assertEquals(receiverShieldTokenAmount1, sendToShiledAddress1Amount);
    Assert.assertEquals(memo1, PublicMethod.getMemo(note));
    Long afterReceiverPublicAssetBalance =
        PublicMethod.getAssetIssueValue(
            receiverPublicAddress,
            PublicMethod.queryAccount(foundationZenTokenKey, blockingStubFull).getAssetIssuedID(),
            blockingStubFull);
  ...
  public void test3Public2OneShieldAndOnePublicTransaction() {
    ...
    final Long sendToPublicAddressAmount =
        costTokenAmount - sendToShiledAddress1Amount - sendToShiledAddress2Amount - zenTokenFee;
    shieldOutList.clear();
    String memo1 = "Public to  shield address1 transaction";
    shieldOutList =
        PublicMethod.addShieldOutputList(
    ...
    shieldOutList =
        PublicMethod.addShieldOutputList(
            shieldOutList, shieldAddress2, "" + sendToShiledAddress2Amount, memo2);
    final Long beforeReceiverPublicAssetBalance =
        PublicMethod.getAssetIssueValue(
            receiverPublicAddress,
            PublicMethod.queryAccount(foundationZenTokenKey, blockingStubFull).getAssetIssuedID(),
            blockingStubFull);
    ...
    Long afterReceiverPublicAssetBalance =
        PublicMethod.getAssetIssueValue(
            ...
            blockingStubFull);
    Assert.assertTrue(
        afterReceiverPublicAssetBalance - beforeReceiverPublicAssetBalance
            == sendToPublicAddressAmount);
  }
  ...
  public void test4Public2OneShieldAndOneSmartContractAddressTransaction() {
    ...
    String code =
        "608060405260ff806100126000396000f30060806040526"
  ...
  public void test5Public2TwoSameShieldAddress() {
    ...
    shieldOutList =
        PublicMethod.addShieldOutputList(
            shieldOutList, shieldAddress1, "" + sendToShiledAddress2Amount, memo2);
    txid =
        PublicMethod.sendShieldCoinGetTxid(
            zenTokenOwnerAddress,
            costTokenAmount,
