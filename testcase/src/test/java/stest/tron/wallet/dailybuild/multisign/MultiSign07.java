...
public class MultiSign07 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is owner",
  ...
  public void testActiveName01() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, needCoin + 1000000, foundationAddress, testKey002, blockingStubFull));
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is active",
      groups = {"daily", "multisig"})
  public void testActiveName02() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, needCoin + 1_000000, foundationAddress, testKey002, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Long balanceBefore = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceBefore: " + balanceBefore);
    PublicMethod.printAddress(ownerKey);
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is activea",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is \"123\"",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is \"\"",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name in exception condition",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner permission_name is 1.1",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Active permission_name length is 32",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Active permission_name length is 33",
      groups = {"daily", "multisig"})
  public void testActiveName09() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, 1000000, foundationAddress, testKey002, blockingStubFull));
    ...
    Assert.assertEquals(
        "Contract validate error : permission's name is too long",
