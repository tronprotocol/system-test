...
public class ContractGrammar002 extends TronBaseTest {
  ...
  public void beforeClass() {
    initSolidityChannel();
    PublicMethod.printAddress(testKeyForGrammarAddress2);
  ...
  @Test(
      enabled = true,
      description = "Interface type function",
  ...
  @Test(
      enabled = true,
      description = "Call a Destructor function",
      groups = {"contract", "daily"})
