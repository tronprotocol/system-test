...
@Slf4j
public class tryCatchTest002 extends TronBaseTest {
  ...
  @Test(enabled = true,  description = "try catch [new] revert no msg", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "try catch [new] revert msg", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "try catch [new] Require no msg", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "try catch [new] Require msg", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "try catch [new] assert", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "try catch [new] transfer fail", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "try catch [new] Send_Error", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "try catch [new] Math_Error", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "try catch [new] ArrayOverFlow_Error", groups = {"contract", "daily"})
