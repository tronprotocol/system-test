...
public class WalletTestAssetIssue018 extends TronBaseTest {
  ...
  public void beforeClass() {
    PublicMethod.printAddress(assetAccount1Key);
  ...
  public void test1AssetIssueNameBelow32Char() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            assetAccount4Address, 2048000000, foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.sendcoin(
            assetAccount5Address, 2048000000, foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.sendcoin(
            assetAccount6Address, 2048000000, foundationAddress, foundationKey, blockingStubFull));
  ...
  public void test2SameAssetissueName() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            assetAccount1Address, 2048000000, foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.sendcoin(
            assetAccount2Address, 2048000000, foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.sendcoin(
            assetAccount3Address, 2048000000, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
