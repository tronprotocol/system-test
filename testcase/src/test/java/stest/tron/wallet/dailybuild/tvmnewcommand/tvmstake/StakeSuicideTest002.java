...
public class StakeSuicideTest002 extends TronBaseTest {
  ...
  @Test(
      enabled = false,
      description = "create2 -> stake -> suicide -> create2 the same Address",
  ...
  public void stackSuicideAndCreate2Test001() {
    ...
    String hex =
        "41" + ByteArray.toHexString(ex.get().getContractResult(0).toByteArray()).substring(24);
  ...
  @Test(
      enabled = false,
      description = "create2 -> stake -> suicide -> sendcoin to create2 Address",
      groups = {"contract", "daily"})
  public void stackSuicideAndCreate2Test002() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, sendcoin, testFoundationAddress, testFoundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
