...
@Slf4j
public class MultiSignAccountTest002 extends TronBaseTest {
  ...
  public void testMultiSignForAccount() {
    ...
    if (!PublicMethod.freezeV2ProposalIsOpen(blockingStubFull)) {
      ...
      Assert.assertTrue(
          PublicMethodForMultiSign.createAccount1(
      ...
      Assert.assertTrue(
          PublicMethodForMultiSign.freezeBalanceGetEnergyWithPermissionId(
              ...
              1000000L,
              0,
              PublicMethod.tronPowerProposalIsOpen(blockingStubFull) ? 2 : 1,
              ownerKey,
              blockingStubFull,
              2,
              permissionKeyString));
