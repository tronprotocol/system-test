...
public class TvmAssetIssue005 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 7000_000_000L, fromAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  }

  @Test(
      enabled = false,
      description = "tokenIssue and updateAsset with suicide to account",
  ...
  public void tokenIssue001AndSuicideToAccount() {
    ...
    AssetIssueContract assetIssueByAccount =
        PublicMethod.getAssetIssueByAccount(contractAddress, blockingStubFull)
            .get()
            .getAssetIssue(0);
    AssetIssueContract assetIssueListByName =
        PublicMethod.getAssetIssueListByName(name, blockingStubFull).get().getAssetIssue(0);
    ...
    Assert.assertEquals(abbr, ByteArray.toStr(assetIssueById.getAbbr().toByteArray()));
    Assert.assertEquals(
        description, ByteArray.toStr(assetIssueById.getDescription().toByteArray()));
    ...
    Assert.assertEquals(0, infoById.get().getResultValue());
    Assert.assertEquals(
        0, PublicMethod.queryAccount(contractAddress, blockingStubFull).getAssetIssuedID().size());
    Assert.assertEquals(
        0,
        PublicMethod.getAssetIssueByAccount(dev003Address, blockingStubFull)
            .get()
            .getAssetIssueCount());
    Assert.assertEquals(
        0, PublicMethod.queryAccount(dev003Address, blockingStubFull).getAssetIssuedID().size());
    long contractAssetCountDev003 =
        PublicMethod.getAssetIssueValue(
            dev003Address, ByteString.copyFrom(assetIssueId.getBytes()), blockingStubFull);
    Assert.assertEquals(assetIssueValueAfter, contractAssetCountDev003);
    assetIssueValue =
        PublicMethod.queryAccount(dev003Address, blockingStubFull)
            .getAssetV2Map()
            .get(assetIssueId);
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev002Address, 100_000_000L, fromAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    // transferAsset,success
    Assert.assertTrue(
        PublicMethod.transferAsset(
            dev002Address,
            assetIssueId.getBytes(),
            100L,
            dev003Address,
            dev003Key,
            blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    long assetIssueValueDev002 =
        PublicMethod.getAssetIssueValue(
            dev002Address, ByteString.copyFrom(assetIssueId.getBytes()), blockingStubFull);
    long assetIssueValueDev003 =
        PublicMethod.getAssetIssueValue(
            dev003Address, ByteString.copyFrom(assetIssueId.getBytes()), blockingStubFull);
    ...
    Assert.assertTrue(
        PublicMethod.transferAsset(
            ...
            blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    long assetIssueValueDev002After =
        PublicMethod.getAssetIssueValue(
            dev002Address, ByteString.copyFrom(assetIssueId.getBytes()), blockingStubFull);
    long assetIssueValueDev004 =
        PublicMethod.getAssetIssueValue(
            dev004Address, ByteString.copyFrom(assetIssueId.getBytes()), blockingStubFull);
  ...
  @Test(
      enabled = false,
      description = "tokenIssue and updateAsset with suicide to contract",
      groups = {"contract", "daily"})
  public void tokenIssue002AndSuicideToContract() {
    ...
    Assert.assertNotNull(smartContract.getAbi());
    long contractAddressBalance2 =
        PublicMethod.queryAccount(contractAddress2, blockingStubFull).getBalance();
    ...
    deployTxid =
        PublicMethod.deployContractAndGetTransactionInfoById(
            ...
            blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethod.getTransactionInfoById(deployTxid, blockingStubFull);
    logger.info("Deploy energytotal is " + infoById.get().getReceipt().getEnergyUsageTotal());
    if (deployTxid == null || infoById.get().getResultValue() != 0) {
      Assert.fail(
          "deploy transaction failed with message: "
    ...
    Assert.assertEquals(0, infoById.get().getResultValue());
    String assetIssueId =
        PublicMethod.queryAccount(contractAddress2, blockingStubFull)
            .getAssetIssuedID()
            .toStringUtf8();
    logger.info("assetIssueId: " + assetIssueId);
    long returnAssetId = ByteArray.toLong((infoById.get().getContractResult(0).toByteArray()));
    ...
    logger.info(
        "getAssetV2Map(): "
            + PublicMethod.queryAccount(contractAddress2, blockingStubFull).getAssetV2Map());
    long assetIssueValue =
        PublicMethod.queryAccount(contractAddress2, blockingStubFull)
            .getAssetV2Map()
            .get(assetIssueId);
    ...
    AssetIssueContract assetIssueByName = PublicMethod.getAssetIssueByName(name, blockingStubFull);
    AssetIssueContract assetIssueByAccount =
        PublicMethod.getAssetIssueByAccount(contractAddress2, blockingStubFull)
            .get()
            .getAssetIssue(0);
    AssetIssueContract assetIssueListByName =
        PublicMethod.getAssetIssueListByName(name, blockingStubFull).get().getAssetIssue(0);
    ...
    Assert.assertEquals(name, ByteArray.toStr(assetIssueByAccount.getName().toByteArray()));
    Assert.assertEquals(assetIssueId, assetIssueListByName.getId());
    long contractAddressBalanceAfter2 =
        PublicMethod.queryAccount(contractAddress2, blockingStubFull).getBalance();
    ...
    param = "\"" + Base58.encode58Check(contractAddress) + "\"," + 50 + ",\"" + assetIssueId + "\"";
    txid =
        PublicMethod.triggerContract(
            contractAddress2,
            methodTransferToken,
    ...
    logger.info(infoById.toString());
    Assert.assertEquals(0, infoById.get().getResultValue());
    long assetIssueValueAfter2 =
        PublicMethod.queryAccount(contractAddress2, blockingStubFull)
            .getAssetV2Map()
            .get(assetIssueId);
    long contractAssetValue =
        PublicMethod.getAssetIssueValue(
            contractAddress, ByteString.copyFrom(assetIssueId.getBytes()), blockingStubFull);
    ...
    Assert.assertEquals(0, infoById.get().getResultValue());
    Assert.assertEquals(
        0, PublicMethod.queryAccount(contractAddress2, blockingStubFull).getAssetIssuedID().size());
    Assert.assertEquals(
        0,
        PublicMethod.getAssetIssueByAccount(contractAddress, blockingStubFull)
            .get()
  ...
  @Test(
      enabled = false,
      description = "tokenIssue and updateAsset suicide with create2",
      groups = {"contract", "daily"})
  public void tokenIssue003AndSuicideWithCreate2() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            callContractAddress, 1500_000_000L, fromAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    Assert.assertEquals(0, infoById.get().getResultValue());
    String assetIssueId =
        PublicMethod.queryAccount(callContractAddress, blockingStubFull)
            .getAssetIssuedID()
            .toStringUtf8();
    logger.info("assetIssueId: " + assetIssueId);
    long returnAssetId = ByteArray.toLong((infoById.get().getContractResult(0).toByteArray()));
    ...
    Assert.assertEquals(
        2,
        PublicMethod.getAssetIssueByAccount(callContractAddress, blockingStubFull)
            .get()
            .getAssetIssueCount());
    // updateAsset
    String methodUpdateAsset = "updateAsset(trcToken,string,string)";
    ...
    long returnId = ByteArray.toLong((infoById.get().getContractResult(0).toByteArray()));
    Assert.assertEquals(1, returnId);
    String newAssetIssueId =
        PublicMethod.queryAccount(callContractAddress, blockingStubFull)
            .getAssetIssuedID()
            .toStringUtf8();
    logger.info("newAssetIssueId: " + newAssetIssueId);
    AssetIssueContract newAssetIssueById =
        PublicMethod.getAssetIssueById(newAssetIssueId, blockingStubFull);
    Assert.assertEquals(
        "testAssetIssue_11111", ByteArray.toStr(newAssetIssueById.getName().toByteArray()));
    Assert.assertEquals(
        "testAssetIssue_22222", ByteArray.toStr(newAssetIssueById.getAbbr().toByteArray()));
    Assert.assertEquals(
        "updateDESCDESC", ByteArray.toStr(newAssetIssueById.getDescription().toByteArray()));
    ...
    Assert.assertEquals(
        Base58.encode58Check(callContractAddress),
        Base58.encode58Check(newAssetIssueById.getOwnerAddress().toByteArray()));

    AssetIssueContract oldAssetIssueById =
        PublicMethod.getAssetIssueById(assetIssueId, blockingStubFull);
