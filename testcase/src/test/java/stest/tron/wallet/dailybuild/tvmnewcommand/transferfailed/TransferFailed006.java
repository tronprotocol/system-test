...
public class TransferFailed006 extends TronBaseTest {
  ...
  public void deployContract() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            accountExcAddress, 10000000000L, foundationAddress, foundationKey, blockingStubFull));
  ...
  public void triggerContract() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            contractAddress, 1000100L, accountExcAddress, accountExcKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.sendcoin(
            contractAddress1, 1, accountExcAddress, accountExcKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
