...
public class PayableTest extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "payable(address) transfer",
      groups = {"contract", "daily"})
  public void tryCatchTest001() {

    Account account =
        PublicMethod.queryAccount(
            PublicMethod.decode58Check("TBXSw8fM4jpQkGc6zZjsVABFpVN7UvXPdV"), blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "payable(address) send",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "payable(address(contract)) transfer",
      groups = {"contract", "daily"})
  public void tryCatchTest003() {
    ...
    Account account = PublicMethod.queryAccount(AContract, blockingStubFull);
    Long balanceBefore = account.getBalance();
