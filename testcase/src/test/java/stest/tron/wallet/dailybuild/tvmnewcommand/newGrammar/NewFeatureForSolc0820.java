...
public class NewFeatureForSolc0820 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    SmartContractOuterClass.SmartContract smartContract =
        PublicMethod.getContract(contract1, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "test using for T global inside sol",
  ...
  @Test(
      enabled = true,
      description = "test using for T global beside sol",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test external library functions in ``using for``",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test public library functions in ``using for`` ",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test internal library functions in ``using for`` ",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "emit event by a contract but defined outside of it.",
      groups = {"contract", "daily"})
