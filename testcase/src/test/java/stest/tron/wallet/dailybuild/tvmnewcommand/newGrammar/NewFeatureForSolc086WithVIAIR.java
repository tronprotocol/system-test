...
public class NewFeatureForSolc086WithVIAIR extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    HashMap retMap =
        PublicMethod.getBycodeAbiWithParam(filePath, contractName, "--experimental-via-ir");
  ...
  @Test(
      enabled = true,
      description = "get address code length",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "fix kecca256 bug: differt length return same code",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "revert error type with params",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "revert error type no params",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test bytes convert to byteN overflow",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test bytes convert to byteN underflow",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "get contract address by different function",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test bytes concat with empty string",
      groups = {"contract", "daily"})
