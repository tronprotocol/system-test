...
@Slf4j
@MultiNode
public class Create2Test013 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "Trigger factory contract to deploy test contract", groups = {"contract", "daily"})
  ...
  @Test(enabled = false, description = "Trigger test1 contract", groups = {"contract", "daily"})
