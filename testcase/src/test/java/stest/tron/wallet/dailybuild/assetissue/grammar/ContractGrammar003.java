...
public class ContractGrammar003 extends TronBaseTest {
  ...
  public void beforeClass() {
    initSolidityChannel();
    PublicMethod.printAddress(testKeyForGrammarAddress3);
  ...
  public void test1Grammar014() {
    ...
    Long returnnumber5 =
        ByteArray.toLong(
            ByteArray.fromHexString(
                ByteArray.toHexString(infoById5.get().getContractResult(0).toByteArray())));
    ...
    Long returnnumber6 =
        ByteArray.toLong(
            ByteArray.fromHexString(
                ByteArray.toHexString(infoById6.get().getContractResult(0).toByteArray())));

    Assert.assertTrue(returnnumber6 == 1);
    String txid7 =
        PublicMethod.triggerContract(
            contractAddress,
            "callcodeTest(address,uint256)",
            initParmes,
            false,
            0,
            maxFeeLimit,
    ...
    Long returnnumber8 =
        ByteArray.toLong(
            ByteArray.fromHexString(
                ByteArray.toHexString(infoById8.get().getContractResult(0).toByteArray())));
    ...
    Long returnnumber9 =
        ByteArray.toLong(
            ByteArray.fromHexString(
                ByteArray.toHexString(infoById9.get().getContractResult(0).toByteArray())));

    Assert.assertTrue(returnnumber9 == 1);
    String txid10 =
        PublicMethod.triggerContract(
            contractAddress,
            "delegatecallTest(address,uint256)",
            initParmes,
            false,
            0,
            maxFeeLimit,
    ...
    Long returnnumber11 =
        ByteArray.toLong(
            ByteArray.fromHexString(
                ByteArray.toHexString(infoById11.get().getContractResult(0).toByteArray())));
    ...
    Long returnnumber12 =
        ByteArray.toLong(
            ByteArray.fromHexString(
                ByteArray.toHexString(infoById12.get().getContractResult(0).toByteArray())));
    ...
    Long returnnumber14 =
        ByteArray.toLong(
            ByteArray.fromHexString(
                ByteArray.toHexString(infoById14.get().getContractResult(0).toByteArray())));
    ...
    Long returnnumber15 =
        ByteArray.toLong(
            ByteArray.fromHexString(
                ByteArray.toHexString(infoById15.get().getContractResult(0).toByteArray())));
  ...
  public void test2Grammar015() {
    ...
    String resultvalue =
        ByteArray.toHexString(
            infoById.get().getLogList().get(0).getTopicsList().get(0).toByteArray());
    Assert.assertTrue(infoById.get().getResultValue() == 0);
    ...
    String resultvalue1 =
        ByteArray.toHexString(
            infoById1.get().getLogList().get(0).getTopicsList().get(0).toByteArray());
    Assert.assertTrue(infoById1.get().getResultValue() == 0);
  ...
  public void test4Grammar017() {
    ...
    Optional<TransactionInfo> infoById1 =
        PublicMethod.getTransactionInfoById(txid1, blockingStubFull1);
    Long returnnumber2 =
        ByteArray.toLong(
            ByteArray.fromHexString(
                ByteArray.toHexString(infoById1.get().getContractResult(0).toByteArray())));
  ...
  @Test(
      enabled = true,
      description = "Trx and sun unit conversion.",
      groups = {"contract", "daily"})
  ...
  public void shutdown() throws InterruptedException {
    PublicMethod.freeResource(
        grammarAddress3, testKeyForGrammarAddress3, testNetAccountAddress, blockingStubFull);
