...
@Slf4j
@MultiNode
public class batchValidateSignContract001 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Correct 16 signatures test pure multivalidatesign", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "14 signatures with 1st incorrect signatures test"
      + " pure multivalidatesign", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "16 signatures with 15th incorrect signatures"
      + " test pure multivalidatesign", groups = {"contract", "daily"})
