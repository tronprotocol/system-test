...
@Slf4j
public class ContractTrcToken080 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "DeployContract with 0 tokenValue and tokenId",
      groups = {"contract", "daily"})
  public void deployTransferTokenContract() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 2100_000_000L, fromAddress, foundationKey, blockingStubFull));
