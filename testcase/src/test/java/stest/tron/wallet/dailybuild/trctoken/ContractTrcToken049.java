...
public class ContractTrcToken049 extends TronBaseTest {
  ...
  public ByteString createAssetissue(byte[] devAddress, String devKey, String tokenName) {
    ...
    ByteString assetAccountId =
        PublicMethod.queryAccount(devAddress, blockingStubFull).getAssetIssuedID();
  ...
  public void deployTransferTokenContract() {
    ...
    Long beforeBalance = PublicMethod.queryAccount(user001Address, blockingStubFull).getBalance();
    ...
    Long beforeAssetIssueContractAddress =
        PublicMethod.getAssetIssueValue(transferTokenContractAddress, tokenId, blockingStubFull);
    final Long beforeAssetIssueDev =
        PublicMethod.getAssetIssueValue(dev001Address, tokenId, blockingStubFull);
