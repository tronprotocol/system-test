...
public class AssertException extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Trigger contract Divide 0",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger contract index out of bounds",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger contract Bytes array index out of bounds",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger contract convert too large value to enumerated type",
      groups = {"daily"})
  ...
  @Test(
      enabled = false,
      description = "Trigger contract move a negative value to a binary",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger contract assert exception",
      groups = {"daily"})
