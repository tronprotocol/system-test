...
@Slf4j
public class MultiSign29 extends TronBaseTest {
  ...
  public void testMultiUpdatepermissions_23() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            test001Address, amount, foundationAddress, foundationKey, blockingStubFull));
  ...
  @Test(
      enabled = true,
      description =
          "Sendcoin with permission id 0,use owner address sign,"
