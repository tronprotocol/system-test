...
public class HttpShieldTrc20Token002 extends ZenTrc20Base {
  ...
  @Test(
      enabled = true,
      description = "Get new shield account  by http",
      groups = {"daily", "serial"})
  public void test01GetNewShieldAccountByHttp() {
    response = getNewShieldedAddress(httpnode);
    shieldAccountInfo = HttpMethod.parseResponseContent(response);
    HttpMethod.printJsonContent(shieldAccountInfo);
  ...
  @Test(
      enabled = true,
      description = "Create mint parameters by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Scan shield TRC20 note by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Shield trc20 burn by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Shield trc20 burn with ask by http",
      groups = {"daily", "serial"})
