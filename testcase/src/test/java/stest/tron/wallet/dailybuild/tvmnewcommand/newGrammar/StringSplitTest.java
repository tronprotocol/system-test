...
public class StringSplitTest extends TronBaseTest {
  ...
  public void test01GetS1N1() {
    ...
    Assert.assertEquals(
        "s12,./",
        PublicMethod.hexStringToString(
            PublicMethod.removeAll0sAtTheEndOfHexStr(
