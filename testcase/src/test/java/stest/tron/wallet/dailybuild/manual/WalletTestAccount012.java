...
public class WalletTestAccount012 extends TronBaseTest {
  ...
  private final String testKey002 =
      Configuration.getByPath("testng.conf").getString("mainWitness.key25");
  private final String testKey003 =
      Configuration.getByPath("testng.conf").getString("mainWitness.key2");
  private final byte[] testAddress003 = PublicMethod.getFinalAddress(testKey003);
  private final String testKey004 =
      Configuration.getByPath("testng.conf").getString("mainWitness.key3");
  private final byte[] testAddress004 = PublicMethod.getFinalAddress(testKey004);
  ...
  public void storageAndCpu() {
    ...
    PublicMethod.sendcoin(
        asset011Address, 100000000000000L, foundationAddress, testKey002, blockingStubFull);
    ...
    AccountResourceMessage accountResource =
        PublicMethod.getAccountResource(asset011Address, blockingStubFull);
    accountResource = PublicMethod.getAccountResource(asset011Address, blockingStubFull);
    ...
    Account account = PublicMethod.queryAccount(testKeyForAssetIssue011, blockingStubFull);
    ...
    while (i++ < 20000) {
      ...
      // PublicMethod.freezeBalanceGetEnergy(asset011Address,1000000L,3,
      ...
      account = PublicMethod.queryAccount(testKeyForAssetIssue011, blockingStubFull);
      Float energyrate =
          (float) (beforeEnergyLimit)
      ...
      if (i % 20 == 0) {
        PublicMethod.freezeBalanceForReceiver(
            ...
            3,
            1,
            ByteString.copyFrom(asset011Address),
            testKey002,
            blockingStubFull);
      }
    }
