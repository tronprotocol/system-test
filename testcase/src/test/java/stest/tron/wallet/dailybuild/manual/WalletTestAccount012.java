...
public class WalletTestAccount012 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    PublicMethod.printAddress(testKey003);    channelFull1 = ManagedChannelBuilder.forTarget(fullnode1)
        .usePlaintext()
        .build();
  ...
  @Test(enabled = false, threadPoolSize = 20, invocationCount = 20, groups = {"daily"})
  ...
  String testKeyForAssetIssue011 = ByteArray.toHexString(ecKey1.getPrivKeyBytes());
    ...
    PublicMethod
        .sendcoin(asset011Address, 100000000000000L, foundationAddress, testKey002, blockingStubFull);
  ...
  String txid;
    ...
    Integer i = 1;
    AccountResourceMessage accountResource = PublicMethod.getAccountResource(asset011Address,
        blockingStubFull);
    accountResource = PublicMethod.getAccountResource(asset011Address,
        blockingStubFull);
  ...
  //logger.info("energy rate is " + energyrate);
      if (i % 20 == 0) {
        PublicMethod.freezeBalanceForReceiver(foundationAddress, 1000000L, 3, 1,
