...
@Slf4j
public class HttpTestEstimateEnergy extends TronBaseTest {
  ...
  public void beforeClass() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            triggerAddress, 10000000000L, foundationAddress, foundationKey, blockingStubFull));
    ...
    String txid =
        HttpMethod.deployContractGetTxid(
            httpnode,
            contractName,
            abi,
            code,
  ...
  @Test(
      enabled = true,
      description = "EstimateEnergy request fullnode,solidity,pbft",
      groups = {"daily", "serial"})
  public void test01EstimateCanGetValue() {
    ...
    response =
        HttpMethod.getEstimateEnergy(
            httpnode, foundationAddress, contractAddress, method, param, null, false, 0, 0, 0);
    Long energyRequired = HttpMethod.parseResponseContent(response).getLong("energy_required");
    Assert.assertTrue(energyRequired >= 0);
    HttpMethod.waitToProduceOneBlock(httpnode);
    response =
        HttpMethod.getEstimateEnergySolidity(
  ...
  @Test(
      enabled = true,
      description = "EstimateEnergy value compare to TriggerConstantContract",
      groups = {"daily", "serial"})
  public void test02CompareToTriggerConstantContract() {
    ...
    response =
        HttpMethod.getEstimateEnergy(
            httpnode, foundationAddress, contractAddress, method, param, null, true, 0, 0, 0);
    Long energyRequired = HttpMethod.parseResponseContent(response).getLong("energy_required");
    Assert.assertTrue(energyRequired >= 0);
    response =
        HttpMethod.triggerConstantContract(
            httpnode, foundationAddress, ByteArray.toHexString(contractAddress), method, param);
    Long energyRequiredConstant = HttpMethod.parseResponseContent(response).getLong("energy_used");
  ...
  @Test(
      enabled = true,
      description = "Estimate energy deploy contract",
      groups = {"daily", "serial"})
  public void test03EstimateDeployContract() {
    ...
    response =
        HttpMethod.getEstimateEnergy(
            httpnode, foundationAddress, null, method, param, code, true, 0, 0, 0);
    Long energyRequired = HttpMethod.parseResponseContent(response).getLong("energy_required");
    Assert.assertTrue(energyRequired >= 0);
    response =
        HttpMethod.triggerConstantContractWithData(
  ...
  public void test04EstimateWithCallvalueAndCommandAfterCall() {
    ...
    response =
        HttpMethod.getEstimateEnergy(
            httpnode, foundationAddress, contractAddress, method, args, null, true, 0, 0, 0);
    responseContent = HttpMethod.parseResponseContent(response);
  ...
  public void test05EstimateOnlyHasCalldata() {
    ...
    response =
        HttpMethod.getEstimateEnergy(
            httpnode, foundationAddress, contractAddress, null, null, data, true, 0, 0, 0);
    Long energyRequired = HttpMethod.parseResponseContent(response).getLong("energy_required");
    Assert.assertTrue(energyRequired >= 0);
    response =
        HttpMethod.triggerConstantContractWithData(
  ...
  public void test06EstimateOnlyContractAddress() {
    response =
        HttpMethod.getEstimateEnergy(
            httpnode, foundationAddress, contractAddress, null, null, null, true, 0, 0, 0);
    Long energyRequired = HttpMethod.parseResponseContent(response).getLong("energy_required");
    Assert.assertTrue(energyRequired >= 0);
    response =
        HttpMethod.triggerConstantContractWithData(
  ...
  @Test(
      ...
      description =
          "estimateEnergy and triggerconstantcontract "
              + "with contract address, function_selector and data. and it will triggerContract use"
              + " function_selector ",
      groups = {"daily", "serial"})
  public void test07EstimatePreferFunctionSelector() {
    ...
    response =
        HttpMethod.getEstimateEnergy(
            httpnode, foundationAddress, contractAddress, method, param, data, true, 0, 0, 0);
    Long energyRequired = HttpMethod.parseResponseContent(response).getLong("energy_required");
    Assert.assertTrue(energyRequired >= 0);
    response =
        HttpMethod.triggerConstantContractWithData(
  ...
  @Test(
      enabled = true,
      description = "triggerSmartContract using data",
      groups = {"daily", "serial"})
