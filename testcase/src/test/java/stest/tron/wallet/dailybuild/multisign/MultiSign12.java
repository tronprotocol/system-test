...
@Slf4j
public class MultiSign12 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Active type is exception condition",
  ...
  public void testActiveType01() {
    ...
    Assert.assertEquals(
        "Contract validate error : active permission type is error",
  ...
  @Test(
      enabled = true,
      description = "Active type is 2.9",
      groups = {"daily", "multisig"})
