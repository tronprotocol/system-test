...
public class ContractTrcToken003 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "DeployContract with exception condition",
  ...
  public void deployTransferTokenContract() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            user001Address, 1100_000_000L, fromAddress, foundationKey, blockingStubFull));
    ...
    Long devAssetCountBefore =
        PublicMethod.getAssetIssueValue(dev001Address, assetAccountDev, blockingStubFull);
    Long userAssetCountBefore =
        PublicMethod.getAssetIssueValue(dev001Address, assetAccountUser, blockingStubFull);
    ...
    GrpcAPI.Return response =
        PublicMethod.deployContractAndGetResponse(
            contractName,
            abi,
            code,
            "",
