...
public class WalletTestAccount012 extends TronBaseTest {
  ...
  public void beforeClass() throws Exception {
    ...
    if (!PublicMethod.tronPowerProposalIsOpen(blockingStubFull)
        || !PublicMethod.freezeV2ProposalIsOpen(blockingStubFull)) {
  ...
  @Test(
      enabled = true,
      priority = 100,
      description = "Freeze balance to get tron power",
      groups = {"daily"})
  public void test01FreezeBalanceGetTronPower() {
    ...
    AccountResourceMessage accountResource =
        PublicMethod.getAccountResource(frozenAddress, blockingStubFull);
    ...
    accountResource = PublicMethod.getAccountResource(frozenAddress, blockingStubFull);
  ...
  @Test(
      enabled = true,
      priority = 100,
      description = "Vote witness by tron power",
      groups = {"daily"})
  public void test02VotePowerOnlyComeFromTronPower() {
    ...
    Assert.assertFalse(
        PublicMethod.voteWitness(frozenAddress, frozenKey, witnessMap, blockingStubFull));
  ...
  @Test(
      enabled = true,
      priority = 100,
      description = "Tron power is not allow to others",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      priority = 100,
      description = "Unfreeze balance for tron power",
      groups = {"daily"})
  public void test04UnfreezeBalanceForTronPower() {
    AccountResourceMessage accountResource =
        PublicMethod.getAccountResource(foundationAddress, blockingStubFull);
    final Long beforeTotalTronPowerWeight = accountResource.getTotalTronPowerWeight();
