...
public class NewFeatureForSolc0821 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    SmartContractOuterClass.SmartContract smartContract =
        PublicMethod.getContract(contractH, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "expressions triggering selector can be executed correctly",
  ...
  @Test(
      enabled = true,
      description = "Allow qualified access to events from other contracts.",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "immutable variable init in condition",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "immutable variable init in try catch",
      groups = {"contract", "daily"})
