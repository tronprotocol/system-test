...
@Slf4j
public class MultiSign05 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Owner key-address is witness account",
  ...
  public void testOwnerKeyAddress01() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, needCoin, foundationAddress, testKey002, blockingStubFull));
  ...
  @Test(
      enabled = true,
      description = "Owner key-address is contract address",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner key-address is inactive address",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner key-address is owner address",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner key-address in exception condition",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner key-address count is 5",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner key-address count in exception condition",
      groups = {"daily", "multisig"})
