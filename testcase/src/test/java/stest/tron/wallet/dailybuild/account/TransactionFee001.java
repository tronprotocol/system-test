...
public class TransactionFee001 {
  ...
  public void test01DeployContractEnergyFeeToSr() {
    ...
    blackHoleBalance1 = PublicMethed.queryAccount(WalletClient.decode58Check(blackHoleAdd),
    ...
    witness02Allowance2 = PublicMethed.queryAccount(witnessAddress02, blockingStubFull)
       .getAllowance();
    blackHoleBalance2 = PublicMethed.queryAccount(WalletClient.decode58Check(blackHoleAdd),
            blockingStubFull).getBalance();
