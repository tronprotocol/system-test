...
public class Create2Test004 extends TronBaseTest {
  ...
  @Test(
      enabled = false,
      description = "Trigger create2 command with factory bytecode",
      groups = {"contract", "daily"})
  public void test02TriggerCreate2ToDeployFactory2Contract() {
    ...
    SmartContract smartContract =
        PublicMethod.getContract(factoryContractAddress2, blockingStubFull);
  ...
  @Test(
      enabled = false,
      description = "Trigger create2 command with test bytecode using factory",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "Trigger create2 command with test bytecode using factory2",
      groups = {"contract", "daily"})
