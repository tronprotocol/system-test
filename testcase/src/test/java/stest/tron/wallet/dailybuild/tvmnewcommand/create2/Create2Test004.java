...
@Slf4j
@MultiNode
public class Create2Test004 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "Trigger create2 command with factory bytecode", groups = {"contract", "daily"})
  public void test02TriggerCreate2ToDeployFactory2Contract() {
    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress,
        PublicMethod.getFreezeBalanceCount(user001Address, user001Key, 150000L,
            blockingStubFull), 0, 1,
  ...
  @Test(enabled = false, description = "Trigger create2 command with test bytecode using factory", groups = {"contract", "daily"})
  public void test03TriggerCreate2ToDeployTestContract() {
    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress,
        PublicMethod.getFreezeBalanceCount(user001Address, user001Key, 80000L,
            blockingStubFull), 0, 1,
        ByteString.copyFrom(user001Address), testKey002, blockingStubFull));
  ...
  @Test(enabled = false, description = "Trigger create2 command with test bytecode using factory2", groups = {"contract", "daily"})
