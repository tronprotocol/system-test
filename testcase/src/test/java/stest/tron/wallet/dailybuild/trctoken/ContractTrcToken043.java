...
public class ContractTrcToken043 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "TransferToken with invalid tokenId, deploy transferContract", groups = {"contract", "daily"})
  public void test01DeployTransferTokenContract() {
    ...
    Assert.assertTrue(PublicMethod.sendcoin(user001Address, 5048_000_000L, fromAddress,
        testKey002, blockingStubFull));
    Assert.assertTrue(PublicMethod.sendcoin(user002Address, 5048_000_000L, fromAddress,
        testKey002, blockingStubFull));
  ...
  @Test(enabled = true, description = "TransferToken with invalid tokenId, deploy receive contract", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "TransferToken with invalid tokenId, transferToken", groups = {"contract", "daily"})
...
//        ByteString.copyFrom(user001Address), testKey002, blockingStubFull));
    ...
    Assert.assertTrue(PublicMethod.transferAsset(user002Address,
        assetAccountId.toByteArray(), 10L, dev001Address, dev001Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
