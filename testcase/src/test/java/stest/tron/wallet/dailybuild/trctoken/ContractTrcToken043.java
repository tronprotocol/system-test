...
@Slf4j
@MultiNode
public class ContractTrcToken043 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "TransferToken with invalid tokenId, deploy transferContract",
  ...
  @Test(
      enabled = true,
      description = "TransferToken with invalid tokenId, deploy receive contract",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "TransferToken with invalid tokenId, transferToken",
      groups = {"contract", "daily"})
  public void test03TriggerContract() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(user002Address, 5000000, fromAddress, testKey002, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    PublicMethod.unFreezeBalance(fromAddress, testKey002, 1, user002Address, blockingStubFull);
  }
