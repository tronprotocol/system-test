...
public class ContractTrcToken036 extends TronBaseTest {
  ...
  public void deploy01TransferTokenContract() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 9999000000L, foundationAddress, testKey002, blockingStubFull));
    ...
    //            blockingStubFull);
    //    Assert
    //        .assertTrue(PublicMethod.sendcoin(transferTokenContractAddress, 100,
    // foundationAddress,
  ...
  @Test(
      enabled = false,
      description = "Trigger transferTokenWithPure contract",
      groups = {"contract", "daily"})
  public void deploy02TransferTokenContract() {
    ...
    Long beforeAssetIssueDevAddress =
        PublicMethod.getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
    Long beforeAssetIssueUserAddress =
        PublicMethod.getAssetIssueValue(user001Address, assetAccountId, blockingStubFull);
    ...
    Long user001AddressAddressBalance =
    ...
    Long afterAssetIssueUserAddress =
        PublicMethod.getAssetIssueValue(user001Address, assetAccountId, blockingStubFull);
    Long afteruser001AddressAddressBalance =
        PublicMethod.queryAccount(user001Address, blockingStubFull).getBalance();
    ...
    transferTokenWithPureTestAddress =
  ...
  @Test(
      enabled = false,
      description = "Trigger transferTokenWithConstant contract",
      groups = {"contract", "daily"})
  public void deploy03TransferTokenContract() {
    ...
    Long beforeAssetIssueContractAddress1 =
        PublicMethod.getAssetIssueValue(
            transferTokenContractAddress, assetAccountId, blockingStubFull);
    Long user001AddressAddressBalance1 =
        PublicMethod.queryAccount(user001Address, blockingStubFull).getBalance();
    ...
    Long afterAssetIssueUserAddress1 =
        PublicMethod.getAssetIssueValue(user001Address, assetAccountId, blockingStubFull);
    Long afteruser001AddressAddressBalance1 =
        PublicMethod.queryAccount(user001Address, blockingStubFull).getBalance();
    ...
    Optional<TransactionInfo> infoById1 =
        PublicMethod.getTransactionInfoById(triggerTxid1, blockingStubFull);
  ...
  @Test(
      enabled = false,
      description = "Trigger transferTokenWithView contract",
      groups = {"contract", "daily"})
  public void deploy04TransferTokenContract() {
    ...
    byte[] transferTokenWithViewAddress =
        PublicMethod.deployContract(
            contractName2,
            abi2,
            code2,
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            transferTokenWithViewAddress, 100, foundationAddress, testKey002, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    Long beforeAssetIssueDevAddress2 =
        PublicMethod.getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
    Long beforeAssetIssueUserAddress2 =
        PublicMethod.getAssetIssueValue(user001Address, assetAccountId, blockingStubFull);
    Long beforeAssetIssueContractAddress2 =
        PublicMethod.getAssetIssueValue(
            transferTokenWithViewAddress, assetAccountId, blockingStubFull);
    Long user001AddressAddressBalance2 =
        PublicMethod.queryAccount(user001Address, blockingStubFull).getBalance();
    ...
    Long afterAssetIssueContractAddress2 =
        PublicMethod.getAssetIssueValue(
            transferTokenWithViewAddress, assetAccountId, blockingStubFull);
    Long afterAssetIssueUserAddress2 =
        PublicMethod.getAssetIssueValue(user001Address, assetAccountId, blockingStubFull);
    Long afteruser001AddressAddressBalance2 =
        PublicMethod.queryAccount(user001Address, blockingStubFull).getBalance();
    ...
    Optional<TransactionInfo> infoById2 =
        PublicMethod.getTransactionInfoById(triggerTxid2, blockingStubFull);
  ...
  @Test(
      enabled = false,
      description = "Trigger transferTokenWithNoPayable contract",
      groups = {"contract", "daily"})
  public void deploy05TransferTokenContract() {
    ...
    byte[] transferTokenWithOutPayableTestAddress =
        PublicMethod.deployContract(
            contractName3,
            abi3,
            code3,
    ...
    Long beforeAssetIssueDevAddress3 =
        PublicMethod.getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
    Long beforeAssetIssueUserAddress3 =
        PublicMethod.getAssetIssueValue(user001Address, assetAccountId, blockingStubFull);
    Long beforeAssetIssueContractAddress3 =
        PublicMethod.getAssetIssueValue(
            transferTokenWithOutPayableTestAddress, assetAccountId, blockingStubFull);
    Long user001AddressAddressBalance3 =
        PublicMethod.queryAccount(user001Address, blockingStubFull).getBalance();
    ...
    Long afterAssetIssueContractAddress3 =
        PublicMethod.getAssetIssueValue(
            transferTokenWithOutPayableTestAddress, assetAccountId, blockingStubFull);
    Long afterAssetIssueUserAddress3 =
        PublicMethod.getAssetIssueValue(user001Address, assetAccountId, blockingStubFull);
    Long afteruser001AddressAddressBalance3 =
        PublicMethod.queryAccount(user001Address, blockingStubFull).getBalance();

    Optional<TransactionInfo> infoById3 =
        PublicMethod.getTransactionInfoById(triggerTxid3, blockingStubFull);
  ...
  public void shutdown() throws InterruptedException {
    ...
    PublicMethod.unFreezeBalance(
        foundationAddress, testKey002, 0, user001Address, blockingStubFull);
  }
}
