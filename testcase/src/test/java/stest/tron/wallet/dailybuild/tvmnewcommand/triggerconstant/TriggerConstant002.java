...
@Slf4j
@MultiNode
public class TriggerConstant002 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "TriggerConstantContract a non-payable function without ABI", groups = {"contract", "daily"})
