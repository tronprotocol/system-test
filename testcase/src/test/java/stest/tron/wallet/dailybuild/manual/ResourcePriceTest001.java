...
@Slf4j
public class ResourcePriceTest001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "get energyPrice grpc",
      groups = {"daily"})
  public void test02GetEnergyPrices() {
    ...
    String energyPricesSolidityPort =
        PublicMethod.getEnergyPriceSolidity(blockingStubFullSolidityPort);
  ...
  @Test(
      enabled = true,
      description = "get bandwidthPrices grpc",
      groups = {"daily"})
  public void test02GetBandwidthPrices() {
    ...
    String bandwidthPricesSolidity =
        PublicMethod.getBandwidthPricesSolidity(blockingStubFullSolidity);
    String bandwidthPricesSolidityPort =
        PublicMethod.getBandwidthPricesSolidity(blockingStubFullSolidityPort);
