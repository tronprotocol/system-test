...
@MultiNode
public class ContractInternalTransaction002 extends TronBaseTest {
  ...
  public void beforeClass() {
    initSolidityChannel();
    PublicMethod.printAddress(testKeyForinternalTxsAddress);    channelFull1 = ManagedChannelBuilder.forTarget(fullnode1)
        .usePlaintext()
        .build();
  ...
  @Test(enabled = true, description = "Type is create create call call", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "Type is call call", groups = {"contract", "daily"})
  ...
  String abi = retMap.get("abI").toString();
    ...
    contractAddress = PublicMethod.deployContract(contractName, abi, code, "", maxFeeLimit,
        1000000L, 100, null, testKeyForinternalTxsAddress,
        internalTxsAddress, blockingStubFull1);
    PublicMethod.waitProduceNextBlock(blockingStubFull1);
  ...
  String txid = "";
    txid = PublicMethod.triggerContract(contractAddress,
        ...
        0, maxFeeLimit, internalTxsAddress, testKeyForinternalTxsAddress, blockingStubFull1);
    PublicMethod.waitProduceNextBlock(blockingStubFull1);
  ...
  String txid1 = PublicMethod.triggerContract(contractAddress,
    ...
    Optional<TransactionInfo> infoById1 = null;
    infoById1 = PublicMethod.getTransactionInfoById(txid1, blockingStubFull1);
    Assert.assertTrue(infoById1.get().getResultValue() == 0);
  int transactionsCount1 = infoById1.get().getInternalTransactionsCount();
  ...
  String txid2 = PublicMethod.triggerContract(contractAddress,
    ...
    infoById2 = PublicMethod.getTransactionInfoById(txid2, blockingStubFull1);
  ...
  String txid3 = PublicMethod.triggerContract(contractAddress,
    ...
    infoById3 = PublicMethod.getTransactionInfoById(txid3, blockingStubFull1);
  ...
  @Test(enabled = true, description = "Test suicide type in internalTransaction after call", groups = {"contract", "daily"})
  ...
  byte[] contractAddress3 = PublicMethod
  ...
  @Test(enabled = true, description = "Type is call create->call->call.Three-level nesting", groups = {"contract", "daily"})
  public void test4InternalTransaction012() {
    Assert.assertTrue(PublicMethod
        .sendcoin(internalTxsAddress, 100000000000L, testNetAccountAddress, testNetAccountKey,
            blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  public void shutdown() throws InterruptedException {
    PublicMethod
        .freeResource(internalTxsAddress, testKeyForinternalTxsAddress, testNetAccountAddress,
