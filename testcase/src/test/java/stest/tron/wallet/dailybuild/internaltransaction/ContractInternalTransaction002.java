...
public class ContractInternalTransaction002 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Type is create create call call",
  ...
  @Test(
      enabled = true,
      description = "Test suicide type in internalTransaction after call",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Type is call create->call->call.Three-level nesting",
      groups = {"contract", "daily"})
