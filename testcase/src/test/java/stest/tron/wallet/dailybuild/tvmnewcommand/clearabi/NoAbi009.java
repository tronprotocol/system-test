...
public class NoAbi009 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "clearabi contract with event", groups = {"contract", "daily"})
  ...
  // getcontract
    ...
    Assert.assertFalse(smartContract.getBytecode().toString().isEmpty());
  // getcontractinfo
    SmartContractDataWrapper contractInfo = PublicMethod
  ...
  @Test(enabled = true, description = "create2 contract with event", groups = {"contract", "daily"})
