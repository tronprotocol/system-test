...
public class Create2Test018 extends TronBaseTest {
  ...
  public void test01DeployFactoryContract() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            witnessAddress2, 100_000_000L, fromAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
  ...
  public void test02TriggerCreate2ToDeployTestContract() {
    Assert.assertTrue(
        PublicMethod.freezeBalanceForReceiver(
            ...
            0,
            1,
            ByteString.copyFrom(witnessAddress2),
            testKey002,
            blockingStubFull));
    ...
    long userBalanceBefore =
        PublicMethod.queryAccount(witnessAddress2, blockingStubFull).getBalance();
  ...
  public void test03TriggerTestContract() {
    ...
    Assert.assertTrue(
        PublicMethod.freezeBalanceForReceiver(
            ...
            PublicMethod.getFreezeBalanceCount(
                witnessAddress2, witnessKey2, 50000L, blockingStubFull),
            0,
            1,
            ByteString.copyFrom(witnessAddress2),
            testKey002,
    ...
    PublicMethod.unFreezeBalance(fromAddress, testKey002, 1, witnessAddress2, blockingStubFull);
    PublicMethod.unFreezeBalance(fromAddress, testKey002, 0, witnessAddress2, blockingStubFull);
  }
