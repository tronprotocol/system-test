...
@Slf4j
@MultiNode
public class Create2Test018 extends TronBaseTest {
  ...
  public void beforeClass() {    PublicMethod.printAddress(dev001Key);
    PublicMethod.printAddress(witnessKey2);
  }

  @Test(enabled = false, description = "Deploy factory contract generated by new solidity", groups = {"contract", "daily"})
  public void test01DeployFactoryContract() {
    ...
    Assert.assertTrue(PublicMethod.sendcoin(witnessAddress2, 100_000_000L, fromAddress,
        testKey002, blockingStubFull));
  ...
  @Test(enabled = false, description = "Trigger create2 function to deploy test contract "
      + "using Witness account", groups = {"contract", "daily"})
  public void test02TriggerCreate2ToDeployTestContract() {
    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress, 9000_000_000_000L, 0, 1,
        ByteString.copyFrom(witnessAddress2), testKey002, blockingStubFull));
    ...
    accountResource = PublicMethod.getAccountResource(witnessAddress2, blockingStubFull);
    long userEnergyLimitBefore = accountResource.getEnergyLimit();
    long userEnergyUsageBefore = accountResource.getEnergyUsed();
    long userBalanceBefore = PublicMethod.queryAccount(witnessAddress2, blockingStubFull)
        .getBalance();
  ...
  final String triggerTxid = PublicMethod.triggerContract(factoryContractAddress,
        ...
        1000000000L, "0", 0, witnessAddress2, witnessKey2,
        blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    long userBalanceAfter = PublicMethod.queryAccount(witnessAddress2, blockingStubFull)
        .getBalance();
  ...
  @Test(enabled = false, description = "Trigger Test contact", groups = {"contract", "daily"})
  public void test03TriggerTestContract() {

    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress,
        PublicMethod.getFreezeBalanceCount(witnessAddress2, witnessKey2, 50000L,
            blockingStubFull), 0, 1,
        ByteString.copyFrom(witnessAddress2), testKey002, blockingStubFull));
  ...
  Long ret = ByteArray.toLong(ByteArray.fromHexString(retList.get(0)));
    ...
    PublicMethod.unFreezeBalance(fromAddress, testKey002, 0,
        dev001Address, blockingStubFull);
    PublicMethod.unFreezeBalance(fromAddress, testKey002, 1,
        witnessAddress2, blockingStubFull);
    PublicMethod.unFreezeBalance(fromAddress, testKey002, 0,
        witnessAddress2, blockingStubFull);
