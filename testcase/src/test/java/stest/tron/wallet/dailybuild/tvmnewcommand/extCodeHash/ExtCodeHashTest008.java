...
@Slf4j
@MultiNode
public class ExtCodeHashTest008 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Get code hash of create2 empty contract", groups = {"contract", "daily"})
  ...
  String param = "\"" + PublicMethod.create2(parameter) + "\"";
  ...
  public void test03DeployFactoryContract() {
    ...
    PublicMethod.freezeBalanceForReceiver(fromAddress, 10_000_000L + PublicMethod.randomFreezeAmount.getAndAdd(1),
        0, 0, ByteString.copyFrom(dev001Address), testKey002, blockingStubFull);
  ...
  @Test(enabled = true, description = "Trigger create2 function to deploy test contract", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "Get code hash of test contract", groups = {"contract", "daily"})
