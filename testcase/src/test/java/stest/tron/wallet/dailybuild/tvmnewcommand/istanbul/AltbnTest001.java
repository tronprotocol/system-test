...
public class AltbnTest001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "bn256add energyCost reduced from 500 to 150",
  ...
  public void bn256addTest001() {
    ...
    TransactionInfo option = PublicMethod.getTransactionInfoById(txid, blockingStubFull).get();
  ...
  @Test(
      enabled = true,
      description = "bn256add energyCost reduced from 40000 to 6000",
      groups = {"contract", "daily"})
