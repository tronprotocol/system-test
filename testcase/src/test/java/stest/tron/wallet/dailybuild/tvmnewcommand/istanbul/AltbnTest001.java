...
@Slf4j
public class AltbnTest001 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "bn256add energyCost reduced from 500 to 150", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "bn256add energyCost reduced from 40000 to 6000", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "bn256add energyCost reduced from ( 80000 * pairNum + 100000)"
      + "to ( 34000 * pairNum + 45000) ", groups = {"contract", "daily"})
