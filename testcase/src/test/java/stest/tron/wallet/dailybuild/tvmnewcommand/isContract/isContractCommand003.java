...
public class isContractCommand003 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    PublicMethod.printAddress(selfdestructContractKey);
  ...
  @Test(
      enabled = true,
      description = "Incorrect address hex test isContract Command",
  ...
  @Test(
      enabled = true,
      description = "Empty addresses hash test isContract Command",
      groups = {"contract", "daily"})
