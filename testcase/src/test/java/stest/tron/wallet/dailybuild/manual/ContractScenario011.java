...
@Slf4j
@MultiNode
public class ContractScenario011 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            deployAddress, 50000000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);

    Assert.assertTrue(
        PublicMethod.sendcoin(
            triggerAddress, 50000000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Deploy Erc721 contract \"Kitty Core\"",
      groups = {"daily"})
  public void deployErc721KittyCore() {
    ...
    Assert.assertTrue(
        PublicMethod.freezeBalance(deployAddress, 6000000000L, 0, deployKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull1);
    Assert.assertTrue(
        PublicMethod.freezeBalance(triggerAddress, 6000000000L, 0, triggerKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull1);
    AccountResourceMessage accountResource =
        PublicMethod.getAccountResource(deployAddress, blockingStubFull);
    ...
    SmartContract smartContract =
        PublicMethod.getContract(kittyCoreContractAddress, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Deploy Erc721 contract \"Sale Clock Auction\"",
      groups = {"daily"})
  public void deploySaleClockAuction() {
    ...
    Optional<TransactionInfo> info =
        PublicMethod.getTransactionInfoById(deplTxid, blockingStubFull);
    Assert.assertTrue(info.get().getResultValue() == 0);

    saleClockAuctionContractAddress = info.get().getContractAddress().toByteArray();
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    SmartContract smartContract =
        PublicMethod.getContract(saleClockAuctionContractAddress, blockingStubFull);
    Assert.assertFalse(StringUtils.isEmpty(smartContract.getBytecode()));
    Assert.assertTrue(smartContract.getAbi() != null);
    accountResource = PublicMethod.getAccountResource(deployAddress, blockingStubFull);
    cpuLimit = accountResource.getEnergyLimit();
  ...
  @Test(
      enabled = true,
      description = "Deploy Erc721 contract \"Siring Clock Auction\"",
      groups = {"daily"})
  public void deploySiringClockAuction() {
    ...
    Optional<TransactionInfo> info2 =
        PublicMethod.getTransactionInfoById(
    ...
    SmartContract smartContract =
        PublicMethod.getContract(siringClockAuctionContractAddress, blockingStubFull);
    Assert.assertFalse(StringUtils.isEmpty(smartContract.getBytecode()));
    Assert.assertTrue(smartContract.getAbi() != null);
    accountResource = PublicMethod.getAccountResource(deployAddress, blockingStubFull);
    cpuLimit = accountResource.getEnergyLimit();
  ...
  @Test(
      enabled = true,
      description = "Deploy Erc721 contract \"Gene Science Interface\"",
      groups = {"daily"})
  public void deployGeneScienceInterface() {
    ...
    String txid =
        PublicMethod.deployContractAndGetTransactionInfoById(
            ...
            blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Optional<TransactionInfo> info2 = PublicMethod.getTransactionInfoById(txid, blockingStubFull);
    geneScienceInterfaceContractAddress = info2.get().getContractAddress().toByteArray();
    Assert.assertTrue(info2.get().getResultValue() == 0);

    SmartContract smartContract =
        PublicMethod.getContract(geneScienceInterfaceContractAddress, blockingStubFull);
    Assert.assertFalse(StringUtils.isEmpty(smartContract.getBytecode()));
    Assert.assertTrue(smartContract.getAbi() != null);
    accountResource = PublicMethod.getAccountResource(deployAddress, blockingStubFull);
    cpuLimit = accountResource.getEnergyLimit();
  ...
  public void triggerUseTriggerEnergyUsage() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Long beforeBalance =
        PublicMethod.queryAccount(triggerUseTriggerEnergyUsageKey, blockingStubFull).getBalance();
    ...
    Long afterBalance =
        PublicMethod.queryAccount(triggerUseTriggerEnergyUsageKey, blockingStubFull1).getBalance();
    ...
    AccountResourceMessage accountResource =
        PublicMethod.getAccountResource(triggerUseTriggerEnergyUsageAddress, blockingStubFull);
    ...
    accountResource =
        PublicMethod.getAccountResource(triggerUseTriggerEnergyUsageAddress, blockingStubFull1);
    ...
    PublicMethod.unFreezeBalance(triggerAddress, triggerKey, 1, triggerAddress, blockingStubFull);
