...
@Slf4j
@Flaky(
    reason = "Timing-sensitive: depends on maintenance interval and unfreeze wait period",
    since = "2026-04-03")
public class FreezeBalanceV2Test001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Freeze balance to get bandwidth",
  ...
  @Test(
      enabled = true,
      description = "Freeze balance to get energy",
      groups = {"daily", "staking"})
  public void test02FreezeBalanceV2GetEnergy() throws Exception {
    AccountResourceMessage accountResource =
        PublicMethod.getAccountResource(frozenEnergyAddress, blockingStubFull);
    ...
    accountResource = PublicMethod.getAccountResource(frozenEnergyAddress, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Unfreeze balance to release bandwidth",
      groups = {"daily", "staking"})
  ...
  @Test(
      enabled = true,
      description = "Freeze balance to release energy",
      groups = {"daily", "staking"})
  ...
  @Test(
      enabled = true,
      description = "Withdraw expire unfreeze to release balance",
      groups = {"daily", "staking"})
  public void test05WithdrawExpireUnfreezeToReleaseBalance() throws Exception {
    ...
    if (System.currentTimeMillis() - 2000L < account.getUnfrozenV2(0).getUnfreezeExpireTime()) {
      Assert.assertFalse(
          PublicMethod.withdrawExpireUnfreeze(
    ...
    Long canWithdrawUnFreezeAmount =
        PublicMethod.getCanWithdrawUnfreezeAmount(
    ...
    Transaction transaction = PublicMethod.getTransactionById(txIdEnergy, blockingStubFull).get();
    Any any = transaction.getRawData().getContract(0).getParameter();
    ...
    TransactionInfo transactionInfo =
        PublicMethod.getTransactionInfoById(txIdEnergy, blockingStubFull).get();
