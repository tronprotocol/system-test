...
@Slf4j
@MultiNode
public class MultiSign02 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Owner threshold in exception condition",
  ...
  @Test(
      enabled = true,
      description = "Owner threshold is 1",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner threshold is more than sum of keys' weight",
      groups = {"daily", "multisig"})
  public void testOwnerThreshold03() {
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "Contract validate error : sum of all key's weight "
  ...
  @Test(
      enabled = true,
      description = "Owner threshold is Long.MAX_VALUE and equal sum(weight)",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Owner threshold is Integer.MAX_VALUE",
      groups = {"daily", "multisig"})
