...
@Slf4j
public class WalletTestZenToken006 extends TronBaseTest {
  ...
  @Test(
      enabled = false,
      description = "Shield note memo is one char",
      groups = {"daily", "shield"})
  ...
  @Test(
      enabled = false,
      description = "Shield note memo is 512 char",
      groups = {"daily", "shield"})
  ...
  @Test(
      enabled = false,
      description = "Shield note memo is 514 char",
      groups = {"daily", "shield"})
  ...
  @Test(
      enabled = false,
      description = "Shield note memo is empty",
      groups = {"daily", "shield"})
  public void test4ShieldMemoIsEmpty() {
    ...
    memo = "";
    shieldOutList.clear();
    shieldOutList = PublicMethod.addShieldOutputList(shieldOutList, shieldAddress, "0", memo);
    Assert.assertTrue(
        PublicMethod.sendShieldCoin(
            null,
            0,
