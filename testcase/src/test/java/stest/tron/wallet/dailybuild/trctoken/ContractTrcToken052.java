...
public class ContractTrcToken052 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "TransferToken to contract address tokenID is 0", groups = {"contract", "daily"})
  ...
  final Long beforetransferTokenContractAddressBalance = PublicMethod
        .queryAccount(transferTokenContractAddress, blockingStubFull).getBalance();
  final Long beforeDevBalance = PublicMethod
  ...
  Long afterAssetIssueDev = PublicMethod
        .getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
  final Long aftertransferTokenContractAddressBalance = PublicMethod
        .queryAccount(transferTokenContractAddress, blockingStubFull).getBalance();
  final Long afterDevBalance = PublicMethod
        .queryAccount(dev001Address, blockingStubFull).getBalance();
