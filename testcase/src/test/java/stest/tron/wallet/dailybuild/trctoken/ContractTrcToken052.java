...
@Slf4j
public class ContractTrcToken052 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "TransferToken to contract address tokenID is 0",
  ...
  public void deployTransferTokenContract() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            user001Address, 6048000000L, foundationAddress, testKey002, blockingStubFull));
    ...
    byte[] transferTokenContractAddress =
        PublicMethod.deployContract(
            ...
            blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    /*Assert.assertFalse(PublicMethod.sendcoin(transferTokenContractAddress, 2048000000,
    ...
    final Long beforeDevBalance =
        PublicMethod.queryAccount(dev001Address, blockingStubFull).getBalance();
