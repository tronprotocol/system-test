...
public class FreezeContractTest001 extends TronBaseTest {
  ...
  @Test(
      description = "contract freeze to account",
      groups = {"contract", "daily"})
  void FreezeContractTest001() {

    AccountResourceMessage account002_before =
        PublicMethod.getAccountResource(testAddress002, blockingStubFull);
  ...
  @Test(
      description = "contract freeze to self",
      groups = {"contract", "daily"})
  ...
  @Test(
      description = "contract freeze to other contract",
      groups = {"contract", "daily"})
  void FreezeContractTest003() {
    ...
    AccountResourceMessage contractResource_after =
        PublicMethod.getAccountResource(newContract, blockingStubFull);
    Account contractAccount_after = PublicMethod.queryAccount(contractAddress, blockingStubFull);
  ...
  void FreezeContractTest004() {
    ...
    AccountResourceMessage account002_after =
        PublicMethod.getAccountResource(testAddress, blockingStubFull);
    Account contractAccount_after = PublicMethod.queryAccount(contractAddress, blockingStubFull);
  ...
  void FreezeContractTest005() {
    ...
    AccountResourceMessage account002_after =
        PublicMethod.getAccountResource(create2Address, blockingStubFull);
    Account contractAccount_after = PublicMethod.queryAccount(contractAddress, blockingStubFull);
  ...
  @Test(
      description = "Unfreeze when freeze to account",
      dependsOnMethods = "FreezeContractTest001",
      groups = {"contract", "daily"})
  ...
  @Test(
      description = "energy caulate after transaction end",
      groups = {"contract", "daily"})
  ...
  @Test(
      description = "freeze in constructor",
      groups = {"contract", "daily"})
  public void FreezeContractTest006() {

    AccountResourceMessage account003_before =
        PublicMethod.getAccountResource(testAddress003, blockingStubFull);
    String filePath = "src/test/resources/soliditycode/freezeContract001.sol";
