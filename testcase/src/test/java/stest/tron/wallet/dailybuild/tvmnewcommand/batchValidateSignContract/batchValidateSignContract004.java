...
public class batchValidateSignContract004 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "10 signatures and 9 address test multivalidatesign",
  ...
  @Test(
      enabled = true,
      description = "14 signatures and 15 address test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "40 signatures and 1 address test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "1 signatures and 50 address test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "16 signatures and 17 address test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "17 signatures and 16 address test multivalidatesign",
      groups = {"contract", "daily"})
