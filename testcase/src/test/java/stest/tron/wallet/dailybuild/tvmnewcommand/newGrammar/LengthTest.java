...
public class LengthTest extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "push() increase Array length",
  ...
  @Test(
      enabled = true,
      description = "push(value) increase Array length",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "pop() decrease Array length",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "push() return no value",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "push(value) return value",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "pop() return no value",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "bytes push() return value",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "bytes push(value) return no value",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "bytes pop() return no value",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "array length change before v0.5.15",
      groups = {"contract", "daily"})
