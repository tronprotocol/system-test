...
@Slf4j
public class ContractTrcToken002 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "TriggerContract with correct tokenValue and tokenId", groups = {"contract", "daily"})
  public void deployTransferTokenContract() {

    Assert.assertTrue(PublicMethod.sendcoin(dev001Address, 3100_000_000L, fromAddress,
        foundationKey, blockingStubFull));
    Assert.assertTrue(PublicMethod.sendcoin(user001Address, 3000_000_000L, fromAddress,
        foundationKey, blockingStubFull));
...
//        foundationKey, blockingStubFull));
  ...
  Long devAssetCountAfter = PublicMethod.getAssetIssueValue(
        dev001Address, assetAccountId, blockingStubFull);
...
//        ByteString.copyFrom(user001Address), foundationKey, blockingStubFull));
    ...
    accountResource = PublicMethod.getAccountResource(dev001Address,
        blockingStubFull);
