...
public class TransferFailed008 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    assetAccountId =
        PublicMethod.queryAccount(contractExcAddress, blockingStubFull).getAssetIssuedID();
    System.out.println("assetAccountId:" + assetAccountId.toStringUtf8());
    Long testNetAccountCountBefore =
        PublicMethod.getAssetIssueValue(contractExcAddress, assetAccountId, blockingStubFull);
    logger.info("testNetAccountCountBefore:" + testNetAccountCountBefore);
  }

  @Test(
      enabled = false,
      description = "TransferToken to old contractAddress",
  ...
  public void test1TransferToOldContractAddress() {
    ...
    contractAddress =
        PublicMethod.deployContract(
            ...
            blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Long contractAccountTokenBalance =
        PublicMethod.getAssetIssueValue(contractAddress, assetAccountId, blockingStubFull);
    ...
    String num = "\"" + oldContractAddress + "\",\"1\",\"" + assetAccountId.toStringUtf8() + "\"";
    txid =
    ...
    Long oldContractAddressAccount =
  ...
  @Test(
      enabled = true,
      description = "TransferToken to new contract",
      groups = {"contract", "daily"})
  public void test1TransferToNewContract() {
    ...
    txid =
        PublicMethod.triggerContract(
            contractAddress,
            "createContractTest(uint256,trcToken)",
            num,
            false,
            0,
            maxFeeLimit,
    ...
    Long nonexistentAddressAccount =
        PublicMethod.getAssetIssueValue(contractAddressA, assetAccountId, blockingStubFull1);
    Assert.assertEquals(1L, nonexistentAddressAccount.longValue());
  }

  @Test(
      enabled = true,
      description = "TransferToken nonexistent target in constructor",
      groups = {"contract", "daily"})
  ...
  public void test3TransferToExistentTargetInConstructor() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    assetAccountId2 =
        PublicMethod.queryAccount(contractExcAddress3, blockingStubFull).getAssetIssuedID();
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Long testNetAccountCountBefore =
        PublicMethod.getAssetIssueValue(contractExcAddress3, assetAccountId2, blockingStubFull);
    Long contractAccountCountBefore =
        PublicMethod.getAssetIssueValue(contractAddress, assetAccountId2, blockingStubFull);
    logger.info("testNetAccountCountBefore:" + testNetAccountCountBefore);
    logger.info("contractAccountCountBefore:" + contractAccountCountBefore);
    String filePath = "src/test/resources/soliditycode/accountAssert.sol";
    String contractName = "transferTokenTestA";
    ...
    Long nonexistentAddressAccountTokenBalance =
        PublicMethod.getAssetIssueValue(nonexistentAddress, assetAccountId, blockingStubFull1);
    Assert.assertEquals(1L, nonexistentAddressAccountTokenBalance.longValue());
    Long nonexistentAddressAccountTokenBalance2 =
        PublicMethod.getAssetIssueValue(nonexistentAddress, assetAccountId2, blockingStubFull1);
