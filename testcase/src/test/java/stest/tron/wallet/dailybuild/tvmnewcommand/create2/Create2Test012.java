...
@Slf4j
@MultiNode
public class Create2Test012 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "Trigger create2 command with test bytecode and salt 1", groups = {"contract", "daily"})
  ...
  @Test(enabled = false, description = "Trigger create2 command with test bytecode and salt 2", groups = {"contract", "daily"})
