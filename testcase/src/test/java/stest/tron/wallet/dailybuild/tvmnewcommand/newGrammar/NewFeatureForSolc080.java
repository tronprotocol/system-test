...
public class NewFeatureForSolc080 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    SmartContractOuterClass.SmartContract smartContract =
        PublicMethod.getContract(mapKeyContract, blockingStubFull);
    Assert.assertNotNull(smartContract.getAbi());
  }

  @Test(
      enabled = true,
      description = "math sub without unchecked, transaction revert",
  ...
  public void test01MathSubNoUncheck() {
    GrpcAPI.TransactionExtention transactionExtention =
        PublicMethod.triggerConstantContractForExtention(
            ...
            blockingStubFull);
    Assert.assertEquals(
        "REVERT opcode executed", transactionExtention.getResult().getMessage().toStringUtf8());
    Assert.assertEquals(
  ...
  @Test(
      enabled = true,
      description = "math sub with uncheck,transaction success",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "math add overflow without unchecked, transaction revert",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "math divide zero without unchecked, transaction revert",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "assert fail without unchecked, transaction revert",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "array out of index without unchecked, transaction revert",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "power multi by default turn: right to left",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "power multi: left to right ",
      groups = {"contract", "daily"})
  public void test09PowerMultiLeftToRight() {
    GrpcAPI.TransactionExtention transactionExtention =
        PublicMethod.triggerConstantContractForExtention(
            mapKeyContract,
            "powerMultiLeftToRight()",
            "#",
            true,
            0,
            maxFeeLimit,
  ...
  @Test(
      enabled = true,
      description = "power multi with 2 params ",
      groups = {"contract", "daily"})
  public void test10PowerMultiWith2Params() {
    GrpcAPI.TransactionExtention transactionExtention =
        PublicMethod.triggerConstantContractForExtention(
            mapKeyContract,
            "powerMultiWith2Params()",
            "#",
            true,
            0,
            maxFeeLimit,
  ...
  @Test(
      enabled = true,
      description = "get block chain id ",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "get normal account address hashcode ",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "get contract address hashcode ",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "transfer trx to tx.origin address with payable",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "transfer trx to literal address with payable",
      groups = {"contract", "daily"})
