...
@Slf4j
public class NewFeatureForSolc080 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "math sub without unchecked, transaction revert", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "math sub with uncheck,transaction success", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "math add overflow without unchecked, transaction revert", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "math divide zero without unchecked, transaction revert", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "assert fail without unchecked, transaction revert", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "array out of index without unchecked, transaction revert", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "type convert", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "power multi by default turn: right to left", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "power multi: left to right ", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "power multi with 2 params ", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "get block chain id ", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "get normal account address hashcode ", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "get contract address hashcode ", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "transfer trx to tx.origin address with payable", groups = {"contract", "daily"})
  ...
  String triggerTxid = PublicMethod.triggerContract(mapKeyContract, methodStr, "1000000", false,
    ...
    info = PublicMethod.queryAccount(mapKeyContract, blockingStubFull);
  Long afterBalance = info.getBalance();
    logger.info("afterBalance: " + afterBalance);
    Assert.assertTrue(beforeBalance == afterBalance + 1000000);
  }

  @Test(enabled = true, description = "transfer trx to literal address with payable", groups = {"contract", "daily"})
