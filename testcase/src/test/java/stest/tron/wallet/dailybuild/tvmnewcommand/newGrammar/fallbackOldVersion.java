...
@Slf4j
@MultiNode
public class fallbackOldVersion extends TronBaseTest {
  ...
  String contractName = "Test0";
    ...
    contractName = "Call";
    contractAddressCall = PublicMethod
        .deployContract(contractName, abi, code, "", maxFeeLimit, 0L,
            100, null, contractExcKey,
            contractExcAddress, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(enabled = true, description = "test fallback", groups = {"contract", "daily"})
  ...
  String para = "\"" + Base58.encode58Check(contractAddressTest0) + "\"";
    txid = PublicMethod.triggerContract(contractAddressCall, method, para, false, value,
  ...
  Long afterBalance = infoafter.getBalance();
    ...
    txid = PublicMethod.triggerContract(contractAddressCall, method, para, false, 0,
        maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethod.getTransactionInfoById(txid, blockingStubFull);
    Assert.assertTrue(infoById.get().getResultValue() == 0);
  ...
  public void shutdown() throws InterruptedException {
    PublicMethod
        .freeResource(contractAddressCall, contractExcKey, testNetAccountAddress,
            blockingStubFull);
    PublicMethod
