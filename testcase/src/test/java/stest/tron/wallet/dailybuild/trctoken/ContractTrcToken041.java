...
@Slf4j
public class ContractTrcToken041 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Trigger contract msg.tokenId add 1,msg.tokenValue add 1",
  ...
  public void deployTransferTokenContract() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 2048000000, foundationAddress, foundationKey, blockingStubFull));
