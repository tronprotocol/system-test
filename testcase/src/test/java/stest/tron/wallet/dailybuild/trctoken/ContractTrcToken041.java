...
public class ContractTrcToken041 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Trigger contract msg.tokenId add 1,msg.tokenValue add 1", groups = {"contract", "daily"})
  ...
  // freeze balance
    PublicMethod.freezeBalanceGetEnergy(dev001Address, 204800000,
        0, 1, dev001Key, blockingStubFull);

    PublicMethod.freezeBalanceGetEnergy(user001Address, 2048000000,
