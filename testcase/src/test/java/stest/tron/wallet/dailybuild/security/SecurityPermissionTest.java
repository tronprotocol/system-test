...
public class SecurityPermissionTest extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            nonOwnerAddress, 200_000_000_000L, foundationAddress, foundationKey, blockingStubFull));
  ...
  public void test04TxOriginVsMsgSender() {
    ...
    GrpcAPI.TransactionExtention extSender =
        PublicMethod.triggerConstantContractForExtention(
            callerAddress,
            "callGetMsgSender()",
            "#",
    ...
    String msgSenderHex =
        "41" + ByteArray.toHexString(extSender.getConstantResult(0).toByteArray()).substring(24);
    ...
    GrpcAPI.TransactionExtention extOrigin =
        PublicMethod.triggerConstantContractForExtention(
            callerAddress,
            "callGetTxOrigin()",
            "#",
    ...
    String txOriginHex =
        "41" + ByteArray.toHexString(extOrigin.getConstantResult(0).toByteArray()).substring(24);
    ...
    Assert.assertEquals(Base58.encode58Check(callerAddress), Base58.encode58Check(msgSenderBytes));
    // tx.origin should be the EOA (testAddress)
    Assert.assertEquals(Base58.encode58Check(testAddress), Base58.encode58Check(txOriginBytes));
