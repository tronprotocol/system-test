...
public class Accounts001 extends JsonRpcBase {
  ...
  public void test04JsonRpcApiTestForEthChainId() throws Exception {
    ...
    response = HttpMethod.getBlockByNum(httpFullNode, 0L);
    responseContent = HttpMethod.parseResponseContent(response);
  ...
  public void test10JsonRpcApiTestForEthGasPrice() throws Exception {
    ...
    response = HttpMethod.getChainParameter(httpFullNode);
    responseContent = HttpMethod.parseResponseContent(response);
    JSONArray temp;
  ...
  public void test11JsonRpcApiTestForEthGetBalance() throws Exception {
    ...
    Long balance2 = HttpMethod.getBalance(httpFullNode, foundationAddress);
  ...
  public void test12JsonRpcApiTestForEthGetBlockTransactionCountByNum() throws Exception {
    ...
    response = HttpMethod.getTransactionCountByBlocknum(httpFullNode, 0);
    responseContent = HttpMethod.parseResponseContent(response);
  ...
  public void test16JsonRpcApiTestForEthGetTransactionByBlockNumberAndIndex() throws Exception {
    ...
    response = HttpMethod.getTransactionInfoByBlocknum(httpFullNode, blockNum);
  ...
  public void test17JsonRpcApiTestForEthGetBlockTransactionCountByHash() throws Exception {
    ...
    response = HttpMethod.getTransactionCountByBlocknum(httpFullNode, blockNum);
    responseContent = HttpMethod.parseResponseContent(response);
  ...
  public void test21JsonRpcApiTestForEthGetTransactionReceipt() throws Exception {
    ...
    response = HttpMethod.getBlockByNum(httpFullNode, blockNumForTrc20);
    responseContent = HttpMethod.parseResponseContent(response);
    int index = 0;
    for (int i = 0; i < responseContent.getJSONArray("transactions").size(); i++) {
      if (trc20Txid.equals(
    ...
    response = HttpMethod.getTransactionInfoByBlocknum(httpFullNode, blockNumForTrc20);
    List<JSONObject> responseContent1 = HttpMethod.parseResponseContentArray(response);
...
//    Assert.assertEquals(trans1, trans2);
  ...
  public void test57JsonRpcApiTestForEthGetBlockReceipts() throws Exception {
    ...
    GrpcAPI.BlockExtention targetBlock = PublicMethod.getBlock2(targetBlockNum, blockingStubFull);
    ...
    HttpMethod.waitToProduceOneBlockFromSolidity(httpFullNode, httpsolidityNode);
