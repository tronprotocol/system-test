...
public class ContractLinkage006 extends TronBaseTest {
  ...
  public void beforeClass() {
    PublicMethod.printAddress(linkage006Key);
  ...
  @Test(
      enabled = true,
      description = "Deploy contract with stack function",
      groups = {"daily"})
  public void teststackOutByContract() {

    Assert.assertTrue(
        PublicMethod.sendcoin(
            linkage006Address, 20000000000L, fromAddress, testKey003, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalance(
            linkage006Address, 1000000L, 0, linkage006Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalanceGetEnergy(
            linkage006Address, 1000000L, 0, 1, linkage006Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    AccountResourceMessage resourceInfo =
        PublicMethod.getAccountResource(linkage006Address, blockingStubFull);
    Account info;
    ...
    AccountResourceMessage resourceInfoafter =
        PublicMethod.getAccountResource(linkage006Address, blockingStubFull1);
    ...
    PublicMethod.unFreezeBalance(linkage006Address, linkage006Key, 1, null, blockingStubFull);
  }

  @Test(
      enabled = true,
      description = "Boundary value for contract stack(63 is the largest level)",
      groups = {"daily"})
  public void teststackOutByContract1() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            linkage006Address2, 20000000000L, fromAddress, testKey003, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalance(
            linkage006Address2, 1000000L, 0, linkage006Key2, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalanceGetEnergy(
            linkage006Address2, 1000000L, 0, 1, linkage006Key2, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    AccountResourceMessage resourceInfo1 =
        PublicMethod.getAccountResource(linkage006Address2, blockingStubFull);
    ...
    AccountResourceMessage resourceInfoafter1 =
        PublicMethod.getAccountResource(linkage006Address2, blockingStubFull1);
  ...
  @Test(
      enabled = true,
      description = "Boundary value for contract stack" + "(Trigger 64 level can't success)",
      groups = {"daily"})
  public void teststackOutByContract2() {
    ...
    PublicMethod.unFreezeBalance(
        linkage006Address2, linkage006Key2, 1, linkage006Address2, blockingStubFull);
  }
  ...
  public void shutdown() throws InterruptedException {
    PublicMethod.unFreezeBalance(
        linkage006Address, linkage006Key, 1, linkage006Address, blockingStubFull);
    PublicMethod.unFreezeBalance(
        linkage006Address, linkage006Key, 0, linkage006Address, blockingStubFull);
    PublicMethod.unFreezeBalance(
        linkage006Address2, linkage006Key2, 1, linkage006Address2, blockingStubFull);
    PublicMethod.unFreezeBalance(
        linkage006Address2, linkage006Key2, 0, linkage006Address2, blockingStubFull);
