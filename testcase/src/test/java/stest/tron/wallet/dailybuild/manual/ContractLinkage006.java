...
public class ContractLinkage006 extends TronBaseTest {
  ...
  public void beforeClass() {
    PublicMethod.printAddress(linkage006Key);    channelFull1 = ManagedChannelBuilder.forTarget(fullnode1)
        .usePlaintext()
        .build();
    blockingStubFull1 = WalletGrpc.newBlockingStub(channelFull1);
  }

  @Test(enabled = true, description = "Deploy contract with stack function", groups = {"daily"})
  public void teststackOutByContract() {

    Assert.assertTrue(PublicMethod.sendcoin(linkage006Address, 20000000000L, fromAddress,
        testKey003, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(PublicMethod.freezeBalance(linkage006Address, 1000000L,
        0, linkage006Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(PublicMethod.freezeBalanceGetEnergy(linkage006Address, 1000000L,
        0, 1, linkage006Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    AccountResourceMessage resourceInfo = PublicMethod.getAccountResource(linkage006Address,
        blockingStubFull);
    Account info;
    info = PublicMethod.queryAccount(linkage006Address, blockingStubFull);
  ...
  Long netFee = infoById.get().getReceipt().getNetFee();
    ...
    Account infoafter = PublicMethod.queryAccount(linkage006Address, blockingStubFull1);
    AccountResourceMessage resourceInfoafter = PublicMethod.getAccountResource(linkage006Address,
        blockingStubFull1);
  ...
  Long afterFreeNetUsed = resourceInfoafter.getFreeNetUsed();
    ...
    PublicMethod.unFreezeBalance(linkage006Address, linkage006Key, 1,
        null, blockingStubFull);
  }

  @Test(enabled = true, description = "Boundary value for contract stack(63 is the largest level)", groups = {"daily"})
  public void teststackOutByContract1() {
    Assert.assertTrue(PublicMethod.sendcoin(linkage006Address2, 20000000000L, fromAddress,
        testKey003, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(PublicMethod.freezeBalance(linkage006Address2, 1000000L,
        0, linkage006Key2, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(PublicMethod.freezeBalanceGetEnergy(linkage006Address2, 1000000L,
        0, 1, linkage006Key2, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    AccountResourceMessage resourceInfo1 = PublicMethod.getAccountResource(linkage006Address2,
        blockingStubFull);
    Account info1 = PublicMethod.queryAccount(linkage006Address2, blockingStubFull);
  ...
  Long netFee1 = infoById1.get().getReceipt().getNetFee();
    ...
    Account infoafter1 = PublicMethod.queryAccount(linkage006Address2, blockingStubFull1);
  ...
  @Test(enabled = true, description = "Boundary value for contract stack"
      + "(Trigger 64 level can't success)", groups = {"daily"})
  public void teststackOutByContract2() {
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    initParmes = "\"" + Base58.encode58Check(fromAddress) + "\",\"64\"";
    AccountResourceMessage resourceInfo2 = PublicMethod.getAccountResource(linkage006Address2,
        blockingStubFull);
    Account info2 = PublicMethod.queryAccount(linkage006Address2, blockingStubFull);
  ...
  Long netFee2 = infoById2.get().getReceipt().getNetFee();
    ...
    Account infoafter2 = PublicMethod.queryAccount(linkage006Address2, blockingStubFull1);
    AccountResourceMessage resourceInfoafter2 = PublicMethod.getAccountResource(linkage006Address2,
        blockingStubFull1);
  ...
  Long afterFreeNetUsed2 = resourceInfoafter2.getFreeNetUsed();
    ...
    PublicMethod.unFreezeBalance(linkage006Address2, linkage006Key2, 1,
  ...
  public void shutdown() throws InterruptedException {
    PublicMethod.unFreezeBalance(linkage006Address, linkage006Key, 1,
        linkage006Address, blockingStubFull);
    PublicMethod.unFreezeBalance(linkage006Address, linkage006Key, 0,
        linkage006Address, blockingStubFull);
    PublicMethod.unFreezeBalance(linkage006Address2, linkage006Key2, 1,
        linkage006Address2, blockingStubFull);
    PublicMethod.unFreezeBalance(linkage006Address2, linkage006Key2, 0,
        linkage006Address2, blockingStubFull);
    PublicMethod.freeResource(linkage006Address, linkage006Key, fromAddress, blockingStubFull);
    PublicMethod.freeResource(linkage006Address2, linkage006Key2, fromAddress, blockingStubFull);  }
