...
@Slf4j
@MultiNode
public class TriggerConstant008 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "TriggerConstantContract a pure function with ABI", groups = {"contract", "daily"})
