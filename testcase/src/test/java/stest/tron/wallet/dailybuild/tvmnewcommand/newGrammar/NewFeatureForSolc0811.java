...
public class NewFeatureForSolc0811 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Get enum.min or enum.max",
  ...
  @Test(
      enabled = true,
      description = "User defined type of data",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Get assembly address",
      groups = {"contract", "daily"})
  public void test003GetAssemblyAddress() {
    ...
    Assert.assertTrue(
        ByteArray.toHexString(transactionExtention.getConstantResult(0).toByteArray())
            .contains(ByteArray.toHexString(mapKeyContract).substring(2)));
  }

  @Test(
      enabled = true,
      description = "Get assembly selector",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Get ABI-Encode calldata",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Support constructor read immutable value",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Fix immutable symbol bug",
      groups = {"contract", "daily"})
