...
public class NewFeatureForSolc0811 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Get enum.min or enum.max", groups = {"contract", "daily"})
  ...
  @Test(enabled = true,description = "User defined type of data", groups = {"contract", "daily"})
  ...
  @Test(enabled = true,description = "Get assembly address", groups = {"contract", "daily"})
  ...
  @Test(enabled = true,description = "Get assembly selector", groups = {"contract", "daily"})
  ...
  @Test(enabled = true,description = "Get ABI-Encode calldata", groups = {"contract", "daily"})
  ...
  @Test(enabled = true,description = "Support constructor read immutable value", groups = {"contract", "daily"})
  ...
  @Test(enabled = true,description = "Fix immutable symbol bug", groups = {"contract", "daily"})
