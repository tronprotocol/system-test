...
public class isContractCommand001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Correct contract address test",
  ...
  @Test(
      enabled = true,
      description = "Account address test",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Nonexistent account address test",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Constructor return test",
      groups = {"contract", "daily"})
  ...
  public void test05ActiveContractBeforeDeploy() {
    ...
    Protocol.Transaction transaction =
        PublicMethod.deployContractWithoutBroadcast(
            contractName,
            abi,
            code,
            "",
  ...
  @Test(
      enabled = true,
      description = "A call B's iscontract in it's constructor",
      groups = {"contract", "daily"})
