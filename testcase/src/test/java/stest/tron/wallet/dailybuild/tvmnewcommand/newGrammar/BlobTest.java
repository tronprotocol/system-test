...
@Slf4j
public class BlobTest extends TronBaseTest {
  ...
  String compileParam = "--experimental-via-ir";
    HashMap retMap = PublicMethod.getBycodeAbiWithParam(filePath, contractName, compileParam);
  ...
  String abi = retMap.get("abI").toString();
    ...
    contractName = "D";
    retMap = PublicMethod.getBycodeAbiWithParam(filePath, contractName, compileParam);
  ...
  @Test(enabled = true, description = "test blobhash in assembly", groups = {"contract", "daily"})
  public void test01AssemblyBlobhash() {
    String txid = PublicMethod.triggerContract(contractC,
            "assemblyBlobhash()", "#",
  ...
  @Test(enabled = true, description = "test blobbasefee in assembly", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "test blobhash(index)", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "test block.blobbasefee", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "test blob KZGPointEvaluation", groups = {"contract", "daily"})
...
String args = "\""+ versionedHash+"\",\"" + commitment +"\",\""+z+"\",\""+y+"\",\""+proof+"\"";
    GrpcAPI.TransactionExtention transactionExtention = PublicMethod.triggerConstantContractForExtention(contractC,
...
//                    "73eda753299d7d483339d80809a1d80553bda402fffe5bfeffffffff00000001", result);
  ...
  @Test(enabled = true, description = "test staticcallBlobhash", groups = {"contract", "daily"})
  public void test08StaticcallBlobhashn(){
    String args = "\"" + base58contractC + "\"";
  String txid = PublicMethod.triggerContract(contractD,
  ...
  @Test(enabled = true, description = "test StaticcallBlobBaseFee", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "test delegatecallBlobhash", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "test delegatecallBlobBaseFee", groups = {"contract", "daily"})
  ...
  @Test(enabled = false, description = "test blob KZGPointEvaluation", groups = {"contract", "daily"})
