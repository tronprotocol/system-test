...
public class MarketSellAsset006 extends TronBaseTest {
  ...
  @Test(
      enabled = false,
      description = "getMarketPairList from solidity and pbft",
      groups = {"daily"})
  void marketSellAssetTest002() {
    Optional<MarketOrderPairList> pairList = PublicMethod.getMarketPairList(blockingStubFull);

    PublicMethod.waitSolidityNodeSynFullNodeData(blockingStubFull, blockingStubSolidity);

    Optional<MarketOrderPairList> pairList2 =
        PublicMethod.getMarketPairListSolidity(blockingStubSolidity);

    Optional<MarketOrderPairList> pairList3 =
        PublicMethod.getMarketPairListSolidity(blockingStubPbft);
  ...
  @Test(
      enabled = false,
      description = "getMarketOrderListByPair from solidity and pbft",
      groups = {"daily"})
  void marketSellAssetTest003() {
    Optional<MarketOrderList> orderList =
        PublicMethod.getMarketOrderListByPair(
            assetAccountId001, assetAccountId002, blockingStubFull);

    PublicMethod.waitSolidityNodeSynFullNodeData(blockingStubFull, blockingStubSolidity);

    Optional<MarketOrderList> orderList2 =
        PublicMethod.getMarketOrderListByPairSolidity(
            assetAccountId001, assetAccountId002, blockingStubSolidity);

    Optional<MarketOrderList> orderList3 =
        PublicMethod.getMarketOrderListByPairSolidity(
            assetAccountId001, assetAccountId002, blockingStubPbft);
  ...
  @Test(
      enabled = false,
      description = "GetMarketOrderById from solidity and pbft",
      groups = {"daily"})
  ...
  @Test(
      enabled = false,
      description = "GetMarketOrderByAccount from solidity and pbft",
      groups = {"daily"})
  void marketSellAssetTest005() {
    ...
    Optional<MarketOrderList> orderList2 =
        PublicMethod.getMarketOrderByAccountSolidity(testAddress001, blockingStubSolidity);
    Assert.assertTrue(orderList2.get().getOrdersCount() > 0);

    Optional<MarketOrderList> orderList3 =
        PublicMethod.getMarketOrderByAccountSolidity(testAddress001, blockingStubPbft);
  ...
  void marketSellAssetTest006() {
    ...
    MarketOrder order2 =
        PublicMethod.getMarketOrderByIdSolidity(orderId, blockingStubSolidity).get();
    ...
    MarketOrder order3 = PublicMethod.getMarketOrderByIdSolidity(orderId, blockingStubPbft).get();
