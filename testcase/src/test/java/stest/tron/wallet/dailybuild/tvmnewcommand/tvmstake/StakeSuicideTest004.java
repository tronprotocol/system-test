...
public class StakeSuicideTest004 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    PublicMethod.sendcoin(
        testAddress001, 1000_000_00000L, foundationAddress, foundationKey, blockingStubFull);
  ...
  @Test(
      enabled = false,
      description = "targetAddress has frozen 1,suicide contract stake 1",
  ...
  void tvmStakeSuicideTest001() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            targetAddress, 10_000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);

    Assert.assertTrue(
        PublicMethod.freezeBalance(
            targetAddress, 1_000000L, 3, testKeyTargetAddress, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    BigInteger expected =
        BigInteger.valueOf(ownerFrozen.getExpireTime())
            ...
            .add(
                BigInteger.valueOf(targetFrozenBefore.getExpireTime())
                    .multiply(BigInteger.valueOf(targetFrozenBefore.getFrozenBalance())))
            .divide(
                BigInteger.valueOf(ownerFrozen.getFrozenBalance())
    ...
    Assert.assertEquals(
        targetFrozenAfter.getFrozenBalance(),
        ownerFrozen.getFrozenBalance() + targetFrozenBefore.getFrozenBalance());
  }

  @Test(
      enabled = false,
      description = "targetAddress has frozen 1,suicide contract stake all",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "targetAddress has frozen all,suicide contract stake all",
      groups = {"contract", "daily"})
  void tvmStakeSuicideTest003() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            targetAddress, 20_000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    Assert.assertTrue(
        PublicMethod.freezeBalanceForReceiver(
            ...
            testKeyTargetAddress,
            blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);

    Assert.assertTrue(
        PublicMethod.freezeBalance(
            targetAddress, 10_000000L, 3, testKeyTargetAddress, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(
      enabled = false,
      description = "targetAddress is new account ,suicide contract stake all",
      groups = {"contract", "daily"})
  void tvmStakeSuicideTest004() {
    ...
    Assert.assertEquals(targetFrozenAfter.getFrozenBalance(), ownerFrozen.getFrozenBalance());
  }

  @Test(
      enabled = false,
      description = "targetAddress frozen to other address ,suicide contract " + "stake all",
      groups = {"contract", "daily"})
