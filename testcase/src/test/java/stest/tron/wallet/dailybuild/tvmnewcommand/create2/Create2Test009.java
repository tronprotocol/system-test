...
@Slf4j
@MultiNode
public class Create2Test009 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "Trigger create2 function to deploy test contract", groups = {"contract", "daily"})
  ...
  // the contract address in transaction info,
    ...
    Assert.assertEquals(Base58.encode58Check(testContractAddress), PublicMethod.create2(parameter));
