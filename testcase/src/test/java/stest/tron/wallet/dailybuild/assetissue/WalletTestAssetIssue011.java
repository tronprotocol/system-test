...
public class WalletTestAssetIssue011 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Transfer asset to create account",
      groups = {"daily"})
  public void testTransferAssetCreateAccount() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            asset011Address, sendAmount, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalance(
            asset011Address, 100000000L, 3, testKeyForAssetIssue011, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    Assert.assertTrue(
        PublicMethod.transferAsset(
            ...
            blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Account queryTransferAssetAccount =
        PublicMethod.queryAccount(transferAssetCreateKey, blockingStubFull);
    ...
    PublicMethod.freeResource(
        asset011Address, testKeyForAssetIssue011, foundationAddress, blockingStubFull);
    PublicMethod.unFreezeBalance(
        asset011Address, testKeyForAssetIssue011, 0, asset011Address, blockingStubFull);
  }
