...
public class BlockhashTest extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "BlockHash should not be change after command OR",
  ...
  @Test(
      enabled = true,
      description = "BlockHash should not be change after command AND",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "BlockHash should not be change after command XOR",
      groups = {"contract", "daily"})
