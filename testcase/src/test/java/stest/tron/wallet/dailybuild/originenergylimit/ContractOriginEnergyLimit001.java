...
public class ContractOriginEnergyLimit001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Boundary value and update test",
      groups = {"daily"})
  public void testOrigin_energy_limit001() {
    ...
    Assert.assertFalse(
        PublicMethod.updateEnergyLimit(
            contractAddress2, -1L, testKeyForGrammarAddress3, grammarAddress3, blockingStubFull));
    ...
    Assert.assertFalse(
        PublicMethod.updateEnergyLimit(
            contractAddress2, 0L, testKeyForGrammarAddress3, grammarAddress3, blockingStubFull));
    ...
    Assert.assertTrue(
        PublicMethod.updateEnergyLimit(
            contractAddress2, 'c', testKeyForGrammarAddress3, grammarAddress3, blockingStubFull));
    ...
    Assert.assertFalse(
        PublicMethod.updateEnergyLimit(
            contractAddress2, 1L, foundationKey, foundationAddress, blockingStubFull));
