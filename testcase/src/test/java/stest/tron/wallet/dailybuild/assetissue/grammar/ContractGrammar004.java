...
public class ContractGrammar004 extends TronBaseTest {
  ...
  public void beforeClass() {
    initSolidityChannel();
    PublicMethod.printAddress(testKeyForGrammarAddress);    channelFull1 = ManagedChannelBuilder.forTarget(fullnode1).usePlaintext().build();
    blockingStubFull1 = WalletGrpc.newBlockingStub(channelFull1);
  }

  @Test(enabled = true, description = "ContractResult is OUT_OF_TIME", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "ContractResult is OUT_OF_MEMORY", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "ContractResult is BAD_JUMP_DESTINATION", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "ContractResult is OUT_OF_ENERGY", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "ContractResult is ILLEGAL_OPERATION", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "ContractResult is REVERT", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "ContractResult is SUCCESS", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "ContractResult is TRANSFER_FAILED", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "ContractResult is STACK_TOO_SMALL", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "ContractResult is STACK_TOO_LARGE", groups = {"contract", "daily"})
