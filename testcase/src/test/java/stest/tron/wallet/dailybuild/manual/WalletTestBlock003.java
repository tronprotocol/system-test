...
@Slf4j
public class WalletTestBlock003 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    blockHash =
        PublicMethod.getBlock(blockNum + 1, blockingStubFull)
            .getBlockHeader()
            .getRawData()
            .getParentHash();
  }
  ...
  @Test(
      enabled = true,
      description = "Get block from fullnode",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Get block from solidity",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Get block by block num with detail true",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "Get block by block num with detail default false",
      groups = {"daily"})
