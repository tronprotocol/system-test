...
@Slf4j
public class NewFeatureForSolidity062 extends TronBaseTest {
  ...
  String abi = retMap.get("abI").toString();
    gasValueContract = PublicMethod.deployContract(contractName, abi, code, "", maxFeeLimit,
  ...
  @Test(enabled = true, description = "get selector from contract or interface's external function", groups = {"contract", "daily"})
  ...
  String truerRes = ByteArray.toHexString(transactionExtention
    ...
    transactionExtention = PublicMethod.triggerConstantContractForExtention(gasValueContract,
  ...
  @Test(enabled = true, description = "call external function like "
      + "c.f{gas: 0, value: 1}()", groups = {"contract", "daily"})
  public void test02Call0GasAnd1Value() {

    String txid = PublicMethod.triggerContract(gasValueContract,
  ...
  byte[] internalReceiver = infoById.get().getInternalTransactions(0)
    ...
    long balanceReceiver = PublicMethod.queryAccount(internalReceiver, blockingStubFull)
        .getBalance();
  ...
  @Test(enabled = true, description = "call external function like "
      + "c.f{gas: 0, value: 0}()", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "inline assembly allow true and false", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "test new create2", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "test Interface Succeed", groups = {"contract", "daily"})
  ...
  String code = retMap.get("byteCode").toString();
  String abi = retMap.get("abI").toString();
  byte[] implementContract = PublicMethod.deployContract(contractName, abi, code, "", maxFeeLimit,
        10000000L, 100, null, contractExcKey,
        contractExcAddress, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(enabled = true, description = "call external function like "
      + "c.f{gas: 440000, value: 0}()", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "call external function like "
      + "c.f{gas: 1, value: 0}()", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "call external function like "
      + "c.f{gas: 0, value: > balance}()", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "call external function like "
      + "c.f{gas: 9223372036854775800, value: 0}()", groups = {"contract", "daily"})
