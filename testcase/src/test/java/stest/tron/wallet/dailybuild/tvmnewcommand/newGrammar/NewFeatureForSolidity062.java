...
public class NewFeatureForSolidity062 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "get selector from contract or interface's external function",
  ...
  @Test(
      enabled = true,
      description = "call external function like " + "c.f{gas: 0, value: 1}()",
      groups = {"contract", "daily"})
  public void test02Call0GasAnd1Value() {
    ...
    String txid =
        PublicMethod.triggerContract(
            gasValueContract,
            "callWithGasAndValue(uint256,uint256)",
            "0,1",
            false,
            0,
            maxFeeLimit,
    ...
    byte[] internalReceiver =
        infoById.get().getInternalTransactions(0).getTransferToAddress().toByteArray();

    long balanceReceiver =
        PublicMethod.queryAccount(internalReceiver, blockingStubFull).getBalance();
    logger.info(
        "transfer to address: "
            + Base58.encode58Check(internalReceiver)
            + "\n balance:"
            + balanceReceiver);
  ...
  @Test(
      enabled = true,
      description = "call external function like " + "c.f{gas: 0, value: 0}()",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "inline assembly allow true and false",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test Interface Succeed",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "call in contract external function like " + "c.f{gas: 0, value: 1}()",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "call external function like " + "c.f{gas: 440000, value: 0}()",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "call external function like " + "c.f{gas: 1, value: 0}()",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "call external function like " + "c.f{gas: 0, value: > balance}()",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "call external function like " + "c.f{gas: 9223372036854775800, value: 0}()",
      groups = {"contract", "daily"})
