...
/** */
@Slf4j
@Flaky(reason = "HTTP API timing-sensitive: freeze/unfreeze operations", since = "2026-04-03")
public class HttpTestFreezeV2001 {
  ...
  public void beforeClass() {
    ...
    response =
        HttpMethod.sendCoin(httpnode, fromAddress, freezeBandwidthAddress, amount, testKey002);
    response = HttpMethod.sendCoin(httpnode, fromAddress, freezeEnergyAddress, amount, testKey002);
    response = HttpMethod.sendCoin(httpnode, fromAddress, receiverResourceAddress, 1L, testKey002);
  ...
  @Test(
      enabled = true,
      description = "FreezeBalanceV2 for bandwidth by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "UnFreezeBalanceV2 for bandwidth by http",
      groups = {"daily", "serial"})
  public void test002UnFreezeBalanceV2ForBandwidth() {
    beforeBalance = HttpMethod.getBalance(httpnode, freezeBandwidthAddress);
    // UnFreezeBalanceV2 for bandwidth
    response =
        HttpMethod.unFreezeBalanceV2(
    ...
    responseContent =
        HttpMethod.parseResponseContent(HttpMethod.getAccount(httpnode, freezeBandwidthAddress));
  ...
  @Test(
      enabled = true,
      description = "FreezeBalanceV2 for energy by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "UnFreezeBalanceV2 for energy by http",
      groups = {"daily", "serial"})
  public void test004UnFreezeBalanceForEnergy() {
    ...
    responseContent =
        HttpMethod.parseResponseContent(HttpMethod.getAccount(httpnode, freezeEnergyAddress));
    JSONArray unfrozenV2 = responseContent.getJSONArray("unfrozenV2");
    Assert.assertTrue(unfrozenV2.size() == 1);
  ...
  @Test(
      enabled = true,
      description = "DelegateResource of bandwidth for others by http",
      groups = {"daily", "serial"})
  public void test005DelegateResourceOfBandwidthForOthers() {
    ...
    responseContent =
        HttpMethod.parseResponseContent(HttpMethod.getAccount(httpnode, receiverResourceAddress));
  ...
  @Test(
      enabled = true,
      description = "UndelegateResource of bandwidth for others by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "DelegateResource of energy for others by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "UndelegateResource of energy for others by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "WithdrawExpireUnfreeze by http",
      groups = {"daily", "serial"})
  public void test009WithdrawExpireUnfreeze() {
    ...
    response =
        HttpMethod.withdrawExpireUnfreeze(httpnode, freezeBandwidthAddress, freezeBandwidthKey);
    Assert.assertTrue(HttpMethod.verificationResult(response));
    HttpMethod.waitToProduceOneBlock(httpnode);
  ...
  @Test(
      enabled = true,
      description = "getCanWithdrawUnfreezeAmount by http",
      groups = {"daily", "serial"})
  public void test012GetCanWithdrawUnfreezeAmount() {
    ...
    responseContent =
        HttpMethod.parseResponseContent(HttpMethod.getAccount(httpnode, freezeForQuery));
  ...
  @Test(
      enabled = true,
      description = "GetDelegatedResourceV2 by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "GetDelegatedResourceAccountIndexV2 by http",
      groups = {"daily", "serial"})
  public void test014GetDelegatedResourceAccountIndexV2() {
    ...
    responseContent =
        HttpMethod.parseResponseContent(
            HttpMethod.getDelegatedResourceAccountIndexV2Pbft(httpPbftNode, freezeForQuery, true));
    Assert.assertTrue(
        responseContent.getString("account").equals(Base58.encode58Check(freezeForQuery)));
    Assert.assertTrue(
        responseContent
  ...
  @Test(
      enabled = true,
      description = "GetAvailableUnfreezeCount by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Test lockPeriod = 1000L",
      groups = {"daily", "serial"})
