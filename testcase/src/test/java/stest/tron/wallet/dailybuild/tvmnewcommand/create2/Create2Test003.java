...
public class Create2Test003 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 command with invalid bytecode",
      groups = {"contract", "daily"})
  public void test02TriggerCreate2WithInvalidBytecode() {
    ...
    String testContractCode =
        "608060405234801561001057600080fd5b50d3801561001d57600080fd5b50d2801"
            + "561002a57600080fd5b5060c9806100396000396000f5fe6080604052348015600f57600080fd5b50d38"
            + "015"
            + "601b57600080fd5b50d28015602757600080fd5b50600436106066577c01000000000000000000000000"
            + "000"
            + "00000000000000000000000000000600035046368e5c0668114606b578063e5aa3d58146083575b60008"
            + "0fd"
            + "5b60716089565b60408051918252519081900360200190f35b60716097565b6000805460010190819055"
            + "905"
            + "65b6000548156fea165627a7a72305820f3e3c0646a8c8d521fe819f10a592327469f611f0d9e8206697"
            + "f7f"
            + "3436ff3c7d0029";
    Long salt = 1L;
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 command with empty bytecode",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 command with \"6080\" bytecode",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 command with \"00000000000\" bytecode",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 command with NULL bytecode",
      groups = {"contract", "daily"})
