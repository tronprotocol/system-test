...
public class Create2Test021 extends TronBaseTest {
  ...
  public void beforeClass() throws Exception {
    ...
    PublicMethod.printAddress(resourceOnwerKey);
  ...
  @Test(
      enabled = true,
      description = "resource delegate with create2 contract, and suicide ",
  ...
  public void test1TriggerContract() {
    ...
    Long beforeExcAccountBalance =
        PublicMethod.queryAccount(resourceOnwerAddress, blockingStubFull).getBalance();
    ...
    Assert.assertTrue(
        PublicMethod.getAccountResource(bytes, blockingStubFull).getEnergyLimit() == 0);
    ...
    Account getAssetIdFromAccount =
        PublicMethod.queryAccount(resourceOnwerAddress, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Create2 contract can transfer trx and token.",
      groups = {"contract", "daily"})
  public void test2TriggerContract() {
    ...
    Account contractExcAddressbefore =
        PublicMethod.queryAccount(contractExcAddress, blockingStubFull);
    ...
    Long returnAddressBytesAccountCountBefore =
        PublicMethod.getAssetIssueValue(bytes, assetAccountId, blockingStubFull);
