...
public class MultiSign09 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Active doesn't have parent_id",
  ...
  @Test(
      enabled = true,
      description = "Active parent_id is exception condition",
      groups = {"daily", "multisig"})
  public void testActiveParent02() {
    ...
    Assert.assertEquals(
        "Contract validate error : permission's parent should be owner",
  ...
  @Test(
      enabled = true,
      description = "Active parent_id is 0",
      groups = {"daily", "multisig"})
