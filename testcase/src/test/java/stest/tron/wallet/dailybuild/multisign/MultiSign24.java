...
public class MultiSign24 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Broadcast multi sign normal transaction",
  ...
  @Test(
      enabled = true,
      description = "Broadcast single owner sign normal transaction",
      groups = {"daily", "multisig"})
  public void test03BroadcastSingleSignNormalTransaction() {
    ...
    Transaction transaction1 =
        PublicMethodForMultiSign.addTransactionSignWithPermissionId(
            transaction, foundationKey, 0, blockingStubFull);
