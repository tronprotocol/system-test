...
public class ContractTrcToken038 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Multi-level call transferToken assert tokenBalance ", groups = {"contract", "daily"})
  ...
  final byte[] transferTokenContractAddress = PublicMethod
