...
@Slf4j
public class ContractTrcToken038 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Multi-level call transferToken assert tokenBalance ",
  ...
  public void deployTransferTokenContract() {
    ...
    final byte[] transferTokenContractAddress =
    ...
    Assert.assertFalse(PublicMethod.sendcoin(btestAddress, 1000000000L,
            foundationAddress, foundationKey, blockingStubFull));*/
    Account info;
