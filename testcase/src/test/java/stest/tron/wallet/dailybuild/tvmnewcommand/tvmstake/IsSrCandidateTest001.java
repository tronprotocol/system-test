...
public class IsSrCandidateTest001 extends TronBaseTest {
  ...
  @Test(
      enabled = false,
      description = "Witness Address should be true",
  ...
  @Test(
      enabled = false,
      description = "Account Address should be false",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "zero Address(0x00) should be false",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "Contract Address should be false",
      groups = {"contract", "daily"})
