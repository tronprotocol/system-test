...
public class MultiSign23 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Add sign for multi sign normal transaction",
  ...
  public void test01MultiSignNormalTransaction() {
    ...
    PublicMethodForMultiSign.recoverAccountPermission(
    ...
    Transaction transaction4 =
        PublicMethodForMultiSign.addTransactionSignWithPermissionId(
            transaction, tmpKey02, 2, blockingStubFull);
    Assert.assertFalse(
        PublicMethodForMultiSign.broadcastTransaction(transaction3, blockingStubFull));
    Assert.assertFalse(
        PublicMethodForMultiSign.broadcastTransaction(transaction4, blockingStubFull));
  ...
  @Test(
      enabled = true,
      description = "Add sign for multi sign permission transaction",
      groups = {"daily", "multisig"})
  public void test02MultiSignPermissionTransaction() {
    ...
    Transaction transaction =
        PublicMethodForMultiSign.accountPermissionUpdateWithoutSign(
            accountPermissionJson,
            ownerAddress,
            ownerKey,
            blockingStubFull,
  ...
  public void test03SingleSignNormalTransaction() {
    ...
    Assert.assertTrue(
        PublicMethodForMultiSign.broadcastTransaction(transaction1, blockingStubFull));
    Long balanceAfter = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceAfter: " + balanceAfter);
    Assert.assertEquals(balanceBefore - balanceAfter, needCoin + 1000000);

    GrpcAPI.TransactionApprovedList transactionApprovedList =
        PublicMethod.getTransactionApprovedList(transaction1, blockingStubFull);
  ...
  public void test06SignFailedTransaction() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, needCoin + 1000_000, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    //    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Long balanceBefore = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceBefore: " + balanceBefore);
    ...
    Transaction transaction1 =
        PublicMethodForMultiSign.addTransactionSignWithPermissionId(
            transaction, foundationKey, 2, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Add sign for timeout normal transaction,get approve list",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Add sign for empty transaction,get approve list",
      groups = {"daily", "multisig"})
  public void test08EmptyTransaction() {
    ...
    Transaction transaction1 =
        PublicMethod.addTransactionSign(transaction, ownerKey, blockingStubFull);
    ...
    GrpcAPI.TransactionApprovedList transactionApprovedList =
        PublicMethod.getTransactionApprovedList(transaction, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Add sign for fake transaction,get approve list",
      groups = {"daily", "multisig"})
  public void test09ErrorTransaction() {
    ...
    Transaction transaction =
        PublicMethodForMultiSign.createFakeTransaction(ownerAddress, 1_000_000L, ownerAddress);
    Transaction transaction1 =
        PublicMethodForMultiSign.addTransactionSignWithPermissionId(
            transaction, tmpKey02, 2, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Add sign transaction with mix order",
      groups = {"daily", "multisig"})
  public void test10MultiSignNormalTransactionWithMixOrder() {
    ...
    Transaction transaction3 =
        PublicMethodForMultiSign.addTransactionSignWithPermissionId(
            transaction2, witnessKey, 2, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Add sign transaction with same address",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Add sign transaction with null address",
      groups = {"daily", "multisig"})
