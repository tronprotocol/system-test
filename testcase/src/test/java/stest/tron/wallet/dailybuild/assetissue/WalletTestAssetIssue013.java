...
public class WalletTestAssetIssue013 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Use transfer net when token owner has no enough net",
      groups = {"daily"})
  public void testWhenNoEnoughFreeAssetNetLimitUseTransferNet() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            asset013Address, sendAmount, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalance(
            asset013Address, 100000000L, 3, testKeyForAssetIssue013, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    AccountNetMessage assetCreatorNet =
        PublicMethod.getAccountNet(asset013Address, blockingStubFull);
    ...
    Assert.assertTrue(
        PublicMethod.transferAsset(
            ...
            transferAssetCreateKey,
            blockingStubFull));
    assetCreatorNet = PublicMethod.getAccountNet(asset013Address, blockingStubFull);
    ...
    PublicMethod.freeResource(
        asset013Address, testKeyForAssetIssue013, foundationAddress, blockingStubFull);
    PublicMethod.unFreezeBalance(
        asset013Address, testKeyForAssetIssue013, 0, asset013Address, blockingStubFull);
  }
