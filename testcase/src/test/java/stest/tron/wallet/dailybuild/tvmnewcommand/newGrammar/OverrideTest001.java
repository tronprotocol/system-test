...
public class OverrideTest001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Deploy 0.5.15 about override(Base1,Base2)",
  ...
  @Test(
      enabled = true,
      description = "Deploy 0.6.0 about not need override",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Deploy 0.6.0 about override(Base1,Base2)",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Deploy 0.6.0 about override modifier",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Deploy 0.5.15 about override modifier",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Deploy 0.6.0 public override external function",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Deploy 0.5.15 public override external function",
      groups = {"contract", "daily"})
