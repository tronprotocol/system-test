...
@Slf4j
@MultiNode
public class TriggerConstant007 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "TriggerConstantContract a view function with ABI", groups = {"contract", "daily"})
