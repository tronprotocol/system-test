...
public class batchValidateSignContract009 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Incorrect address hex test multivalidatesign", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "Empty address and signatures hex test multivalidatesign", groups = {"contract", "daily"})
