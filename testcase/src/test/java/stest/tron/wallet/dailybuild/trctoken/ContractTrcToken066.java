...
public class ContractTrcToken066 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "TransferToken with 0 tokenValue, deploy transferContract",
  ...
  @Test(
      enabled = true,
      description = "TransferToken with 0 tokenValue, deploy receive contract",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "TransferToken with 0 tokenValue, trigger transferContract",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "TransferToken with 0 tokenValue, get contract tokenBalance",
      groups = {"contract", "daily"})
