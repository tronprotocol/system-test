...
public class ContractInternalTransaction001 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Create->call.Two-level nesting", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "There is one internalTransaction.Only call", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "There is one internalTransaction.Only create", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "Test suicide type in internalTransaction", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "Type is create call", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "Type is create call call", groups = {"contract", "daily"})
