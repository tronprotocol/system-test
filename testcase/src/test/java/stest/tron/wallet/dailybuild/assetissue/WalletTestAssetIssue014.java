...
@Slf4j
public class WalletTestAssetIssue014 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Use transfer net when no enough public free asset net",
      groups = {"daily"})
  public void testWhenNoEnoughPublicFreeAssetNetLimitUseTransferNet() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            asset014Address, sendAmount, foundationAddress, foundationKey, blockingStubFull));
    ...
    Assert.assertTrue(
        PublicMethod.createAssetIssue(
            ...
            1L,
            1L,
            testKeyForAssetIssue014,
            blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);

    Account getAssetIdFromThisAccount;
    getAssetIdFromThisAccount = PublicMethod.queryAccount(asset014Address, blockingStubFull);
    ...
    AccountNetMessage assetCreatorNet =
        PublicMethod.getAccountNet(asset014Address, blockingStubFull);
    ...
    Assert.assertTrue(
        PublicMethod.transferAsset(
            ...
            blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    assetCreatorNet = PublicMethod.getAccountNet(asset014Address, blockingStubFull);
    ...
    PublicMethod.freeResource(
        asset014Address, testKeyForAssetIssue014, foundationAddress, blockingStubFull);
    PublicMethod.unFreezeBalance(
        asset014Address, testKeyForAssetIssue014, 0, asset014Address, blockingStubFull);
  }
