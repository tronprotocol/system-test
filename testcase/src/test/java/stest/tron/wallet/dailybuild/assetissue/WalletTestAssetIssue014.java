...
public class WalletTestAssetIssue014 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Use transfer net when no enough public free asset net", groups = {"daily"})
  public void testWhenNoEnoughPublicFreeAssetNetLimitUseTransferNet() {
    ...
    Assert.assertTrue(PublicMethod
        .sendcoin(asset014Address, sendAmount, foundationAddress, foundationKey, blockingStubFull));
  ...
  Long transferAfterFreeNetUsed = assetTransferNet.getFreeNetUsed();
    ...
    PublicMethod
        .freeResource(asset014Address, testKeyForAssetIssue014, foundationAddress, blockingStubFull);
    PublicMethod.unFreezeBalance(asset014Address, testKeyForAssetIssue014, 0, asset014Address,
        blockingStubFull);
  }
