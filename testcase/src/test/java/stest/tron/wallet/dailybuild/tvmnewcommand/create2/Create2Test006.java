...
public class Create2Test006 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 with salt empty",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 with salt 0",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 with salt -1",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 with salt 100",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "Trigger create2 with salt f * 64",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 with salt efffe",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 with salt affffa",
      groups = {"contract", "daily"})
