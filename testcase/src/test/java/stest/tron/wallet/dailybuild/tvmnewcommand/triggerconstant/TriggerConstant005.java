...
@Slf4j
@MultiNode
public class TriggerConstant005 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "TriggerConstantContract a payable function with ABI", groups = {"contract", "daily"})
