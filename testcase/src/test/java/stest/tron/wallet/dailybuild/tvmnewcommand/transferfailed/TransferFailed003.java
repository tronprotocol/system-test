...
public class TransferFailed003 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "TransferToken enough tokenBalance",
  ...
  @Test(
      enabled = true,
      description = "TransferToken insufficient tokenBalance",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "TransferToken to nonexistent target",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "TransferToken to myself",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "TransferToken notexist tokenID ",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "TransferToken to myself and insufficient tokenBalance",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "TransferToken to nonexistent target, but revert",
      groups = {"contract", "daily"})
