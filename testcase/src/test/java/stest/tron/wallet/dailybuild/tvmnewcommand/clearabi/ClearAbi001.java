...
public class ClearAbi001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Clear a contract created by other account",
  ...
  public void testClearAbi001() {
    ...
    TransactionExtention transactionExtention =
        PublicMethod.clearContractAbiForExtention(
  ...
  @Test(
      enabled = true,
      description = "Clear a contract with ABI created by itself",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Clear a contract without ABI",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Clear a account address",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Clear a uninitialized account",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Clear a not meet the rules address",
      groups = {"contract", "daily"})
