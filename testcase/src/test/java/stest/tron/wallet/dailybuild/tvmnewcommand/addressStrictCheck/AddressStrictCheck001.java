...
public class AddressStrictCheck001 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Open experimental check address ", groups = {"contract", "daily"})
  ...
  String num = "00000000000000000000004108362A6DB594586C035758ECA382A49FDF13EF61";
    ...
    transactionExtention = PublicMethod.triggerConstantContractForExtention(contractAddress,
        "checkAddress2(address)", num, true,
        0, 0, "0", 0, contractExcAddress, contractExcKey, blockingStubFull);
