...
@Slf4j
@Flaky(reason = "Contract deployment timing, intermittent null results", since = "2026-04-03")
@MultiNode
public class UsdtTest002 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "args feeLimit = need feeLimit - 1",
  ...
  @Test(
      enabled = true,
      description = "transfer usdt, no energy, and trx balance = feeLimit",
      groups = {"contract", "daily"})
  public void test02() {
    Assert.assertTrue(
        PublicMethod.freezeBalanceV2(dev001Address, 100000000L, 0, dev001Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    long balance = PublicMethod.queryAccount(dev001Address, blockingStubFull).getBalance();
    long needSend = balance - rightFeeLimit;
    Assert.assertTrue(
        PublicMethod.sendcoin(callerddress, needSend, dev001Address, dev001Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    String methedStr = "transfer(address,uint256)";
  ...
  @Test(
      enabled = true,
      description = "transfer usdt, no energy, and trx balance = feeLimit - 1",
      groups = {"contract", "daily"})
  public void test03() {
  ...
  @Test(
      enabled = true,
      description = "originEnergy from 0 to enough",
      groups = {"contract", "daily"})
  public void test04() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 300000000L, testNetAccountAddress, testNetAccountKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.freezeBalanceV2(dev001Address, 250000000L, 1, dev001Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "change consumeUserResourcePercent from 70 to 80",
      groups = {"contract", "daily"})
  public void test05() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    long temPercent =
        PublicMethod.getContract(usdtAddress, blockingStubFull).getConsumeUserResourcePercent();
