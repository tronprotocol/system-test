...
@Slf4j
@MultiNode
public class ContractLinkage001 extends TronBaseTest {
  ...
  public void beforeClass() {
    PublicMethod.printAddress(linkage001Key);
  ...
  @Test(
      enabled = true,
      description = "Deploy contract with valid or invalid value",
      groups = {"daily"})
  public void deployContentValue() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            linkage001Address, 30000000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);

    Account info;
    AccountResourceMessage resourceInfo =
        PublicMethod.getAccountResource(linkage001Address, blockingStubFull);
    ...
    AccountResourceMessage resourceInfoafter =
        PublicMethod.getAccountResource(linkage001Address, blockingStubFull1);
    ...
    Assert.assertTrue(
        PublicMethod.freezeBalanceGetEnergy(
            linkage001Address, freezeBalance, 0, 1, linkage001Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    Assert.assertTrue(
        PublicMethod.freezeBalance(
            linkage001Address, freezeBalance, 0, linkage001Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    Assert.assertTrue(
        PublicMethod.queryAccount(contractAddress, blockingStubFull).getBalance() == valueBalance);
    PublicMethod.unFreezeBalance(
        linkage001Address, linkage001Key, 1, linkage001Address, blockingStubFull);
  }
  ...
  public void shutdown() throws InterruptedException {
    PublicMethod.freeResource(
        linkage001Address, linkage001Key, foundationAddress, blockingStubFull);
  }
}
