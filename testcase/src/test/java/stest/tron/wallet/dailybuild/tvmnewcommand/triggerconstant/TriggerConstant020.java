...
@Slf4j
@MultiNode
public class TriggerConstant020 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "TriggerContract a non-payable function with ABI", groups = {"contract", "daily"})
