...
public class Accounts003 extends JsonRpcBase {
  ...
  @Test(
      enabled = true,
      description = "Eth api of eth_newFilter contains nothing.",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Eth api of eth_newFilter  contains topic and address.",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Eth api of eth_newFilter only contain topic and blockHash.",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Eth api of eth_newFilter which only contains blockHash.",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Eth api of eth_newFilter check new  and after block.",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Eth api of eth_newBlockFilter",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Eth api of eth_getFilterChanges has less 20 elements.",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Eth api of eth_getLogs both contains topic and address.",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Eth api of eth_getFilterLogs .",
      groups = {"daily", "serial"})
