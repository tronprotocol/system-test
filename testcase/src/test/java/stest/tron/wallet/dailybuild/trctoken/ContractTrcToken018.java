...
public class ContractTrcToken018 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Transfer token to an inactive account",
  ...
  public void testDeployTransferTokenContract() {
    ...
    // PublicMethod.randomFreezeAmount.addAndGet(1), 0, 0,
    ...
    Long receiveAssetBefore =
        PublicMethod.getAssetIssueValue(tmpAddress, assetAccountId, blockingStubFull);
    logger.info(
