...
@Slf4j
public class ContractTrcToken018 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Transfer token to an inactive account", groups = {"contract", "daily"})
  public void testDeployTransferTokenContract() {
    ...
    Assert.assertTrue(PublicMethod
        .sendcoin(user001Address, 2200_000_000L, fromAddress, testKey002, blockingStubFull));
...
//    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress, 10_000_000L + PublicMethod.randomFreezeAmount.addAndGet(1), 0, 0,
...
//    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  //    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress,
//        PublicMethod.getFreezeBalanceCount(user001Address, user001Key, 50000L, blockingStubFull), 0,
//        1, ByteString.copyFrom(user001Address), testKey002, blockingStubFull));
  ...
  Long receiveAssetBefore = PublicMethod
  ...
  final String triggerTxid = PublicMethod
    ...
    Long transferAssetAfter = PublicMethod
        .getAssetIssueValue(transferTokenContractAddress, assetAccountId, blockingStubFull);
    logger.info(
  ...
  Long receiveAssetAfter = PublicMethod
        .getAssetIssueValue(tmpAddress, assetAccountId, blockingStubFull);
    logger.info(
