...
public class ContractTrcToken029 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Deploy transferTokenwithSameName contract", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "Trigger transferTokenwithSameName", groups = {"contract", "daily"})
  ...
  // user trigger A to transfer token to B
    ByteString assetAccountDev = PublicMethod
