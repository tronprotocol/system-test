...
public class ContractTrcToken029 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Deploy transferTokenwithSameName contract",
  ...
  public void deploy01TransferTokenContract() {
    ...
    1000000000L, foundationAddress, testKey002, blockingStubFull));*/
  }

  /** constructor. */
  @Test(
      enabled = true,
      description = "Trigger transferTokenwithSameName",
      groups = {"contract", "daily"})
