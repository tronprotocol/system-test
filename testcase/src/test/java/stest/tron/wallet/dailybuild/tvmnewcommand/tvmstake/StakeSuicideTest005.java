...
public class StakeSuicideTest005 extends TronBaseTest {
  ...
  @Test(
      enabled = false,
      description = "targetAddress is account no TRX, and no frozen",
  ...
  void tvmStakeSuicideTest001() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Optional<TransactionInfo> ex =
        PublicMethod.getTransactionInfoById(txidSuicide, blockingStubFull);
  ...
  @Test(
      enabled = false,
      description = "targetAddress is account 1 TRX, and no frozen",
      groups = {"contract", "daily"})
  void tvmStakeSuicideTest002() {
    ...
    PublicMethod.sendcoin(
        targetAddress, 1_000000L, foundationAddress, foundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(
      enabled = false,
      description = "targetAddress is account 1 TRX, and 1 frozen",
      groups = {"contract", "daily"})
