...
public class ExtCodeHashTest003 extends TronBaseTest {
  ...
  @Test(enabled = AllTest, description = "Get a not exist account extcodehash", groups = {"contract", "daily"})
  ...
  @Test(enabled = AllTest, description = "Active the account and get extcodehash again", groups = {"contract", "daily"})
