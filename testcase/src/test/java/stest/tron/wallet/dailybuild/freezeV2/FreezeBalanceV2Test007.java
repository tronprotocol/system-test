...
@Slf4j
@Flaky(reason = "Timing-sensitive: cancel unfreeze wait period", since = "2026-04-03")
public class FreezeBalanceV2Test007 extends TronBaseTest {
  ...
  public void beforeClass() throws Exception {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            testAddress001, 200_000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalanceV2(testAddress001, 20000000L, 0, testKey001, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.freezeBalanceV2(testAddress001, 20000000L, 1, testKey001, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  }
  ...
  @Test(
      enabled = true,
      description = "cancel unexpired unfreeze net, unfreeze count=1",
      groups = {"daily", "staking"})
  public void test01CancelAllUnfreezeNet() {
    GrpcAPI.AccountResourceMessage resource1 =
        PublicMethod.getAccountResource(testAddress001, blockingStubFull);
    Assert.assertEquals(resource1.getTronPowerLimit(), 40);
    logger.info(resource1.toString());

    Assert.assertTrue(
        PublicMethod.unFreezeBalanceV2(testAddress001, testKey001, 1000000L, 0, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "cancel all unexpired unfreeze energy",
      groups = {"daily", "staking"})
  public void test02CancelAllUnfreezeEnergy() {
    ...
    Assert.assertTrue(
        PublicMethod.unFreezeBalanceV2(testAddress001, testKey001, 1000000L, 1, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "cancel all net and energy include expired and unexpired",
      groups = {"daily", "staking"})
  public void test05CancelAllUnfreeze() {
    ...
    Protocol.TransactionInfo info1 =
        PublicMethod.getTransactionInfoByIdFromSolidity(txid, blockingStubFullSolidity).get();
    Protocol.TransactionInfo info2 =
        PublicMethod.getTransactionInfoByIdFromSolidity(txid, blockingStubPbft).get();
  ...
  public void test06VoteAfterCancelAllUnfreeze() {
    ...
    Assert.assertTrue(
        PublicMethod.voteWitness(testAddress001, testKey001, voteMap, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Protocol.Account account1 = PublicMethod.queryAccount(testAddress001, blockingStubFull);
  ...
  public void test07UnfreezeWithVotedAndCancelAllUnfreeze() {
    Assert.assertTrue(
        PublicMethod.unFreezeBalanceV2(testAddress001, testKey001, 19000000L, 0, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Protocol.Account account1 = PublicMethod.queryAccount(testAddress001, blockingStubFull);
