...
public class TransferFailed002 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Send balance not enough",
  ...
  public void test1SendNotEnough() {
    ...
    txid =
        PublicMethod.triggerContract(
            contractAddress,
            "testSendTrxInsufficientBalance(uint256)",
            num,
            false,
            0,
            maxFeeLimit,
  ...
  @Test(
      enabled = true,
      description = "Send balance enough",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Send trx nonexistent target",
      groups = {"contract", "daily"})
  public void test3SendTrxNonexistentTarget() {
    ...
    txid =
        PublicMethod.triggerContract(
            contractAddress,
            "testSendTrxNonexistentTarget(uint256,address)",
            num,
            false,
            0,
            maxFeeLimit,
    ...
    Assert.assertNotEquals(energyUsageTotal2, energyUsageTotal + EnergyCost.getNewAcctCall());
  ...
  @Test(
      enabled = true,
      description = "Send trx nonexistent target and balance not enough",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Send trx self and balance not enough",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Send trx nonexistent target, but revert",
      groups = {"contract", "daily"})
  public void test7SendTrxNonexistentTargetRevert() {
    ...
    txid =
        PublicMethod.triggerContract(
            contractAddress,
            "testSendTrxRevert(uint256,address)",
            num,
            false,
            0,
            maxFeeLimit,
