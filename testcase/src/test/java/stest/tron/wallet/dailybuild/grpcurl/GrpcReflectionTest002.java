...
import stest.tron.wallet.common.client.utils.TransactionCapsule;
import stest.tron.wallet.common.client.utils.TransactionUtils;
import stest.tron.wallet.common.client.utils.TronBaseTest;
import stest.tron.wallet.common.client.utils.Utils;

@Slf4j
public class GrpcReflectionTest002 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "test GetTransactionInfoByBlockNum with grpcurl",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test BroadcastTransaction with grpcurl",
      groups = {"daily"})
  public void test002BroadcastTransaction() {
    ECKey receiver = new ECKey(Utils.getRandom());
    Protocol.Transaction trx =
        PublicMethod.sendcoinForTransaction(
  ...
  @Test(
      enabled = true,
      description = "test GetBlockByLatestNum2",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test TransferAsset2",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test Solidity GetBlockByNum",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetAccountResource",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetBlockByLimitNext",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetTransactionListFromPending",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test CreateAccount2",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test AccountPermissionUpdate",
      groups = {"daily"})
    ...
    String data =
        String.format(
            "{\"owner_address\":\"%s\",\"owner\":{\"type\":0,\"id\":0,\"permission_name\":\"owner\""
                + ","
                + "\"threshold\":1,\"keys\":[{\"address\":\"%s\",\"weight\":1}]},\"actives\":[{\"ty"
                    + "pe\":2,\"id\":2,"
                + "\"permission_name\":\"active\",\"threshold\":1,\"operations\":\"f/8fwAM+ww8AAAAA"
  ...
  @Test(
      enabled = true,
      description = "test CancelAllUnfreezeV2",
      groups = {"daily"})
  public void test015CancelAllUnfreezeV2() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    PublicMethod.unFreezeBalanceV2(
  ...
  @Test(
      enabled = true,
      description = "test CreateAccount",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test CreateAssetIssue",
      groups = {"daily"})
    ...
    String data =
        String.format(
            "{\"owner_address\":\"%s\",\"name\":\"Qml0VG9ycmVudA==\",\"abbr\":\"QkNU\","
                + "\"total_supply\":1000000,\"frozen_supply\":[{\"frozen_amount\":1,\"frozen_days\""
                    + ":1}],"
                + "\"trx_num\":1,\"precision\":6,\"num\":1,\"start_time\":%d,\"end_time\":%d,"
                + "\"description\":\"Z1JQQ3VybEFzc2V0\",\"url\":\"d3d3LnVybC5jb20=\",\"free_asset_n"
                    + "et_limit\":1000,"
  ...
  @Test(
      enabled = true,
      description = "test CreateAssetIssue2",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test CreateCommonTransaction",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test CreateWitness",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test CreateWitness2",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test DelegateResource",
      groups = {"daily"})
  public void test022DelegateResource() {
    ...
    String data =
        String.format(
            "{\"owner_address\":\"%s\",\"resource\":\"ENERGY\",\"balance\":50000000,\"receiver_addr"
                + "ess\":\"%s\"}",
    ...
    String data =
        String.format(
            "{\"owner_address\":\"%s\",\"new_contract\":"
                ...
                + "\"bytecode\":"
                + "\"NjA4MDYwNDA1MjM0ODAxNTYxMDAxMDU3Nj"
                + "AwMDgwZmQ1YjUwZDM4MDE1NjEwMDFkNTc2MD"
                + "AwODBmZDViNTBkMjgwMTU2MTAwMmE"
                + "1NzYwMDA4MGZkNWI1MDYwYjg4MDYxMDAzOTYw"
                + "MDAzOTYwMDBmM2ZlNjA4MDYwNDA1MjM0ODAxN"
                + "TYwMGY1NzYwMDA4MGZkNWI1MGQzOD"
                + "AxNTYwMWI1NzYwMDA4MGZkNWI1MGQyODAxNTYw"
                + "Mjc1NzYwMDA4MGZkNWI1MDYwMDQzNjEwNjA0MD"
                + "U3NjAwMDM1NjBlMDFjODA2MzJmY"
                + "mViZDM4MTQ2MDQ1NTc1YjYwMDA4MGZkNWI2MDU4"
                + "NjA1MDM2NjAwNDYwNmE1NjViNjAwMDgxOTA1NT"
                + "kwNTY1YjYwNDA1MTkwODE1MjY"
                + "wMjAwMTYwNDA1MTgwOTEwMzkwZjM1YjYwMDA2MDI"
                + "wODI4NDAzMTIxNTYwN2I1NzYwMDA4MGZkNWI1MD"
                + "M1OTE5MDUwNTZmZWEyNjQ3ND"
                + "cyNmY2ZTU4MjIxMjIwYzg2Njk3MTVmZTk1MzgxZW"
                + "UzMTVlMTExOTA2NGZmODBhODEyMWRkZmM1Mjc0"
                + "N2E1NTE2MWQwZDRmNGRkYTJh"
                + "NTY0NzM2ZjZjNjM0MzAwMDgxMjAwMzM=\","
                + "\"name\":\"MyContract\","
  ...
  @Test(
      enabled = true,
      description = "test FreezeBalanceV2",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetAccountBalance",
      groups = {"daily"})
  public void test025GetAccountBalance() {
    ...
    String data =
        String.format(
            "{\"account_identifier\":{\"address\":\"%s\"},\"block_identifier\":{\"number\":1,\"hash"
                + "\":\"%s\"}}",
  ...
  @Test(
      enabled = true,
      description = "test GetAccountById",
      groups = {"daily"})
  public void test026GetAccountById() {
    ...
    String returnStringSolidity =
        PublicMethod.gRPCurlRequest(data, requestUrlSolidity, soliditynode);
  ...
  @Test(
      enabled = true,
      description = "test GetAssetIssueByAccount",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetAssetIssueById",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetAssetIssueByName",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetAssetIssueList",
      groups = {"daily"})
  public void test030GetAssetIssueList() {
    ...
    String returnStringSolidity =
        PublicMethod.gRPCurlRequest(null, requestUrlSolidity, soliditynode);
  ...
  @Test(
      enabled = true,
      description = "test GetAssetIssueListByName",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetAvailableUnfreezeCount",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetBandwidthPrices",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetBlockBalanceTrace",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetBlockByLatestNum",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetBrokerageInfo",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetCanDelegatedMaxSize",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetCanWithdrawUnfreezeAmount",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetChainParameters",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test GetDelegatedResourceAccountIndexV2",
      groups = {"daily"})
  public void test042GetDelegatedResourceAccountIndexV2() {
    ...
    String data3 =
        String.format(
            "{\"owner_address\":\"%s\",\"resource\":\"ENERGY\",\"balance\":%d,\"receiver_address\":"
                + "\"%s\"}",
  ...
  @Test(
      enabled = true,
      description = "test ParticipateAssetIssue",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test ParticipateAssetIssue2",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test TransferAsset",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test UnfreezeAsset",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test UnfreezeAsset2",
      groups = {"daily"})
  ...
  @Test(
      enabled = true,
      description = "test UpdateAsset2",
      groups = {"daily"})
  public void test048UpdateAsset2() {
    String ownerAddressBase64 = Base64.getEncoder().encodeToString(jsonRpcOwnerAddress);
    String data =
        String.format(
            "{\"owner_address\":\"%s\",\"description\":\"dGVzdEdycGN1cmw=\",\"url\":\"d3d3LmNjLmNvb"
                + "Q==\"}",
            ownerAddressBase64);
