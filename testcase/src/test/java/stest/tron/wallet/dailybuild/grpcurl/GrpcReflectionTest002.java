...
@Slf4j
public class GrpcReflectionTest002 extends TronBaseTest {  ECKey key = new ECKey(Utils.getRandom());
  ...
  @Test(enabled = true, description = "test GetTransactionInfoByBlockNum with grpcurl", groups = {"daily"})
  public void test001GetTransactionInfoByBlockNum() {
    ECKey receiver = new ECKey(Utils.getRandom());
  String txId = PublicMethod.sendcoinGetTransactionId(receiver.getAddress(), 10000000, foundationAddress, foundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Optional<Protocol.TransactionInfo> trx = PublicMethod.getTransactionInfoById(txId, blockingStubFull);
  ...
  @Test(enabled = true, description = "test BroadcastTransaction with grpcurl", groups = {"daily"})
  public void test002BroadcastTransaction() {
    ECKey receiver = new ECKey(Utils.getRandom());
    Protocol.Transaction trx = PublicMethod.sendcoinForTransaction(
        receiver.getAddress(),
        10000000L,
        foundationAddress,
        foundationKey,
  ...
  @Test(enabled = true, description = "test GetBlockByLatestNum2", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test TransferAsset2", groups = {"daily"})
  ...
  String fromBase64 = Base64.getEncoder().encodeToString(jsonRpcOwnerAddress);
    Protocol.Account accountInfo = PublicMethod.queryAccount(jsonRpcOwnerAddress, blockingStubFull);
  ...
  @Test(enabled = true, description = "GetAccountNet", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test Solidity GetBlockByNum", groups = {"daily"})
  public void test006GetBlockByNum() {
    String data = "{\"num\":1}";
  String requestUrl = "protocol.WalletSolidity/GetBlockByNum";
  String returnString = PublicMethod.gRPCurlRequest(data, requestUrl, soliditynode);
  ...
  String returnStringPBFT = PublicMethod.gRPCurlRequest(data, requestUrl, pbftnode);
    Assert.assertEquals(returnStringPBFT, returnString);
  }

  @Test(enabled = true, description = "test GetAccountResource", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetBlockById", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetAccount ", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetBlockByLimitNext", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetTransactionListFromPending", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test ListNodes", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test CreateAccount2", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test AccountPermissionUpdate", groups = {"daily"})
  public void test014AccountPermissionUpdate() {
    ECKey newAccount = new ECKey(Utils.getRandom());
  String newAccountBase64 = Base64.getEncoder().encodeToString(newAccount.getAddress());
    PublicMethod.sendcoin(newAccount.getAddress(), 1000000000, foundationAddress, foundationKey, blockingStubFull);
  ...
  @Test(enabled = true, description = "test CancelAllUnfreezeV2", groups = {"daily"})
  public void test015CancelAllUnfreezeV2(){
    ECKey newAccount = new ECKey(Utils.getRandom());
  String newAccountKey = ByteArray.toHexString(newAccount.getPrivKeyBytes());
    PublicMethod.sendcoin(newAccount.getAddress(), 100000000, foundationAddress, foundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    PublicMethod.freezeBalanceV2(newAccount.getAddress(), 50000000, 1, newAccountKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(enabled = true, description = "test CreateAccount", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test CreateAssetIssue", groups = {"daily"})
  public void test017CreateAssetIssue(){
    ECKey newAccount = new ECKey(Utils.getRandom());
  String newAccountBase64 = Base64.getEncoder().encodeToString(newAccount.getAddress());
    PublicMethod.sendcoin(newAccount.getAddress(), 2000000000, foundationAddress, foundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(enabled = true, description = "test CreateAssetIssue2", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test CreateCommonTransaction", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test CreateWitness", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test CreateWitness2", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test DelegateResource", groups = {"daily"})
  ...
  String ownerAddressBase64 = Base64.getEncoder().encodeToString(foundationAddress);
    PublicMethod.sendcoin(newAccount.getAddress(), 100000000, foundationAddress, foundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    PublicMethod.freezeBalanceV2(newAccount.getAddress(), 50000000,
  ...
  @Test(enabled = true, description = "DeployContract", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test FreezeBalanceV2", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetAccountBalance", groups = {"daily"})
  public void test025GetAccountBalance() {
    String ownerAddressBase64 = Base64.getEncoder().encodeToString(foundationAddress);
    Protocol.Block block =  PublicMethod.getBlock(2L, blockingStubFull);
  ...
  @Test(enabled = true, description = "test GetAccountById", groups = {"daily"})
  public void test026GetAccountById() {
    ECKey newAccount = new ECKey(Utils.getRandom());
    PublicMethod.sendcoin(newAccount.getAddress(), 100000000, foundationAddress, foundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  String utf8AccountId = "grpcUrlTest";
    PublicMethod.setAccountId(utf8AccountId.getBytes(), newAccount.getAddress(),ByteArray.toHexString(newAccount.getPrivKeyBytes()), blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(enabled = true, description = "test GetAssetIssueByAccount", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetAssetIssueById", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetAssetIssueByName", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetAssetIssueList", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetAssetIssueListByName", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetAvailableUnfreezeCount", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetBandwidthPrices", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetBlock", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetBlockBalanceTrace", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetBlockByLatestNum", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetBrokerageInfo", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetBurnTrx", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetCanDelegatedMaxSize", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetCanWithdrawUnfreezeAmount", groups = {"daily"})
  public void test040GetCanWithdrawUnfreezeAmount() {
    Long sendAmount = 100000000L;
  ECKey newAccount = new ECKey(Utils.getRandom());
  String newAccountBase64 = Base64.getEncoder().encodeToString(newAccount.getAddress());
    PublicMethod.sendcoin(newAccount.getAddress(), sendAmount, foundationAddress, foundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    PublicMethod.freezeBalanceV2(newAccount.getAddress(), sendAmount/2,
        1, ByteArray.toHexString(newAccount.getPrivKeyBytes()),blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    PublicMethod.unFreezeBalanceV2(newAccount.getAddress(),ByteArray.toHexString(newAccount.getPrivKeyBytes()),
        sendAmount/4,
        1,
        blockingStubFull
        );
  ...
  String returnString2 = PublicMethod.gRPCurlRequest(data2, requestUrl2, fullnode);
  ...
  @Test(enabled = true, description = "test GetChainParameters", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test GetDelegatedResourceAccountIndexV2", groups = {"daily"})
  ...
  String receiverAccountBase64 = Base64.getEncoder().encodeToString(resourceReceiver.getAddress());
    PublicMethod.sendcoin(newAccount.getAddress(), sendAmount, foundationAddress, foundationKey, blockingStubFull);
    PublicMethod.sendcoin(resourceReceiver.getAddress(), sendAmount, foundationAddress, foundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    PublicMethod.freezeBalanceV2(newAccount.getAddress(), sendAmount/2,
        1, ByteArray.toHexString(newAccount.getPrivKeyBytes()),blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    PublicMethod.delegateResourceV2(newAccount.getAddress(),
        sendAmount/4,
        1,
  ...
  String returnString2 = PublicMethod.gRPCurlRequest(data2, requestUrl2, fullnode);
    ...
    returnStringSolidity = PublicMethod.gRPCurlRequest(data2, requestUrlSolidity, soliditynode);
    Assert.assertEquals(returnStringSolidity, returnString2);
    returnStringPBFT = PublicMethod.gRPCurlRequest(data2, requestUrlSolidity, pbftnode);
  ...
  String returnString3 = PublicMethod.gRPCurlRequest(data3, requestUrl3, fullnode);
  ...
  @Test(enabled = true, description = "test ParticipateAssetIssue", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test ParticipateAssetIssue2", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test TransferAsset", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test UnfreezeAsset", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test UnfreezeAsset2", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test UpdateAsset2", groups = {"daily"})
  ...
  @Test(enabled = true, description = "test UpdateAsset", groups = {"daily"})
