...
public class NewFeatureForSolc0817 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "using M for Type; is allowed at file level free function",
      groups = {"contract", "daily"})
  public void test003UseForFreeFunction() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    SmartContractOuterClass.SmartContract smartContract =
        PublicMethod.getContract(useForContract, blockingStubFull);
    Assert.assertNotNull(smartContract.getAbi());
  ...
  @Test(
      enabled = true,
      description = "using M for Type; is allowed at file level lib function",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "using M for Type; is allowed at file level with global",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test event.selector",
      groups = {"contract", "daily"})
  ...
  public void test008BugFixAbiEncodeCall() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    SmartContractOuterClass.SmartContract smartContract =
        PublicMethod.getContract(consCon, blockingStubFull);
    Assert.assertNotNull(smartContract.getAbi());
