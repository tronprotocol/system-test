...
public class ContractTrcToken005 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "TriggerContract with exception condition", groups = {"contract", "daily"})
  public void deployTransferTokenContract() {
    Assert.assertTrue(PublicMethod
        .sendcoin(dev001Address, 1100_000_000L, fromAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(PublicMethod
        .sendcoin(user001Address, 2000_000_000L, fromAddress, foundationKey, blockingStubFull));
  //    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress,
//        PublicMethod.getFreezeBalanceCount(dev001Address, dev001Key, 70000L, blockingStubFull), 0,
...
//    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  // not have this tokenId
    ...
    response = PublicMethod.triggerContractAndGetResponse(transferTokenContractAddress,
