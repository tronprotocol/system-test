...
@Slf4j
public class ContractTrcToken005 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "TriggerContract with exception condition",
  ...
  public void deployTransferTokenContract() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            user001Address, 2000_000_000L, fromAddress, foundationKey, blockingStubFull));
    ...
    // PublicMethod.randomFreezeAmount.getAndAdd(1), 0, 0,
    ...
    // blockingStubFull), 0,
    //        1, ByteString.copyFrom(user001Address), foundationKey, blockingStubFull));
    //    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    GrpcAPI.Return response =
        PublicMethod.triggerContractAndGetResponse(
    ...
    /*PublicMethod
        .sendcoin(transferTokenContractAddress,
            5000000,
            fromAddress,
            foundationKey,
            blockingStubFull);
