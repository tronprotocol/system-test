...
public class ContractGrammar001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Support function type",
  ...
  @Test(
      enabled = true,
      description = "Ordinary library contract",
      groups = {"contract", "daily"})
  ...
  public void test4Grammar004() {
    ...
    libraryAddress = library + Base58.encode58Check(contractAddress);
    contractAddress1 =
        PublicMethod.deployContractForLibrary(
            contractName1,
            abi1,
