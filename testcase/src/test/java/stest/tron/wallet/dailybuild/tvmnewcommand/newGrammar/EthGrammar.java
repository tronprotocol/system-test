...
public class EthGrammar extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    SmartContractOuterClass.SmartContract smartContract =
        PublicMethod.getContract(contractC, blockingStubFull);
    ...
    contractD =
        PublicMethod.deployContract(
            ...
            blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    smartContract = PublicMethod.getContract(contractD, blockingStubFull);
    Assert.assertNotNull(smartContract.getAbi());
  }

  @Test(
      enabled = true,
      description = "test get base fee value = commit.No 11 energy fee",
  ...
  @Test(
      enabled = true,
      description = "test get gas price value = commit.No 11 energy fee",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "get create2 address, test get base fee ",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "call can use 63/64 energy in new contract",
      groups = {"contract", "daily"})
  public void test04CallEnergy() {
    ...
    String argsStr =
        "\""
            + Base58.encode58Check(contractD)
            + "\","
            + "\""
  ...
  @Test(
      enabled = true,
      description = "create2 address call can use 63/64 energy in new contract",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "create2 address delegatecall " + "can use 63/64 energy in new contract",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "create2 address this.function " + "can use 63/64 energy in new contract",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test get Ripemd160 input is 123",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test get Ripemd160 input is empty",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test get Ripemd160 input length is greater than 256",
      groups = {"contract", "daily"})
  public void test10getRipemd160() {
    String args =
        "\"111111111111ddddddddddddd0x0000000000000000000000008b56a0602cc81fb0"
  ...
  @Test(
      enabled = true,
      description = "test get Ripemd160 input is string " + "and do not convert to bytes",
      groups = {"contract", "daily"})
  ...
  public void test13getBlak2f() {
    ...
    Assert.assertEquals(
        "SUCESS", transactionExtention.getTransaction().getRet(0).getRet().toString());
    Assert.assertEquals(
        "ba80a53f981c4d0d6a2797b69f12f6e94c212f14685ac"
  ...
  @Test(
      enabled = true,
      description =
          "when call create2, stack depth will be checked"
  ...
  @Test(
      enabled = true,
      description =
          "when call create, stack depth will be checked."
              + "if stack depth is greater than 64, then create command will revert"
              + "but run environment can not compute so much, so the actual result is time out",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "test max Energy Limit For trigger Constant contract",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description =
          "commit NO.47 value can be 1e17 if commit No.63 opened"
