...
@Slf4j
@MultiNode
public class TriggerConstant010 extends TronBaseTest {
  ...
  @Test(enabled = false, description = "TriggerContract a non-payable function without ABI", groups = {"contract", "daily"})
