...
@Slf4j
@MultiNode
public class batchValidateSignContract010 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Correct 50 signatures test multivalidatesign",
  ...
  @Test(
      enabled = true,
      description = "2 signatures with 1st incorrect signatures" + " test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "3 signatures with 1st incorrect address" + " test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "9 signatures with 7th incorrect signatures" + " test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "5 signatures with 2th-4th incorrect address" + " test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "150 signatures with 2nd/32nd incorrect signatures" + " test multivalidatesign",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description =
          "88 signatures with 9th/11th/28th/32nd incorrect address" + " test multivalidatesign",
      groups = {"contract", "daily"})
  public void test07IncorrectAddress() {
    ...
    addresses.set(27, WalletClient.encode58Check(new ECKey().getAddress()));
    addresses.set(31, WalletClient.encode58Check(new ECKey().getAddress()));
    List<Object> parameters = Arrays.asList("0x" + Hex.toHexString(hash), signatures, addresses);
    String input = PublicMethod.parametersString(parameters);
    TransactionExtention transactionExtention =
        PublicMethod.triggerConstantContractForExtention(
  ...
  @Test(
      enabled = true,
      description = "105 signatures with Incorrect hash test multivalidatesign",
      groups = {"contract", "daily"})
