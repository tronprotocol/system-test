...
public class batchValidateSignContract010 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Correct 50 signatures test multivalidatesign", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "105 signatures with Incorrect hash test multivalidatesign", groups = {"contract", "daily"})
