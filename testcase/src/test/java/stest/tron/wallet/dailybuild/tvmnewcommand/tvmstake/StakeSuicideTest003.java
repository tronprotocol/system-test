...
public class StakeSuicideTest003 extends TronBaseTest {
  ...
  public void beforeClass() {
    PublicMethod.sendcoin(
        testAddress001, 10000000, testFoundationAddress, testFoundationKey, blockingStubFull);
  }

  @Test(
      enabled = false,
      description = "suicide target Address is owner Address",
  ...
  @Test(
      enabled = false,
      description = "suicide target Address is BlackHoleAddress Address",
      groups = {"contract", "daily"})
  public void stakeSuicideTest002() {
    ...
    final Account accountBefore =
        PublicMethod.queryAccount(PublicMethod.decode58Check(blackHoleAddress), blockingStubFull);
    String methedStr = "SelfdestructTest(address)";
    ...
    Account accountAfter =
        PublicMethod.queryAccount(PublicMethod.decode58Check(blackHoleAddress), blockingStubFull);
    Assert.assertEquals(
        accountBefore.getBalance() + ex.get().getReceipt().getEnergyFee() + 10000000,
  ...
  public void stakeSuicideTest003() {
    ...
    final Account accountBefore =
        PublicMethod.queryAccount(
            PublicMethod.decode58Check("T9yD14Nj9j7xAB4dbGeiX9h8unkKHxuWwb"), blockingStubFull);
    String methedStr = "SelfdestructTest(address)";
