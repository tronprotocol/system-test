...
public class ChainidAndSelfBalance001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "chainId should be block zero`s Hash",
  ...
  @Test(
      enabled = true,
      description = "selfBalance of addres(this).balance",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "selfBalance of contractAddress",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "selfBalance of normal Address",
      groups = {"contract", "daily"})
  public void getBalanceTest003() {
    ...
    TransactionExtention returns =
        PublicMethod.triggerConstantContractForExtention(
            ...
            blockingStubFull);
    Long getBalance = ByteArray.toLong(returns.getConstantResult(0).toByteArray());
    Long accountBalance = PublicMethod.queryAccount(testAddress002, blockingStubFull).getBalance();
  ...
  @Test(
      enabled = true,
      description = "selfBalance of unActive Address",
      groups = {"contract", "daily"})
