...
@Slf4j
@MultiNode
public class batchValidateSignContract012 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Trigger precompile multivalisign function with correct data", groups = {"contract", "daily"})
  ...
  String method = "testArray2(bytes)";
    txid = PublicMethod.triggerContractBoth(contractAddress, method,
  ...
  @Test(enabled = true, description = "Trigger precompile multivalidatesign function with incor"
      + "rect data", groups = {"contract", "daily"})
