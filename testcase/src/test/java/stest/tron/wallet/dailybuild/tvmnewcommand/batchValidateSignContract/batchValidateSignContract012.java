...
public class batchValidateSignContract012 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Trigger precompile multivalisign function with correct data",
  ...
  public void test01TriggerPrecompileMultivalisignWithCorrectData() {
    ...
    txid =
        PublicMethod.triggerContractBoth(
            contractAddress,
            method,
            AbiUtil.parseParameters(method, Arrays.asList(input)),
            true,
            0,
            maxFeeLimit,
            contractExcAddress,
  ...
  @Test(
      enabled = true,
      description = "Trigger precompile multivalidatesign function with incor" + "rect data",
      groups = {"contract", "daily"})
