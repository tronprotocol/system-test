...
public class TriggerConstant014 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "TriggerContract a non-constant function created by create2",
  ...
  @Test(
      enabled = true,
      description =
          "TriggerConstantContract a non-constant function " + "created by create2 on solidity",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description =
          "TriggerConstantContract a non-constant function "
