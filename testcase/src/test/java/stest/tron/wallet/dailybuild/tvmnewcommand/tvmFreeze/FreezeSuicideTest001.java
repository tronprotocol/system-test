...
public class FreezeSuicideTest001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "when delegate freeze, cannot suicide",
  ...
  @Test(
      enabled = true,
      description = "when delegate freeze to self, then suicide",
      groups = {"contract", "daily"})
  public void FreezeSuicideTest002() {
    ...
    freezeAccount_after = PublicMethod.getAccountResource(testAddress002, blockingStubFull);
