...
@Slf4j
@MultiNode
public class MultiSign14 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Witness threshold is exception condition",
  ...
  public void testWitnessThreshold01() {
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "Contract validate error : sum of all key's weight should not be"
  ...
  @Test(
      enabled = true,
      description = "Witness threshold is 1",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Witness threshold is more than sum of weight",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Witness threshold is Long.MAX_VALUE",
      groups = {"daily", "multisig"})
