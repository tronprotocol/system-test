...
public class VerifyBurnProof001 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "data length != 512", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "value greate than Long.MAX_VALUE", groups = {"contract", "daily"})
