...
@Slf4j
public class VerifyBurnProof001 extends TronBaseTest {
  ...
  public void beforeClass() {
    PublicMethod.printAddress(testPriKey001);
    Assert.assertTrue(
        PublicMethod.sendcoin(
            testAddress001, 1000_000_000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  }

  @Test(
      enabled = true,
      description = "Deploy VerfyMintProof contract ",
  ...
  @Test(
      enabled = true,
      description = "value greate than Long.MAX_VALUE",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "verify success with address call",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "verify success with fuction call",
      groups = {"contract", "daily"})
