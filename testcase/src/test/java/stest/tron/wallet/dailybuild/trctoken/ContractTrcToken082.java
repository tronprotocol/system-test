...
public class ContractTrcToken082 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "deploy contract and generate create2 address",
  ...
  public void test01DeployContract() {
    ...
    //    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress, 100000_000_000L, 0,
    // 0,
    ...
    Long contractAssetCount =
        PublicMethod.getAssetIssueValue(contractD, assetAccountId, blockingStubFull);
    logger.info(
    ...
    Assert.assertEquals(0, info.get().getResultValue());
    Long create2Count =
        PublicMethod.getAssetIssueValue(create2Address, assetAccountId, blockingStubFull);
  ...
  public void test02KillCreate2Kill() throws Exception {
    ...
    logger.info(
        "test02KillCreate2Kill create2Address: "
            + PublicMethod.getContract(create2Address, blockingStubFull).toString());
    Thread.sleep(30);
    String txid3 =
        PublicMethod.triggerContract(
            create2Address,
    ...
    Long create2AssetCount =
        PublicMethod.getAssetIssueValue(receiveAdderss, assetAccountId, blockingStubFull);
