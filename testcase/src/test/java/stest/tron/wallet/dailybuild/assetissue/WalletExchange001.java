...
public class WalletExchange001 extends TronBaseTest {
  ...
  @Test(
      enabled = false,
      description = "Create two asset issue to create exchange",
      groups = {"daily"})
  public void test1CreateUsedAsset() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            exchange001Address, 10240000000L, foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.sendcoin(
            secondExchange001Address, 10240000000L, toAddress, testKey003, blockingStubFull));
  ...
  @Test(
      enabled = false,
      description = "Test create exchange",
      groups = {"daily"})
  ...
  @Test(
      enabled = false,
      description = "Test list exchange api",
      groups = {"daily"})
  ...
  @Test(
      enabled = false,
      description = "Test inject exchange",
      groups = {"daily"})
  ...
  @Test(
      enabled = false,
      description = "Test withdraw exchange",
      groups = {"daily"})
  ...
  public void test6TransactionExchange() {
    ...
    Assert.assertTrue(
        PublicMethod.exchangeTransaction(
            exchangeId,
            assetAccountId1.toByteArray(),
            transactionNum,
            1,
  ...
  @Test(
      enabled = false,
      description = "Test GetExchangeListPaginated api",
      groups = {"daily"})
  ...
  @Test(
      enabled = false,
      description = "Test get exchange list from pbft",
      groups = {"daily"})
  ...
  @Test(
      enabled = false,
      description = "Test get exchange by id from pbft",
      groups = {"daily"})
  public void test9GetExchangeByIdFromPbft() {
    Assert.assertEquals(
        PublicMethod.getExchange(exchangeId.toString(), blockingStubPbft),
