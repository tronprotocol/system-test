...
@Slf4j
public class WalletExchange001 extends TronBaseTest {
  ...
  @Test(enabled = false,description = "Create two asset issue to create exchange", groups = {"daily"})
  public void test1CreateUsedAsset() {
    ...
    Assert.assertTrue(PublicMethod.sendcoin(secondExchange001Address, 10240000000L, toAddress,
  ...
  @Test(enabled = false,description = "Test create exchange", groups = {"daily"})
  ...
  //CreateExchange
    Assert.assertTrue(
        PublicMethod.exchangeCreate(assetAccountId1.toByteArray(), firstTokenInitialBalance,
  ...
  @Test(enabled = false,description = "Test list exchange api", groups = {"daily"})
  ...
  @Test(enabled = false,description = "Test inject exchange", groups = {"daily"})
  ...
  Long beforeToken2Balance = 0L;
    ...
    Assert.assertTrue(
        PublicMethod.injectExchange(exchangeId, assetAccountId1.toByteArray(), injectBalance,
  ...
  @Test(enabled = false,description = "Test withdraw exchange", groups = {"daily"})
  ...
  Long beforeToken2Balance = 0L;
    ...
    Assert.assertTrue(
        PublicMethod.exchangeWithdraw(exchangeId, assetAccountId1.toByteArray(), withdrawNum,
            exchange001Address, exchange001Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    firstAccount = PublicMethod.queryAccount(exchange001Address, blockingStubFull);
  Long afterToken1Balance = 0L;
  ...
  @Test(enabled = false,description = "Test exchange transaction", groups = {"daily"})
  ...
  @Test(enabled = false,description = "Test GetExchangeListPaginated api", groups = {"daily"})
   ...
   * constructor.
   */
  @Test(enabled = false,description = "Test get exchange list from pbft", groups = {"daily"})
  public void test8GetExchangeListFromPbft() {
    //Pbft support listexchange
    listExchange = PublicMethod.getExchangeList(blockingStubPbft);
    Assert.assertTrue(listExchange.get().getExchangesCount() > 0);
  }
   ...
   * constructor.
   */
  @Test(enabled = false,description = "Test get exchange by id from pbft", groups = {"daily"})
  public void test9GetExchangeByIdFromPbft() {
    Assert.assertEquals(PublicMethod.getExchange(exchangeId.toString(), blockingStubPbft),
        PublicMethod.getExchange(exchangeId.toString(), blockingStubSolidity));
  }
