...
@Slf4j
@MultiNode
public class ShiftCommand002 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "OLd compiler compile shift instruction",
  ...
  public void test1Oldcompile() {
    ...
    String code =
        "608060405234801561001057600080fd5b50d3801561001d57600080fd5b50d2801561002a5"
    ...
    String abi =
        "[{\"constant\":false,\"inputs\":[{\"name\":\"num\",\"type\":\"uint256\"},"
  ...
  @Test(
      enabled = true,
      description = "New compiler compile shift instruction",
      groups = {"contract", "daily"})
