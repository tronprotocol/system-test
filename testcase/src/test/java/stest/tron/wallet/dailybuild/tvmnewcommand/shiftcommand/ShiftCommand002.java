...
public class ShiftCommand002 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "OLd compiler compile shift instruction", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "New compiler compile shift instruction", groups = {"contract", "daily"})
