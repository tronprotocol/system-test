...
public class FunctionArray2Storage086 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "function array test view to default",
  ...
  public void test01View2Default() {
    ...
    Assert.assertEquals(
        22,
        ByteArray.toInt(
            transactionInfo.get().getContractResult(0).substring(32, 64).toByteArray()));
  }

  @Test(
      enabled = true,
      description = "function array pure to default",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "function array pure to view ",
      groups = {"contract", "daily"})
