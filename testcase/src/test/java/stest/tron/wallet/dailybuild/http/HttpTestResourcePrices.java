...
public class HttpTestResourcePrices {
  ...
  @Test(
      enabled = true,
      description = "get Energy prices from http interface",
      groups = {"daily", "serial"})
  public void test02GetEnergyPrices() {
    // get EnergyPrice from chainParameters
    Long energyPriceChainParameter =
        HttpMethod.getProposalValue(httpnode, ProposalEnum.GetEnergyFee.getProposalName());
    ...
    String pricesSolidityPort =
        HttpMethod.parseResponseContent(resSolidityport).getString("prices");
  ...
  @Test(
      enabled = true,
      description = "get Bandwidth prices from http interface",
      groups = {"daily", "serial"})
  public void test02GetBandwidthPrices() {
    // get Bandwidth prices from chainParameters
    Long BandwidthPriceChainParameter =
        HttpMethod.getProposalValue(httpnode, ProposalEnum.getTransactionFee.getProposalName());
