...
public class ContractTestSendCoin001 extends TronBaseTest {
  ...
  public void testSendCoinAndTransferAssetContract001() {
    ...
    Assert.assertTrue(
        PublicMethod.freezeBalanceForReceiver(
            fromAddress,
            PublicMethod.getFreezeBalanceCount(dev001Address, dev001Key, 130000L, blockingStubFull),
            0,
            1,
    ...
    Optional<TransactionInfo> infoById =
        PublicMethod.getTransactionInfoById(deployContractTxid, blockingStubFull);
    ...
    Return ret =
        PublicMethod.transferAssetForReturn(
    ...
    Return ret1 =
        PublicMethod.sendcoinForReturn(
            transferTokenContractAddress, 1_000_000L, fromAddress, foundationKey, blockingStubFull);
  ...
  public void testSendCoinAndTransferAssetContract002() {
    ...
    Assert.assertEquals(
        ...
        ret.getMessage().toStringUtf8());
    Long contractAssetCount =
        PublicMethod.getAssetIssueValue(testContractAddress, assetAccountId, blockingStubFull);
    logger.info(
        "Contract has AssetId: "
            + assetAccountId.toStringUtf8()
            + ", Count: "
    ...
    Return ret1 =
        PublicMethod.sendcoinForReturn(
            testContractAddress, 1_000_000L, fromAddress, foundationKey, blockingStubFull);
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, ret1.getCode());
    Assert.assertEquals(
        "Contract validate error : Cannot transfer TRX to a smartContract.",
        ret1.getMessage().toStringUtf8());
    ...
    long contractAssetCountBefore =
        PublicMethod.getAssetIssueValue(testContractAddress, assetAccountId, blockingStubFull);
    long contractBefore =
        PublicMethod.queryAccount(testContractAddress, blockingStubFull).getBalance();
  ...
  public void testSendCoinAndTransferAssetContract003() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            contractExcAddress, 2000000000L, fromAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    if (PublicMethod.allowTvmSelfdestructRestrictionIsActive(blockingStubFull)) {
      ...
      Assert.assertFalse(
          PublicMethod.sendcoin(
              returnAddressBytes, 1_000_000L, fromAddress, foundationKey, blockingStubFull));
      txid =
          PublicMethod.triggerContract(
              contractAddress,
              "deploy(bytes,uint256)",
