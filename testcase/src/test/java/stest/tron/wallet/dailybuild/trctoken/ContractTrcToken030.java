...
public class ContractTrcToken030 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Deploy suicide contract",
  ...
  public void deploy01TransferTokenContract() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            user001Address, 4048000000L, foundationAddress, foundationKey, blockingStubFull));
  ...
  @Test(
      enabled = true,
      description = "Trigger suicide contract,toaddress is other",
      groups = {"contract", "daily"})
