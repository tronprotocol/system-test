...
public class MarketSellAsset005 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            testAddress001, 2024_000000L, foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.sendcoin(
            testAddress002, 2024_000000L, foundationAddress, foundationKey, blockingStubFull));
  ...
  @Test(
      enabled = false,
      description = "Create an order to sell Trx and buy Trc10",
      groups = {"daily"})
  void test01SellTrxBuyTrc10() {
    ...
    PublicMethod.transferAsset(
        testAddress002, assetAccountId001, 10000, testAddress001, testKey001, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    final Map<String, Long> beforeAsset001 =
  ...
  @Test(
      enabled = false,
      description = "Create an order to sell Trc10 and buy Trx",
      groups = {"daily"})
