...
public class UnStakeTest001 extends TronBaseTest {
  ...
  @Test(
      enabled = false,
      description = "unstake normal",
      groups = {"contract", "daily"})
  public void tvmStakeTest001Normal() {
    PublicMethod.sendcoin(
        testAddress001, 1120_000_000L, testFoundationAddress, testFoundationKey, blockingStubFull);
  ...
  @Test(
      enabled = false,
      description = "unstake when no stake",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "unstake call another contract in one contract",
      groups = {"contract", "daily"})
  public void tvmUnstakeTest005CallAnotherInOneContract() {
    PublicMethod.sendcoin(
        testAddress001, 2120_000_000L, testFoundationAddress, testFoundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    String filePath = "./src/test/resources/soliditycode/unStake001.sol";
    String contractName = "unStakeTest";
    HashMap retMap = PublicMethod.getBycodeAbi(filePath, contractName);
    ...
    long contractAddressBBalance =
        PublicMethod.queryAccount(contractAddressB, blockingStubFull).getBalance();
  ...
  @Test(
      enabled = false,
      description = "unstake with reward balance",
      groups = {"contract", "daily"})
  public void tvmUnstakeTest006WithRewardBalance() {
    ...
    org.junit.Assert.assertEquals(
        0, ByteArray.toLong(ByteArray.fromHexString(Hex.toHexString(result))));
