...
@Slf4j
@MultiNode
public class ContractTrcToken054 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Trigger transferToken with 0 tokenValue",
  ...
  public void testTriggerTransferTokenContract() {
    ...
    logger.info(
        "the value: " + PublicMethod.getStrings(infoById.get().getContractResult(0).toByteArray()));
