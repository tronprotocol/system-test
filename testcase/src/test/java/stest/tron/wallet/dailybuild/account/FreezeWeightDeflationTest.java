...
public class FreezeWeightDeflationTest extends TronBaseTest {
  ...
  public void beforeClass() throws Exception {
    ...
    Assert.assertTrue(
        PublicMethod.freezeBalanceV1ForReceiver(
            foundationAddress,
            frozenAmount * 8,
            0,
            0,
  ...
  public void test01FreezeNetCauseWeightDeflationTest() {
    final Long beforeNetWeight =
        PublicMethod.getAccountResource(frozen1Address, blockingStubFull).getTotalNetWeight();
    final Long beforeEnergyWeight =
        PublicMethod.getAccountResource(frozen1Address, blockingStubFull).getTotalEnergyWeight();
  ...
  public void test02FreezeEnergyCauseWeightDeflationTest() {
    ...
    Assert.assertTrue(
        PublicMethod.unFreezeBalance(frozen1Address, frozen1Key, 1, null, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    afterEnergyWeight =
        PublicMethod.getAccountResource(frozen1Address, blockingStubFull).getTotalEnergyWeight();
    Assert.assertTrue(afterEnergyWeight - beforeEnergyWeight == 0);
  ...
  @Test(
      enabled = true,
      description = "Delegate energy to two receiver cause weight deflation test",
      groups = {"daily"})
