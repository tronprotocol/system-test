...
public class fallbackReceive extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "contract test0 has no fallback method",
  ...
  @Test(
      enabled = true,
      description = "contract test01 has fallback method",
      groups = {"contract", "daily"})
  public void test011Fallback() {
    ...
    if (!Objects.isNull(logList)) {
      for (Protocol.TransactionInfo.Log log : logList) {
        ...
        Assert.assertEquals(
            "fallback", PublicMethod.getContractStringMsg(log.getData().toByteArray()));
      }
    }
  }
  ...
  @Test(
      enabled = true,
      description = "contract test02 has fallback payable method",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "contract TestPayable has fallback and receive",
      groups = {"contract", "daily"})
  ...
  public void test05FallbackReceive() {
    ...
    Protocol.Account infoafter =
        PublicMethod.queryAccount(contractAddressTestPayable, blockingStubFull);
    GrpcAPI.AccountResourceMessage resourceInfoafter =
        PublicMethod.getAccountResource(contractAddressTestPayable, blockingStubFull);
    Long afterBalance = infoafter.getBalance();
  ...
  public void shutdown() throws InterruptedException {
    ...
    PublicMethod.freeResource(
        contractAddressTest1, contractExcKey, testNetAccountAddress, blockingStubFull);
    PublicMethod.freeResource(
        contractAddressTest2, contractExcKey, testNetAccountAddress, blockingStubFull);
    PublicMethod.freeResource(
        contractAddressTestPayable, contractExcKey, testNetAccountAddress, blockingStubFull);
    PublicMethod.freeResource(
        contractAddressCaller, contractExcKey, testNetAccountAddress, blockingStubFull);
