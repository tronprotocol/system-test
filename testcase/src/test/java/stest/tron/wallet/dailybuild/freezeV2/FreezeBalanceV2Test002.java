...
@Slf4j
public class FreezeBalanceV2Test002 extends TronBaseTest {
  ...
  public void beforeClass() throws Exception {
    ...
    PublicMethod.printAddress(frozenEnergyKey);
    PublicMethod.printAddress(receiveBandwidthKey);
    PublicMethod.printAddress(receiveBandwidthKey);
    PublicMethod.printAddress(delegateFromKey);    if (!PublicMethod.freezeV2ProposalIsOpen(blockingStubFull)) {      throw new SkipException("Skipping freezeV2 test case");
    }
    ...
    Assert.assertTrue(PublicMethod.sendcoin(frozenEnergyAddress, sendAmount,
        foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(PublicMethod.sendcoin(receiveBandwidthAddress, 1L,
        foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(PublicMethod.sendcoin(receiveEnergyAddress, 1L,
        foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(PublicMethod.sendcoin(delegateFromAddress, sendAmount,
        foundationAddress, foundationKey, blockingStubFull));
    ...
    Assert.assertTrue(PublicMethod.freezeBalanceV2(frozenEnergyAddress, freezeEnergyBalance,
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Delegate resource of bandwidth", groups = {"daily", "staking"})
  ...
  String txId = PublicMethod.delegateResourceV2AndGetTxId(frozenBandwidthAddress,
        delegateBandwidthAmount, 0, receiveBandwidthAddress, frozenBandwidthKey, blockingStubFull);
    Assert.assertNotNull(txId);
    PublicMethod.waitProduceNextBlock(blockingStubFull);


    Transaction transaction = PublicMethod.getTransactionById(txId, blockingStubFull).get();
    ...
    account = PublicMethod.queryAccount(frozenBandwidthAddress,
        blockingStubFull);
  ...
  final Long afterReceiverNetLimit = accountResource.getNetLimit();
    ...
    account = PublicMethod.queryAccount(receiveBandwidthAddress, blockingStubFull);
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Undelegate resource of bandwidth", groups = {"daily", "staking"})
  ...
  String txId = PublicMethod.unDelegateResourceV2AndGetTxId(frozenBandwidthAddress,
        delegateBandwidthAmount, 0, receiveBandwidthAddress, frozenBandwidthKey, blockingStubFull);
    Assert.assertNotNull(txId);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
   ...
   * constructor.
   */
  @Test(enabled = true, description = "Test GetCanDelegatedMaxSize api", groups = {"daily", "staking"})
  public void test03TestGetCanDelegatedMaxSizeApi() throws Exception {
    Long canDelegatedMaxSizeWithNoNetUsed = PublicMethod
  ...
  Long canDelegatedMaxSizeWithNoNetUsedSolidity =  PublicMethod
  ...
  Long canDelegatedMaxSizeWithNoNetUsedPbft =  PublicMethod
  ...
  int retryTimes = 0;
    while (PublicMethod.getCanDelegatedMaxSize(frozenBandwidthAddress, 0, blockingStubFull).get()
        .getMaxSize() + 1100000 > canDelegatedMaxSizeWithNoNetUsed && retryTimes++ <= 5000) {
      logger.info(
          "Current" + PublicMethod
              .getCanDelegatedMaxSize(frozenBandwidthAddress, 0, blockingStubFull)
              .get()
              .getMaxSize()
      );
      PublicMethod.sendcoinGetTransactionIdForConstructData(foundationAddress,
          1L, frozenBandwidthAddress, frozenBandwidthKey, blockingStubFull);
      Thread.sleep(10L);
    }

    PublicMethod.waitProduceNextBlock(blockingStubFull);
  Long canDelegatedMaxSizeWithNetUsed =  PublicMethod.getCanDelegatedMaxSize(
    ...
    Assert.assertTrue(PublicMethod.delegateResourceV2(
        frozenBandwidthAddress,
  ...
  //query solidity
    PublicMethod.waitSolidityNodeSynFullNodeData(blockingStubFull, blockingStubFullSolidity);
  Long canDelegatedMaxSizeWithNetUsedSolidity =  PublicMethod.getCanDelegatedMaxSizeSolidity(
  ...
  //query pbft
    PublicMethod.waitSolidityNodeSynFullNodeData(blockingStubFull, blockingStubPbft);
  Long canDelegatedMaxSizeWithNetUsedPbft =  PublicMethod.getCanDelegatedMaxSizeSolidity(
    ...
    Assert.assertTrue(PublicMethod.freezeBalanceV2(delegateFromAddress,
        freezeBandwidthBalance, 0, delegateFromKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(PublicMethod.delegateResourceV2(delegateFromAddress,
        PublicMethod.getCanDelegatedMaxSize(delegateFromAddress, 0, blockingStubFull)
            .get()
            .getMaxSize(),
        0,
        frozenBandwidthAddress,
        ...
        blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  Long canDelegatedMaxSizeWithOtherDelegatedToMe =  PublicMethod.getCanDelegatedMaxSize(
        frozenBandwidthAddress, 0, blockingStubFull)
        .get()
        .getMaxSize();
