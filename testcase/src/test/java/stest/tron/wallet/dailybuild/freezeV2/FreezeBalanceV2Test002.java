...
public class FreezeBalanceV2Test002 extends TronBaseTest {
  ...
  public void beforeClass() throws Exception {
    ...
    PublicMethod.printAddress(receiveBandwidthKey);
    PublicMethod.printAddress(delegateFromKey);
  ...
  @Test(
      enabled = true,
      description = "Delegate resource of bandwidth",
  ...
  public void test01DelegateResourceOfBandwidth() throws Exception {
    ...
    AccountResourceMessage accountResource =
        PublicMethod.getAccountResource(frozenBandwidthAddress, blockingStubFull);
    ...
    accountResource = PublicMethod.getAccountResource(receiveBandwidthAddress, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "Undelegate resource of bandwidth",
      groups = {"daily", "staking"})
  ...
  @Test(
      enabled = true,
      description = "Test GetCanDelegatedMaxSize api",
      groups = {"daily", "staking"})
  public void test03TestGetCanDelegatedMaxSizeApi() throws Exception {
    Long canDelegatedMaxSizeWithNoNetUsed =
        PublicMethod.getCanDelegatedMaxSize(frozenBandwidthAddress, 0, blockingStubFull)
            .get()
            .getMaxSize();
    ...
    Long canDelegatedMaxSizeWithNoNetUsedSolidity =
        PublicMethod.getCanDelegatedMaxSizeSolidity(
    ...
    Long canDelegatedMaxSizeWithNoNetUsedPbft =
        PublicMethod.getCanDelegatedMaxSizeSolidity(frozenBandwidthAddress, 0, blockingStubPbft)
            .get()
            .getMaxSize();
    logger.info("canDelegatedMaxSizeWithNoNetUsedPbft" + canDelegatedMaxSizeWithNoNetUsedPbft);
    int retryTimes = 0;
    while (PublicMethod.getCanDelegatedMaxSize(frozenBandwidthAddress, 0, blockingStubFull)
                    .get()
                    .getMaxSize()
                + 1100000
