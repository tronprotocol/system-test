...
@Slf4j
public class MultiSign22 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Sign permission transaction by owner permission",
  ...
  @Test(
      enabled = true,
      description = "Sign normal transaction by owner permission",
      groups = {"daily", "multisig"})
  public void test02SignByOwnerKeyForNormal() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, needCoin + 1_000000, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Long balanceBefore = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceBefore: " + balanceBefore);
    List<String> ownerPermissionKeys = new ArrayList<>();
  ...
  @Test(
      enabled = true,
      description = "Sign normal transaction by active permission",
      groups = {"daily", "multisig"})
  public void test03SignByActiveKey() {
    ...
    String accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"owner\",\"threshold\":1,\"keys\":["
            ...
            + "\",\"weight\":1},"
            + "{\"address\":\""
            + PublicMethod.getAddressString(normalKey001)
            + "\",\"weight\":1}"
            + "]}]}";
  ...
  @Test(
      enabled = true,
      description = "Sign permission transaction by active permission",
      groups = {"daily", "multisig"})
  ...
  public void test06SignByOtherKey() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, 1000000, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    // PublicMethod.waitProduceNextBlock(blockingStubFull);
    Long balanceBefore = PublicMethod.queryAccount(ownerAddress, blockingStubFull).getBalance();
    logger.info("balanceBefore: " + balanceBefore);
    ...
    GrpcAPI.Return response =
        PublicMethodForMultiSign.accountPermissionUpdateForResponse(
            accountPermissionJson,
            ownerAddress,
            ownerKey,
            blockingStubFull,
  ...
  @Test(
      enabled = true,
      description = "Sign permission transaction " + "by empty permission list",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Sign permission transaction by empty address",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Sign permission transaction by invalid address",
      groups = {"daily", "multisig"})
  ...
  @Test(
      enabled = true,
      description = "Set same permission",
      groups = {"daily", "multisig"})
