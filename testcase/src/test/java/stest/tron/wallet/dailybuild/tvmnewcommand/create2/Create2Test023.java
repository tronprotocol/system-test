...
@Slf4j
@MultiNode
public class Create2Test023 extends TronBaseTest {
  ...
  public void test01DeployFactoryContract() {
    ...
    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress,
        PublicMethod.getFreezeBalanceCount(dev001Address, dev001Key, 170000L * 2,
  ...
  @Test(enabled = true, description = "contract A new B contract,A suicide,contract B still exist", groups = {"contract", "daily"})
  public void test02TriggerTestContract() {

    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress,
        PublicMethod.getFreezeBalanceCount(user001Address, user001Key, 50000 * 5L,
            blockingStubFull), 0, 1,
  ...
  //B Address is created by A, Trigger contract B
    triggerTxid = PublicMethod.triggerContract(ByteArray.fromHexString(exceptedResult),
