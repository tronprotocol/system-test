...
public class ContractRewardTest001 extends TronBaseTest {
  ...
  @Test(
      enabled = false,
      description = "querry SR account, reward should equal to gerRewardInfo",
      groups = {"contract", "daily"})
  void rewardbalanceTest001() {
    BytesMessage bytesMessage =
        BytesMessage.newBuilder()
            .setValue(ByteString.copyFrom(PublicMethod.getFinalAddress(witnessKey)))
            .build();
  ...
  @Test(
      enabled = false,
      description = "querry 0x00, reward should be 0",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "querry UnActive account , reward should be 0",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "querry ZeroReward account, reward should be 0",
      groups = {"contract", "daily"})
  void rewardbalanceTest005() {
    BytesMessage bytesMessage =
        BytesMessage.newBuilder()
            .setValue(ByteString.copyFrom(PublicMethod.getFinalAddress(testFoundationKey)))
            .build();
    long reward = blockingStubFull.getRewardInfo(bytesMessage).getNum();
    String methedStr = "rewardBalance(address)";
  ...
  @Test(
      enabled = false,
      description = "withdrawBalance twice",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "withdrawBalance other contract",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "new withdrawBalance constructor",
      groups = {"contract", "daily"})
