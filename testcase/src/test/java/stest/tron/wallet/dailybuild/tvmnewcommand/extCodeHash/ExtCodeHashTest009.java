...
@Slf4j
@MultiNode
public class ExtCodeHashTest009 extends TronBaseTest {
  ...
  public void test01DeployExtCodeHashContract() {
    ...
    Assert.assertTrue(
        PublicMethod.freezeBalanceForReceiver(
            fromAddress,
            PublicMethod.getFreezeBalanceCount(dev001Address, dev001Key, 180000L, blockingStubFull),
            0,
            1,
  ...
  @Test(
      enabled = true,
      description = "Get code hash of create2 empty contract",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Trigger create2 function to deploy test contract",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "Get code hash of test contract",
      groups = {"contract", "daily"})
