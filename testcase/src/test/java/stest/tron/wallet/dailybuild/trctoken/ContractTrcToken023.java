...
public class ContractTrcToken023 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "deploy contract for transfer token",
  ...
  public void deploy01TransferTokenContract() {
    ...
    btestAddress =
        PublicMethod.deployContract(
            ...
            blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    /*Assert.assertFalse(PublicMethod.sendcoin(
        transferTokenContractAddress, 1000000000L,
        foundationAddress, foundationKey, blockingStubFull));
    Assert.assertFalse(PublicMethod.sendcoin(
        btestAddress, 1000000000L, foundationAddress,
  ...
  @Test(
      enabled = true,
      description = "transfer token which from address does not have",
      groups = {"contract", "daily"})
