...
public class HttpTestAccount002 {
  ...
  @Test(
      enabled = true,
      description = "FreezeBalance for bandwidth by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "UnFreezeBalance for bandwidth by http",
      groups = {"daily", "serial"})
  public void test002UnFreezeBalanceForBandwidth() {
    berforeBalance = HttpMethod.getBalance(httpnode, freezeBalanceAddress);

    // UnFreeze balance for bandwidth
    if (HttpMethod.getProposalValue(httpnode, ProposalEnum.GetUnfreezeDelayDays.getProposalName())
        > 0) {
      response =
  ...
  @Test(
      enabled = true,
      description = "FreezeBalance for energy by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "UnFreezeBalance for energy by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "FreezeBalance with bandwidth for others by http",
      groups = {"daily", "serial"})
  public void test005FreezeBalanceOfBandwidthForOthers() {
    response =
        HttpMethod.sendCoin(httpnode, fromAddress, receiverResourceAddress, amount, testKey002);
    Assert.assertTrue(HttpMethod.verificationResult(response));
    HttpMethod.waitToProduceOneBlock(httpnode);
    berforeBalance = HttpMethod.getBalance(httpnode, freezeBalanceAddress);
  ...
  @Test(
      enabled = true,
      description = "Get Delegated Resource by http",
      groups = {"daily", "serial"})
  public void test006GetDelegatedResource() {
    ...
    response =
        HttpMethod.getDelegatedResource(httpnode, freezeBalanceAddress, receiverResourceAddress);
  ...
  @Test(
      enabled = true,
      description = "Get Delegated Resource from solidity by http",
      groups = {"daily", "serial"})
  public void test007GetDelegatedResourceFromSolidity() {
    ...
    response =
        HttpMethod.getDelegatedResourceFromSolidity(
  ...
  @Test(
      enabled = true,
      description = "Get Delegated Resource from PBFT by http",
      groups = {"daily", "serial"})
  public void test008GetDelegatedResourceFromPbft() {
    ...
    HttpMethod.waitToProduceOneBlockFromPbft(httpnode, httpPbftNode);
    response =
        HttpMethod.getDelegatedResourceFromPbft(
  ...
  @Test(
      enabled = true,
      description = "Get Delegated Resource Account Index by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Get Delegated Resource Account Index from solidity by http",
      groups = {"daily", "serial"})
  public void test010GetDelegatedResourceAccountIndexFromSolidity() {
    ...
    response =
        HttpMethod.getDelegatedResourceAccountIndexFromSolidity(
  ...
  @Test(
      enabled = true,
      description = "Get Delegated Resource Account Index from PBFT by http",
      groups = {"daily", "serial"})
  public void test011GetDelegatedResourceAccountIndexFromPbft() {
    ...
    response =
        HttpMethod.getDelegatedResourceAccountIndexFromPbft(httpPbftNode, freezeBalanceAddress);
    responseContent = HttpMethod.parseResponseContent(response);
    HttpMethod.printJsonContent(responseContent);
    Assert.assertFalse(responseContent.get("toAccounts").toString().isEmpty());
    String toAddress = responseContent.getJSONArray("toAccounts").get(0).toString();
  ...
  @Test(
      enabled = true,
      description = "UnFreezeBalance with bandwidth for others by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "FreezeBalance with energy for others by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "UnFreezeBalance with energy for others by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "FreezeBalance for tron power by http",
      groups = {"daily", "serial"})
  public void test015FreezeTronPower() {
    if (HttpMethod.proposalFreezeV2IsOpen(httpnode)) {
      throw new SkipException("Skipping this freezeV1 test case");
    }
    if (HttpMethod.getProposalValue(
  ...
  @Test(
      enabled = true,
      description = "UnFreezeBalance for tron power by http",
      groups = {"daily", "serial"})
