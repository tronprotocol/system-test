...
@MultiNode
public class ContractInternalTransaction003 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "Three-level nesting.Type is Create call->call->create", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, description = "Test delegatecall and callcode.", groups = {"contract", "daily"})
  ...
  String txid3 = "";
    txid3 = PublicMethod.triggerContract(contractAddress,
  ...
  @Test(enabled = true, description = "Three-level nesting.Type "
      + "is create call->call->create call->suicide", groups = {"contract", "daily"})
  ...
  @Test(enabled = false, description = "After create 80 times,then suicide", groups = {"contract", "daily"})
  ...
  @Test(enabled = false, description = "After create 88 times,then suicide", groups = {"contract", "daily"})
  ...
  @Test(enabled = true, retryAnalyzer = Retry.class,
      description = "Test maxfeelimit can trigger call create call max time", groups = {"contract", "daily"})
  ...
  byte[] contractAddress2 = PublicMethod
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    PublicMethod
        .sendcoin(internalTxsAddress, 500000000000L, foundationAddress, foundationKey,
            blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
