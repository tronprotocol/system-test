...
public class ContractInternalTransaction003 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Three-level nesting.Type is Create call->call->create",
      groups = {"contract", "daily"})
  public void testInternalTransaction013() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            internalTxsAddress, 100000000000L, foundationAddress, foundationKey, blockingStubFull));
  ...
  @Test(
      enabled = true,
      description = "Test delegatecall and callcode.",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "After create 80 times,then suicide",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "After create 88 times,then suicide",
      groups = {"contract", "daily"})
  ...
  public void testInternalTransaction018() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    PublicMethod.sendcoin(
        internalTxsAddress, 500000000000L, foundationAddress, foundationKey, blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  ...
  public void shutdown() throws InterruptedException {
    PublicMethod.freeResource(
        internalTxsAddress, testKeyForinternalTxsAddress, foundationAddress, blockingStubFull);
