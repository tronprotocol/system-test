...
public class WalletTestAccount014 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "Query freeNetUsage in 50061",
      groups = {"daily"})
  public void fullAndSoliMerged1ForFreeNetUsage() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            account014Address, 1000000000L, foundationAddress, testKey002, blockingStubFull));
  ...
  @Test(
      enabled = true,
      description = "Query net usage in 50061",
      groups = {"daily"})
  ...
  public void shutdown() throws InterruptedException {
    PublicMethod.freeResource(
        account014Address, account014Key, foundationAddress, blockingStubFull);
    PublicMethod.freeResource(
        account014SecondAddress, account014SecondKey, foundationAddress, blockingStubFull);
  }
}
