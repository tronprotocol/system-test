...
public class UsdtTest001 extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    PublicMethod.freezeBalanceForReceiver(
        testNetAccountAddress,
        10000000000L + PublicMethod.randomFreezeAmount.addAndGet(1),
        0,
        1,
    ...
    SmartContract smartContract = PublicMethod.getContract(usdtAddress, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "transfer when feeLimit = 0",
  ...
  public void test01TransferFeeLimitEqualZero() {
    ...
    final Protocol.Transaction transaction =
        PublicMethod.getTransactionById(txid, blockingStubFull).get();
    ...
    TransactionInfo transactionInfo2 =
        PublicMethod.getTransactionInfoById(txid2, blockingStubFull).get();
  ...
  @Test(
      enabled = true,
      description = "transfer at FeeLimit boundary",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "test black list when transfer and approve",
      groups = {"contract", "daily"})
  public void test03TransferWithBlackList() {
    ...
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    TransactionInfo transactionInfo =
        PublicMethod.getTransactionInfoById(txid1, blockingStubFull).get();
    Assert.assertEquals(
        transactionInfo.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    // add blackList
    ...
    TransactionInfo txAddBlackInfo =
        PublicMethod.getTransactionInfoById(txAddBlack, blockingStubFull).get();
    Assert.assertEquals(
        txAddBlackInfo.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    Protocol.Transaction txAddBlackTx =
        PublicMethod.getTransactionById(txAddBlack, blockingStubFull).get();
    Assert.assertEquals(
    ...
    TransactionInfo transactionInfo3 =
        PublicMethod.getTransactionInfoById(txid3, blockingStubFull).get();
    Assert.assertEquals(
    ...
    TransactionInfo txRemoveBlackListInfo =
        PublicMethod.getTransactionInfoById(txRemoveBlackList, blockingStubFull).get();
    Assert.assertEquals(
        txRemoveBlackListInfo.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    Protocol.Transaction txRemoveBlackListTx =
        PublicMethod.getTransactionById(txRemoveBlackList, blockingStubFull).get();
    Assert.assertEquals(
    ...
    TransactionInfo transactionInfo4 =
        PublicMethod.getTransactionInfoById(txid4, blockingStubFull).get();
    Assert.assertEquals(
    ...
    TransactionInfo transactionInfo5 =
        PublicMethod.getTransactionInfoById(txid5, blockingStubFull).get();
    Assert.assertEquals(
  ...
  @Test(
      enabled = true,
      description = "add and remove black list when feeLimit = 0",
      groups = {"contract", "daily"})
  public void test04BlackListFeeLimitEqualZero() {
    ...
    TransactionInfo txAddBlackInfo2 =
        PublicMethod.getTransactionInfoById(txAddBlack2, blockingStubFull).get();
    Assert.assertEquals(
        txAddBlackInfo2.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    Protocol.Transaction txAddBlackTx2 =
        PublicMethod.getTransactionById(txAddBlack2, blockingStubFull).get();
    Assert.assertEquals(
    ...
    TransactionInfo txRemoveBlackInfo =
        PublicMethod.getTransactionInfoById(txRemoveBlack, blockingStubFull).get();
    Assert.assertEquals(
        txRemoveBlackInfo.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.OUT_OF_ENERGY);
    Protocol.Transaction txRemoveBlackTx =
        PublicMethod.getTransactionById(txRemoveBlack, blockingStubFull).get();
    ...
    TransactionInfo txRemoveBlackInfo2 =
        PublicMethod.getTransactionInfoById(txRemoveBlack2, blockingStubFull).get();
    Assert.assertEquals(
        txRemoveBlackInfo2.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    Protocol.Transaction txRemoveBlackTx2 =
        PublicMethod.getTransactionById(txRemoveBlack2, blockingStubFull).get();
    Assert.assertEquals(
  ...
  @Test(
      enabled = true,
      description = "approve when feeLimit = 0 and boundary + 1",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "approve when feeLimit = boundary - 1",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "add remove when feeLimit = boundary -1",
      groups = {"contract", "daily"})
  ...
  public void shutdown() throws InterruptedException {
    ...
    PublicMethod.unDelegateResourceV2(
