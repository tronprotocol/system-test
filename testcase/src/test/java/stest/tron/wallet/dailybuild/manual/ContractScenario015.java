...
public class ContractScenario015 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "TRON TRC20 transfer token",
      groups = {"daily"})
  public void trc20Tron() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            contract014Address, 1000000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    // Deploy contract1, contract1 has a function to transaction 5 sun to target account
    String contractName = "TRON TRC20";
    String code =
        Configuration.getByPath("testng.conf").getString("code.code_Scenario015_TRC20_TRON");
    String abi = Configuration.getByPath("testng.conf").getString("abi.abi_Scenario015_TRC20_TRON");
    txid =
