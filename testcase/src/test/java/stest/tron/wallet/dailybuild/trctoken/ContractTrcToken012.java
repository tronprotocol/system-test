...
@Slf4j
public class ContractTrcToken012 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "deploy transfer contract with correct value", groups = {"contract", "daily"})
...
//        0, 0, ByteString.copyFrom(dev001Address), foundationKey, blockingStubFull));
  ...
  @Test(description = "TransferToken with correct value, transfer to a normal account", groups = {"contract", "daily"})
...
//        ByteString.copyFrom(user001Address), foundationKey, blockingStubFull));
  ...
  Long receiveAssetBefore = PublicMethod.getAssetIssueValue(dev001Address, assetAccountId,
        blockingStubFull);
  ...
  Long receiveAssetAfter = PublicMethod.getAssetIssueValue(dev001Address,
        assetAccountId, blockingStubFull);
  ...
  @Test(description = "TransferToken with correct value, get account tokenBalance", groups = {"contract", "daily"})
