...
public class ContractTrcToken012 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "deploy transfer contract with correct value",
      groups = {"contract", "daily"})
  public void test01DeployTransferTokenContract() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 15048_000_000L, fromAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.sendcoin(
            user001Address, 14048_000_000L, fromAddress, foundationKey, blockingStubFull));
  ...
  @Test(
      description = "TransferToken with correct value, transfer to a normal account",
      groups = {"contract", "daily"})
  ...
  @Test(
      description = "TransferToken with correct value, get account tokenBalance",
      groups = {"contract", "daily"})
