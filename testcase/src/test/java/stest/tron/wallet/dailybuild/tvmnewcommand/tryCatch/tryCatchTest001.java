...
public class tryCatchTest001 extends TronBaseTest {
  ...
  @Test(
      enabled = true,
      description = "try catch  revert no msg",
  ...
  public void tryCatchTest001() {
    ...
    Assert.assertEquals(
        "NoErrorMsg",
        PublicMethod.getContractStringMsg(
            transactionInfo.get().getContractResult(0).toByteArray()));
  }

  @Test(
      enabled = true,
      description = "try catch  revert msg",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "try catch  Require no msg",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "try catch  Require msg",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "try catch  transfer fail",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "try catch  Send_Error",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "try catch  Math_Error",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = true,
      description = "try catch  ArrayOverFlow_Error",
      groups = {"contract", "daily"})
