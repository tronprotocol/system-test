...
public class ContractTrcToken001 extends TronBaseTest {
  ...
  @Test(enabled = true, description = "DeployContract with correct tokenValue and tokenId", groups = {"contract", "daily"})
  public void deployTransferTokenContract() {
    Assert.assertTrue(PublicMethod
        .sendcoin(dev001Address, 5100_000_000L, fromAddress, foundationKey, blockingStubFull));

    PublicMethod.waitProduceNextBlock(blockingStubFull);
  //    Assert.assertTrue(PublicMethod.freezeBalanceForReceiver(fromAddress,
//        PublicMethod.getFreezeBalanceCount(dev001Address, dev001Key, 135678L, blockingStubFull), 0,
