...
public class HttpTestAsset001 {
  ...
  public void test01CreateAssetIssue() {
    ...
    response =
        HttpMethod.sendCoin(httpnode, fromAddress, participateAddress, 10000000L, testKey002);
    Assert.assertTrue(HttpMethod.verificationResult(response));
    HttpMethod.waitToProduceOneBlock(httpnode);
  ...
  @Test(
      enabled = true,
      description = "GetAssetIssueById by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "GetAssetIssueById from solidity by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "GetAssetIssueById from PBFT by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "GetAssetIssueByName by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "GetAssetIssueByName from solidity by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "GetAssetIssueByName from PBFT by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "TransferAsset by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Participate asset issue by http",
      groups = {"daily", "serial"})
  public void test09ParticipateAssetIssue() {
    HttpMethod.waitToProduceOneBlock(httpnode);
    response =
        HttpMethod.participateAssetIssue(
  ...
  @Test(
      enabled = true,
      description = "Update asset issue by http",
      groups = {"daily", "serial"})
  public void test10UpdateAssetIssue() {
    response =
        HttpMethod.updateAssetIssue(
  ...
  @Test(
      enabled = true,
      description = "Get asset issue list by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Get asset issue list from solidity by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Get asset issue list from PBFT by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Get paginated asset issue list by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Get paginated asset issue list from solidity by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "Get paginated asset issue list from PBFT by http",
      groups = {"daily", "serial"})
  ...
  @Test(
      enabled = true,
      description = "TransferAsset visible true,then broadcast hex",
      groups = {"daily", "serial"})
