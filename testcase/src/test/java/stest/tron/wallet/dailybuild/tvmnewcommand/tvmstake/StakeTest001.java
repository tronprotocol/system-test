...
public class StakeTest001 extends TronBaseTest {
  ...
  void tvmStakeTest001() {
    ...
    byte[] voteAddress =
        (blockingStubFull.getAccount(request).getVotesList().get(0).getVoteAddress().toByteArray());
  ...
  @Test(
      enabled = false,
      description = "Non-witness account",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "Number of votes over balance",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "Enough votes for a second ballot",
      groups = {"contract", "daily"})
  ...
  void tvmStakeTest005() {
    ...
    String argsStr =
        "\""
            + Base58.encode58Check(testWitnessAddress)
            + "\","
            + 1000000
            + ",\""
  ...
  @Test(
      enabled = false,
      description = "Contract Call Contract stake",
      groups = {"contract", "daily"})
  ...
  @Test(
      enabled = false,
      description = "Vote for the first witness and then vote for the second " + "witness.",
      groups = {"contract", "daily"})
