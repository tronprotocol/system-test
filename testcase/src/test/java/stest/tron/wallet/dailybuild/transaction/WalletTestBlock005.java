...
public class WalletTestBlock005 {
  ...
  @Test(enabled = true, description = "Get block by latest num.")
  ...
  @Test(enabled = false, description = "Get block by latest num with type is zero.")
  ...
  @Test(enabled = false, description = "Get block by latest num with type is one.")
  ...
  @Test(enabled = true, description = "Get block by exception num")
