...
@Slf4j
public class AttackSendcoin extends TronBaseTest {
  ...
  private final byte[] attackAddress = PublicMethod.getFinalAddress(testKey001);
  private final byte[] normal1Address = PublicMethod.getFinalAddress(normalKey001);
  private final byte[] normal2Address = PublicMethod.getFinalAddress(normalKey002);
  private final byte[] normal3Address = PublicMethod.getFinalAddress(normalKey003);
  private final byte[] normal4Address = PublicMethod.getFinalAddress(normalKey004);
