...
public class WalletTestBlock004 {
  ...
  public void testGetBlockByLimitNextWithTypeIsZero() throws InterruptedException {
    ...
    logger.info(
        "num:" + getBlockByLimitNext.get().getBlock(0).getBlockHeader().getRawData().getNumber());

    Assert.assertTrue(blockNumber.equals(num));
    ...
    Assert.assertFalse(getBlockByLimitNext.get().getBlock(0).getTransactionsList().isEmpty());
  }
