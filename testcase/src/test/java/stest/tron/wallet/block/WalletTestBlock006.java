...
@Slf4j
public class WalletTestBlock006 extends TronBaseTest {
  /** constructor. */
  ...
  public void testGetTransactionCountByBlockNumFromFullnode() {
    ...
    transactionNumInBlock =
        blockingStubFull.getTransactionCountByBlockNum(builder.build()).getNum();
  ...
  public void testGetTransactionCountByBlockNumFromSolidity() {
    ...
    Long transactionNumInBlock = 0L;
    transactionNumInBlock =
        blockingStubSolidity.getTransactionCountByBlockNum(builder.build()).getNum();
    Assert.assertTrue(transactionNumInBlock >= 1);
