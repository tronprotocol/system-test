...
public class TestNetErc721Cat extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            deployAddress, 50000000000L, foundationAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.sendcoin(
            triggerAddress, 50000000000L, foundationAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
  ...
  public void deploySiringClockAuction() {
    ...
    siringClockAuctionContractAddress =
        PublicMethod.deployContract(
            contractName,
            abi,
            code,
  ...
  public void unCreateKitty() {
    Integer times = 0;
    logger.info(
        "In create kitty, kitty core address is "
            + ByteArray.toHexString(kittyCoreContractAddress));
    while (times++ < 20) {
      txid =
          PublicMethod.triggerContract(
              kittyCoreContractAddress,
