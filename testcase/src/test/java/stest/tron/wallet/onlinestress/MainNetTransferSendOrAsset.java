...
public class MainNetTransferSendOrAsset extends TronBaseTest {
  ...
  private final byte[] fromSendAddress = PublicMethod.getFinalAddress(testKey003);
  private final byte[] toSendAddress = PublicMethod.getFinalAddress(testKey004);
  private final byte[] defaultAddress = PublicMethod.getFinalAddress(defaultKey);
