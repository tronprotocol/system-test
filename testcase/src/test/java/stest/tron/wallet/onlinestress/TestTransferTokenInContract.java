...
@Slf4j
@MultiNode
public class TestTransferTokenInContract extends TronBaseTest {
  ...
  public ByteString createAssetissue(byte[] devAddress, String devKey, String tokenName) {
    ...
    if (queryAssetByAccount.get().getAssetIssueCount() == 0) {
      ...
      Account getAssetIdFromThisAccount = PublicMethod.queryAccount(devAddress, blockingStubFull);
      assetAccountId = getAssetIdFromThisAccount.getAssetIssuedID();
    } else {
      logger.info("This account already create an assetisue");
      Optional<GrpcAPI.AssetIssueList> queryAssetByAccount1 = Optional.ofNullable(assetIssueList1);
      tokenName =
          ByteArray.toStr(queryAssetByAccount1.get().getAssetIssue(0).getName().toByteArray());
    }
  ...
  public void continueRun() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 2048000000, foundationAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.sendcoin(
            user001Address, 4048000000L, foundationAddress, testKey002, blockingStubFull));
    // freeze balance
    Assert.assertTrue(
    ...
    String code =
        "608060405260e2806100126000396000f300608060405260043610603e5763ffffffff7c01000000"
            + "000000000000000000000000000000000000000000000000006000350416633be9ece781146043575b60"
                + "0080"
            + "fd5b606873ffffffffffffffffffffffffffffffffffffffff60043516602435604435606a565b005b60"
                + "4051"
            + "73ffffffffffffffffffffffffffffffffffffffff84169082156108fc02908390859060008181818587"
                + "8a8a"
            + "d094505050505015801560b0573d6000803e3d6000fd5b505050505600a165627a7a723058200ba246bd"
                + "b58b"
    ...
    code =
        "60806040526000805560c5806100166000396000f30060806040526004361060485763ffffffff7c0100000"
            + "00000000000000000000000000000000000000000000000000060003504166362548c7b8114604a57806"
                + "3890"
            + "eba68146050575b005b6048608c565b348015605b57600080fd5b50d38015606757600080fd5b50d2801"
                + "5607"
            + "357600080fd5b50607a6093565b60408051918252519081900360200190f35b6001600055565b6000548"
                + "1560"
            + "0a165627a7a723058204c4f1bb8eca0c4f1678cc7cc1179e03d99da2a980e6792feebe4d55c89c022830"
                + "029";
    abi =
        "[{\"constant\":false,\"inputs\":[],\"name\":\"setFlag\",\"outputs\":[],\"payable\":true,"
            + "\"stateMutability\":\"payable\",\"type\":\"function\"},{\"constant\":true,\"inputs\""
                + ":[],"
            + "\"name\":\"flag\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":fal"
                + "se,"
            + "\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"payable\":true,"
            + "\"stateMutability\":\"payable\",\"type\":\"constructor\"},{\"payable\":true,"
            + "\"stateMutability\":\"payable\",\"type\":\"fallback\"}]";
    byte[] receiveTokenContractAddress =
        PublicMethod.deployContract(
            contractName,
            abi,
            code,
    ...
    code =
        "608060405260ff806100126000396000f30060806040526004361060485763ffffffff7c010000000000000"
            + "0000000000000000000000000000000000000000000600035041663a730416e8114604d578063b69ef8a"
                + "8146"
            + "081575b600080fd5b606f73ffffffffffffffffffffffffffffffffffffffff6004351660243560ab565"
                + "b604"
            + "08051918252519081900360200190f35b348015608c57600080fd5b50d38015609857600080fd5b50d28"
                + "0156"
            + "0a457600080fd5b50606f60cd565b73ffffffffffffffffffffffffffffffffffffffff90911690d1600"
                + "0908"
            + "15590565b600054815600a165627a7a723058202b6235122df66c062c2e723ad58a9fea93346f3bc1989"
                + "8971"
            + "8f211aa1dbd2d7a0029";
    abi =
        "[{\"constant\":false,\"inputs\":[{\"name\":\"toAddress\","
            + "\"type\":\"address\"},{\"name\":\"tokenId\","
            + "\"type\":\"trcToken\"}],\"name\":\"getTokenBalnce\","
            + "\"outputs\":[{\"name\":\"b\",\"type\":\"uint256\"}],"
            + "\"payable\":true,\"stateMutability\":"
    ...
    byte[] tokenBalanceContractAddress =
        PublicMethod.deployContract(
            contractName,
            abi,
            code,
    ...
    PublicMethod.transferAsset(
        user001Address, tokenId.toByteArray(), 100, dev001Address, dev001Key, blockingStubFull);
    ...
    for (int i = 0; i < 1000000000000L; i++) {
      ...
      PublicMethod.freezeBalanceForReceiver(
          user001Address,
          PublicMethod.getFreezeBalanceCount(user001Address, user001Key, 300000L, blockingStubFull),
          0,
          1,
      ...
      String param =
          "\""
              + Base58.encode58Check(receiveTokenContractAddress)
              + "\",\""
              + tokenId.toStringUtf8()
              + "\",\"5\"";
      String triggerTxid =
      ...
      PublicMethod.unFreezeBalance(
          foundationAddress, user001Key, 1, user001Address, blockingStubFull);
      PublicMethod.unFreezeBalance(
          foundationAddress, user001Key, 0, user001Address, blockingStubFull);
    }
  }
