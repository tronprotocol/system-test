...
public class SupportTronlinkAutoTest extends TronBaseTest {
  ...
  public void testMultiSignForAccount() {
    ...
    while (i++ < 20) {
      ...
      PublicMethod.sendcoin(
          ownerAddress, 200000000000L, foundationAddress, testKey002, blockingStubFull);
  ...
  public void test002CreateWitness() {
    ...
    while (i++ < 10) {
      ...
      PublicMethod.sendcoin(
          ownerAddress, 50000000000L, foundationAddress, testKey002, blockingStubFull);
  ...
  public void test03MultiSignForAccount() {
    ...
    for (HashMap.Entry entry : muti.entrySet()) {
      ...
      // System.exit(1);
      PublicMethod.sendcoin(
          ownerAddress, 20000000000L, foundationAddress, testKey002, blockingStubFull);
