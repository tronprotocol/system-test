...
@Slf4j
public class SupportTronlinkAutoTest extends TronBaseTest {

  //just test key
  private final String testKey002
      = "7400E3D0727F8A61041A8E8BF86599FE5597CE19DE451E59AED07D60967A5E25";  ByteString assetAccountId1;
  ...
  //PublicMethod.printAddress(ownerKey);
      ...
      PublicMethod.sendcoin(ownerAddress, 200000000000L, foundationAddress, testKey002,
          blockingStubFull);
  ...
  //PublicMethod.printAddress(ownerKey);
      ...
      PublicMethod.sendcoin(ownerAddress, 50000000000L, foundationAddress, testKey002,
          blockingStubFull);
  ...
  @Test(enabled = true, threadPoolSize = 1, invocationCount = 1, groups = {"stress"})
  public void test03MultiSignForAccount() {
    //test keys
  ...
  //entry.getValue().toString();
      ...
      ownerAddress = PublicMethod.getFinalAddress(ownerKey);

      manager1Key = entry.getValue().toString();
      manager1Address = PublicMethod.getFinalAddress(manager1Key);
  //System.out.println("ownerKey:" + ownerKey);
  //System.out.println("manager1Key:" + manager1Key);
  //System.exit(1);
      PublicMethod.sendcoin(ownerAddress, 20000000000L, foundationAddress, testKey002,
          blockingStubFull);
...
//test keys
  ...
  int i = 1;
    for (String ownerKey : witnessKey) {
      byte[] ownerAddress = PublicMethod.getFinalAddress(ownerKey);
      PublicMethod.sendcoin(ownerAddress, 20000000000L, foundationAddress, testKey002,
          blockingStubFull);
  ...
  //dapp chain trc20 tract TXkdXbzjoLpxGAD2strP1zwjJzR6osNfD7
      byte[] contractAddress = PublicMethod.decode58Check("TXkdXbzjoLpxGAD2strP1zwjJzR6osNfD7");
  //main chain TRC 20 contract TCCcBZEdTHmS1NfFtCYfwpjBKeTv515n71
      //byte[] contractAddress =  PublicMethod.decode58Check("TCCcBZEdTHmS1NfFtCYfwpjBKeTv515n71");

      PublicMethod
          .triggerContract(contractAddress, "transfer(address,uint256)", triggerString, false,
              0, 1000000000, "0", 0, foundationAddress, testKey002, blockingStubFull);
      PublicMethod.waitProduceNextBlock(blockingStubFull);
