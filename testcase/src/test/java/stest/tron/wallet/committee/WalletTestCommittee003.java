  ...
  public void testApproveProposal() {
    ...
    Assert.assertTrue(
        PublicMethod.approveProposal(
            witness002Address, witnessKey2, proposalId, true, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    ...
    Assert.assertTrue(
        Base58.encode58Check(witness002Address)
            .equals(
                Base58.encode58Check(
    ...
    Assert.assertTrue(
        PublicMethod.approveProposal(
            witness002Address, witnessKey2, proposalId, false, blockingStubFull));
    proposalList = blockingStubFull.listProposals(EmptyMessage.newBuilder().build());
    listProposals = Optional.ofNullable(proposalList);
    ...
    Assert.assertFalse(
        PublicMethod.approveProposal(toAddress, testKey003, proposalId, true, blockingStubFull));
    // Muti approval
    Assert.assertTrue(
        PublicMethod.approveProposal(
