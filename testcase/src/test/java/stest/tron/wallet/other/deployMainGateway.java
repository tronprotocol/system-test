...
public class deployMainGateway extends TronBaseTest {
  ...
  private final String testDepositTrx =
      "324a2052e491e99026442d81df4d2777292840c1b3949e20696c49096" + "c6bacb7";
  ...
  public void test1DepositTrc20001() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            depositAddress, 1000_000_000L, testDepositAddress, testDepositTrx, blockingStubFull));
    ...
    String code = Configuration.getByPath("testng.conf").getString("code.code_MainGateway");
    String abi = Configuration.getByPath("testng.conf").getString("abi.abi_MainGateway");
    ...
    SmartContract smartContract = PublicMethod.getContract(mainChainGateway, blockingStubFull);
