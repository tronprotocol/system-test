...
public class deploySideGateway extends TronBaseTest {
  ...
  public void test1DepositTrc20001() {
    ...
    String code = Configuration.getByPath("testng.conf").getString("code.code_SideGateway");
    String abi = Configuration.getByPath("testng.conf").getString("abi.abi_SideGateway");
