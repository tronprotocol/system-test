...
@Slf4j
public class TestUpdateOnlineTxs extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            dev001Address, 300100_000_000L, fromAddress, foundationKey2, blockingStubFull));
  ...
  public void sunswapV1() {
    ...
    String txid1 =
        PublicMethod.triggerContract(
            PublicMethod.decode58Check(exchangeAdd),
            methodSign,
            param,
            false,
            50000000,
            ...
            blockingStubFull);
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Optional<TransactionInfo> info1 = PublicMethod.getTransactionInfoById(txid1, blockingStubFull);
  ...
  public void sunio2PoolAddliq() {
    ...
    String txid =
        PublicMethod.triggerContract(
            PublicMethod.decode58Check(pool),
            methedStr,
            argsStr,
            false,
            0,
  ...
  public void sunio2PoolDeposit() {
    ...
    String txid =
        PublicMethod.triggerContract(
            PublicMethod.decode58Check(gague),
            methedStr,
            argsStr,
            false,
            0,
  ...
  public void justlendBorrow() {
    ...
    String txid =
        PublicMethod.triggerContract(
            PublicMethod.decode58Check(jusdd),
            methedStr,
            argsStr,
            false,
            0,
  ...
  public void justlendMint() {
    ...
    String txid =
        PublicMethod.triggerContract(
            PublicMethod.decode58Check(jtrx),
            methedStr,
            argsStr,
            false,
            0,
  ...
  public void bttcDepositJst() {
    ...
    String argsStr =
        "\"TH48niZfbwHMyqZwEB8wmHfzcvR8ZzJKC6\","
    ...
    String txid =
        PublicMethod.triggerContract(
            PublicMethod.decode58Check(rootChainManager),
            methedStr,
            argsStr,
            false,
            0,
  ...
  public void approve() {
    ...
    String txid =
        PublicMethod.triggerContract(
            PublicMethod.decode58Check(token),
            methedStr,
            argsStr,
            false,
            0,
