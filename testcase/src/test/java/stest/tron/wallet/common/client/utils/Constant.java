...
public class Constant {
  ...
  public static final byte[] ZTRON_EXPANDSEED_PERSONALIZATION = {
    'Z', 't', 'r', 'o', 'n', '_', 'E', 'x', 'p', 'a', 'n', 'd', 'S', 'e', 'e', 'd'
  };
  ...
  // public static final String COMMITTEE_ALLOW_SHIELDED_TRANSACTION =
  // "committee.allowShieldedTransaction";
