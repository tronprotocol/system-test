...
import stest.tron.wallet.common.client.utils.zen.note.NoteEncryption.Encryption.EncCiphertext;
import stest.tron.wallet.common.client.utils.zen.note.NoteEncryption.Encryption.EncPlaintext;
import stest.tron.wallet.common.client.utils.zen.note.NoteEncryption.Encryption.OutCiphertext;
...
public class NoteEncryption {
  ...
  public OutCiphertext encryptToOurselves(
    ...
    byte[] ock = new byte[Encryption.NOTEENCRYPTION_CIPHER_KEYSIZE];
