...
public class MultisignOperatorErgodicTest extends TronBaseTest {
  ...
  public void beforeClass() {
    ...
    Assert.assertTrue(
        PublicMethodForMultiSign.accountPermissionUpdate(
            ...
            multisignAccountKey,
            blockingStubFull,
            new String[] {multisignAccountKey}));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
  }
  ...
  public void test001MultiSignGodicAccountTypeTransaction() {
    Assert.assertTrue(
        PublicMethodForMultiSign.setAccountId1(
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethodForMultiSign.createAccountWhtiPermissionId(
            multisignAccountAddress,
            newAddress,
            multisignAccountKey,
            blockingStubFull,
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethodForMultiSign.sendcoinWithPermissionId(
            newAddress,
            100L,
            multisignAccountAddress,
            2,
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethodForMultiSign.freezeBalanceWithPermissionId(
            multisignAccountAddress,
            1000000L,
            0,
            2,
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethodForMultiSign.freezeBalanceGetEnergyWithPermissionId(
            multisignAccountAddress,
            1000000L,
            0,
            1,
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethodForMultiSign.freezeBalanceForReceiverWithPermissionId(
            multisignAccountAddress,
            1000000L,
            0,
            0,
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethodForMultiSign.unFreezeBalanceWithPermissionId(
            multisignAccountAddress,
            multisignAccountKey,
            0,
            null,
    ...
    Assert.assertTrue(
        PublicMethodForMultiSign.unFreezeBalanceWithPermissionId(
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethodForMultiSign.updateAccountWithPermissionId(
            multisignAccountAddress,
            updateName.getBytes(),
            multisignAccountKey,
            blockingStubFull,
  ...
  public void test002MultiSignGodicContractTypeTransaction() {
    ...
    byte[] contractAddress =
        PublicMethodForMultiSign.deployContractWithPermissionId(
            contractName,
            abi,
            code,
            "",
    ...
    txid =
        PublicMethodForMultiSign.triggerContractWithPermissionId(
            contractAddress,
            "testUseCpu(uint256)",
            initParmes,
            false,
    ...
    Assert.assertTrue(
        PublicMethodForMultiSign.clearContractAbi(
            contractAddress,
            multisignAccountAddress,
            multisignAccountKey,
            blockingStubFull,
  ...
  public void test003MultiSignGodicTokenTypeTransaction() {
    ...
    Assert.assertTrue(
        PublicMethodForMultiSign.createAssetIssueWithpermissionId(
            multisignAccountAddress,
            name,
            totalSupply,
            1,
    ...
    getAssetIdFromOwnerAccount =
        PublicMethod.queryAccount(multisignAccountAddress, blockingStubFull);
    assetAccountId1 = getAssetIdFromOwnerAccount.getAssetIssuedID();

    Assert.assertTrue(
        PublicMethodForMultiSign.transferAssetWithpermissionId(
            manager1Address,
    ...
    Assert.assertTrue(
        PublicMethodForMultiSign.updateAssetWithPermissionId(
            multisignAccountAddress,
  ...
  public void test004MultiSignGodicExchangeTypeTransaction() {
    ...
    org.junit.Assert.assertTrue(
        PublicMethod.sendcoin(
            secondExchange001Address, 10240000000L, fromAddress, foundationKey2, blockingStubFull));
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertTrue(
        PublicMethodForMultiSign.exchangeTransaction1(
            exchangeId,
            assetAccountId1.toByteArray(),
            50,
            1,
    ...
    Assert.assertTrue(
        PublicMethodForMultiSign.participateAssetIssueWithPermissionId(
            secondExchange001Address,
            assetAccountId2.toByteArray(),
            1,
            multisignAccountAddress,
  ...
  public void test005MultiSignGodicShieldTransaction() {
    ...
    final Long beforeBalance =
        PublicMethod.queryAccount(multisignAccountAddress, blockingStubFull).getBalance();
    final Long beforeNetUsed =
        PublicMethod.getAccountResource(multisignAccountAddress, blockingStubFull).getFreeNetUsed();
    ...
    Assert.assertTrue(
        PublicMethodForMultiSign.sendShieldCoin(
            multisignAccountAddress,
            sendTokenAmount,
            null,
            null,
  ...
  public void test006MultiSignGodicWitnessTransaction() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            newAddress, 1000000_000_000L, fromAddress, foundationKey2, blockingStubFull));
    logger.info(accountPermissionJson);
    Assert.assertTrue(
        PublicMethodForMultiSign.accountPermissionUpdate(
    ...
    Assert.assertTrue(
        PublicMethodForMultiSign.createWitness(
            url, newAddress, newKey, 2, permissionKeyString, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethodForMultiSign.updateWitness2(
            newAddress,
    ...
    Assert.assertTrue(
        PublicMethodForMultiSign.voteWitnessWithPermissionId(
            smallVoteMap,
            multisignAccountAddress,
            multisignAccountKey,
            blockingStubFull,
  ...
  public void test008MultiSignGodicWithdrawBanlanceTransaction() {
    ...
    Assert.assertTrue(
        PublicMethodForMultiSign.withdrawBalance(
