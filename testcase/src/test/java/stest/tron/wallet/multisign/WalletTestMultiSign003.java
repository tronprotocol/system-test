...
@Slf4j
public class WalletTestMultiSign003 extends TronBaseTest {  ByteString assetAccountId1;
  ...
  final String updateName = Long.toString(System.currentTimeMillis());
    ...
    Assert.assertTrue(PublicMethodForMultiSign.createAccount(
    ...
    Assert.assertTrue(PublicMethodForMultiSign.freezeBalanceGetEnergy(
        ownerAddress, 1000000L, 0, 2, ownerKey, blockingStubFull, ownerKeyString));
    Assert.assertTrue(PublicMethodForMultiSign.freezeBalanceForReceiver(
        ownerAddress, 1000000L, 0, 0, ByteString.copyFrom(newAddress),
        ownerKey, blockingStubFull, ownerKeyString));
    Assert.assertTrue(PublicMethodForMultiSign.unFreezeBalance(
    ...
    Assert.assertTrue(PublicMethodForMultiSign.updateAccount(
  ...
  String voteStr = Base58.encode58Check(witnessAddress);
    ...
    Assert.assertTrue(PublicMethodForMultiSign.voteWitness(
