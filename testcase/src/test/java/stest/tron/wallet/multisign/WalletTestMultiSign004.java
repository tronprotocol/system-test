...
@Slf4j
@MultiNode
public class WalletTestMultiSign004 extends TronBaseTest {
  ...
  public void testMultiSignForSmartContract() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            ownerAddress, needcoin + 100000000L, foundationAddress2,
    ...
    byte[] contractAddress =
        PublicMethodForMultiSign.deployContract(
            contractName,
            abi,
            code,
            "",
    ...
    txid =
        PublicMethodForMultiSign.triggerContract(
            contractAddress,
            "testUseCpu(uint256)",
            initParmes,
            false,
    ...
    Assert.assertTrue(
        PublicMethod.unFreezeBalance(
            fromAddress, foundationKey2, 0, ownerAddress, blockingStubFull));
    Assert.assertTrue(
        PublicMethod.unFreezeBalance(
            fromAddress, foundationKey2, 1, ownerAddress, blockingStubFull));
  }
}
