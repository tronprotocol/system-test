  ...
  public void deployWhenNoEnergy() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            linkage003Address, 200000000L, fromAddress, testKey003, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Account info;
    AccountResourceMessage resourceInfo =
        PublicMethod.getAccountResource(linkage003Address, blockingStubFull);
    ...
    AccountResourceMessage resourceInfoafter =
        PublicMethod.getAccountResource(linkage003Address, blockingStubFull1);
