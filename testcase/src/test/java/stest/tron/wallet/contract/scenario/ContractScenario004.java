...
@Slf4j
public class ContractScenario004 extends TronBaseTest {
  ...
  public void deployErc20TronTokenWithoutData() {
    Assert.assertTrue(
        PublicMethod.sendcoin(
            contract004Address, 200000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalanceGetEnergy(
            contract004Address, 100000000L, 3, 1, contract004Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    AccountResourceMessage accountResource =
        PublicMethod.getAccountResource(contract004Address, blockingStubFull);
