...
@Slf4j
public class ContractScenario007 extends TronBaseTest {
  ...
  public void deployErc721CardMigration() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            contract007Address, 20000000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalanceGetEnergy(
            contract007Address, 100000000L, 3, 1, contract007Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    AccountResourceMessage accountResource =
        PublicMethod.getAccountResource(contract007Address, blockingStubFull);
