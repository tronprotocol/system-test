...
@Slf4j
public class ContractScenario001 extends TronBaseTest {
  ...
  public void deployAddressDemo() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            contract001Address, 20000000L, toAddress, testKey003, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethod.freezeBalanceGetEnergy(
            contract001Address, 15000000L, 3, 1, contract001Key, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull1);
    AccountResourceMessage accountResource =
        PublicMethod.getAccountResource(contract001Address, blockingStubFull);
