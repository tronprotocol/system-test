...
@Slf4j
@MultiNode
public class ContractScenario012 extends TronBaseTest {
  ...
  public void test1DeployTransactionCoin() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(
            contract012Address, 2000000000L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    AccountResourceMessage accountResource =
        PublicMethod.getAccountResource(contract012Address, blockingStubFull);
  ...
  public void test4TriggerTransactionCoin() {
    ...
    Assert.assertTrue(
        PublicMethod.sendcoin(receiverAddress, 10000000L, toAddress, testKey003, blockingStubFull));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
    txid =
        PublicMethod.triggerContract(
            contractAddress,
